...
export interface PolarVortexMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PolarVortexMonitor({ onClose, showClose = true }: PolarVortexMonitorProps) {
  return (
...
export default PolarVortexMonitor
