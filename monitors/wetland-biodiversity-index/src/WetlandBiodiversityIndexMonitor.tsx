...
export interface WetlandBiodiversityIndexMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WetlandBiodiversityIndexMonitor({ onClose, showClose = true }: WetlandBiodiversityIndexMonitorProps) {
  return (
...
export default WetlandBiodiversityIndexMonitor
