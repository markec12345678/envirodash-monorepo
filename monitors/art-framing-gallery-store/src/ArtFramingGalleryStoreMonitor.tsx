...
export interface ArtFramingGalleryStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ArtFramingGalleryStoreMonitor({ onClose, showClose = true }: ArtFramingGalleryStoreMonitorProps) {
  return (
...
export default ArtFramingGalleryStoreMonitor
