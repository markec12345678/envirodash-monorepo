...
export interface CraneFleetOperationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CraneFleetOperationMonitor({ onClose, showClose = true }: CraneFleetOperationMonitorProps) {
  return (
...
export default CraneFleetOperationMonitor
