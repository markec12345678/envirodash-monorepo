...
export interface HydrothermalPlumeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HydrothermalPlumeMonitor({ onClose, showClose = true }: HydrothermalPlumeMonitorProps) {
  return (
...
export default HydrothermalPlumeMonitor
