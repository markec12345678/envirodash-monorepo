...
export interface ArenaEventMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ArenaEventMonitor({ onClose, showClose = true }: ArenaEventMonitorProps) {
  return (
...
export default ArenaEventMonitor
