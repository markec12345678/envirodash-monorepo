...
export interface LandfillOperationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LandfillOperationMonitor({ onClose, showClose = true }: LandfillOperationMonitorProps) {
  return (
...
export default LandfillOperationMonitor
