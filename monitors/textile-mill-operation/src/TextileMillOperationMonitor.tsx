...
export interface TextileMillOperationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TextileMillOperationMonitor({ onClose, showClose = true }: TextileMillOperationMonitorProps) {
  return (
...
export default TextileMillOperationMonitor
