...
export interface NutritionSecurityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function NutritionSecurityMonitor({ onClose, showClose = true }: NutritionSecurityMonitorProps) {
  return (
...
export default NutritionSecurityMonitor
