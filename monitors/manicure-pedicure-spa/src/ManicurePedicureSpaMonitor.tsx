...
export interface ManicurePedicureSpaMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ManicurePedicureSpaMonitor({ onClose, showClose = true }: ManicurePedicureSpaMonitorProps) {
  return (
...
export default ManicurePedicureSpaMonitor
