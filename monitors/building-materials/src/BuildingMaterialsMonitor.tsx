...
export interface BuildingMaterialsMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BuildingMaterialsMonitor({ onClose, showClose = true }: BuildingMaterialsMonitorProps) {
  return (
...
export default BuildingMaterialsMonitor
