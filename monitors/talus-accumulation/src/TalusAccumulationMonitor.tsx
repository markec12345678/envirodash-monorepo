...
export interface TalusAccumulationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TalusAccumulationMonitor({ onClose, showClose = true }: TalusAccumulationMonitorProps) {
  return (
...
export default TalusAccumulationMonitor
