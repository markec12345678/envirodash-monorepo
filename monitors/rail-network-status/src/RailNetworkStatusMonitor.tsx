...
export interface RailNetworkStatusMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RailNetworkStatusMonitor({ onClose, showClose = true }: RailNetworkStatusMonitorProps) {
  return (
...
export default RailNetworkStatusMonitor
