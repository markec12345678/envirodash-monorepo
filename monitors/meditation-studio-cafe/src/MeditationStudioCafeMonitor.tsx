...
export interface MeditationStudioCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MeditationStudioCafeMonitor({ onClose, showClose = true }: MeditationStudioCafeMonitorProps) {
  return (
...
export default MeditationStudioCafeMonitor
