...
export interface DustHemisphereTransportMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DustHemisphereTransportMonitor({ onClose, showClose = true }: DustHemisphereTransportMonitorProps) {
  return (
...
export default DustHemisphereTransportMonitor
