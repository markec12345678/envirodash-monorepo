...
export interface BowlingAlleyLaneMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BowlingAlleyLaneMonitor({ onClose, showClose = true }: BowlingAlleyLaneMonitorProps) {
  return (
...
export default BowlingAlleyLaneMonitor
