...
export interface BreweryFermentationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BreweryFermentationMonitor({ onClose, showClose = true }: BreweryFermentationMonitorProps) {
  return (
...
export default BreweryFermentationMonitor
