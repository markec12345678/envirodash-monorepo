...
export interface AirPollutionHealthMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AirPollutionHealthMonitor({ onClose, showClose = true }: AirPollutionHealthMonitorProps) {
  return (
...
export default AirPollutionHealthMonitor
