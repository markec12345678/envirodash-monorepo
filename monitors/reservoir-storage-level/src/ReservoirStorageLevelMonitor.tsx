...
export interface ReservoirStorageLevelMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ReservoirStorageLevelMonitor({ onClose, showClose = true }: ReservoirStorageLevelMonitorProps) {
  return (
...
export default ReservoirStorageLevelMonitor
