...
export interface PermafrostCarbonFeedbackMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PermafrostCarbonFeedbackMonitor({ onClose, showClose = true }: PermafrostCarbonFeedbackMonitorProps) {
  return (
...
export default PermafrostCarbonFeedbackMonitor
