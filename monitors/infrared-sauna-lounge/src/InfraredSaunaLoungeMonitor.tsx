...
export interface InfraredSaunaLoungeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function InfraredSaunaLoungeMonitor({ onClose, showClose = true }: InfraredSaunaLoungeMonitorProps) {
  return (
...
export default InfraredSaunaLoungeMonitor
