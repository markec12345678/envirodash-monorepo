...
export interface GolfCountryClubRestaurantMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GolfCountryClubRestaurantMonitor({ onClose, showClose = true }: GolfCountryClubRestaurantMonitorProps) {
  return (
...
export default GolfCountryClubRestaurantMonitor
