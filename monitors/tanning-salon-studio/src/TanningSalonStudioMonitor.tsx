...
export interface TanningSalonStudioMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TanningSalonStudioMonitor({ onClose, showClose = true }: TanningSalonStudioMonitorProps) {
  return (
...
export default TanningSalonStudioMonitor
