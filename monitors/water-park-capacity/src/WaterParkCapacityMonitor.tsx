...
export interface WaterParkCapacityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WaterParkCapacityMonitor({ onClose, showClose = true }: WaterParkCapacityMonitorProps) {
  return (
...
export default WaterParkCapacityMonitor
