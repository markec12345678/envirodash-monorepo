...
export interface SteelMillOperationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SteelMillOperationMonitor({ onClose, showClose = true }: SteelMillOperationMonitorProps) {
  return (
...
export default SteelMillOperationMonitor
