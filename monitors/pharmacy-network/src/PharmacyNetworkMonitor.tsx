...
export interface PharmacyNetworkMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PharmacyNetworkMonitor({ onClose, showClose = true }: PharmacyNetworkMonitorProps) {
  return (
...
export default PharmacyNetworkMonitor
