...
export interface SnowpackWaterEquivalentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SnowpackWaterEquivalentMonitor({ onClose, showClose = true }: SnowpackWaterEquivalentMonitorProps) {
  return (
...
export default SnowpackWaterEquivalentMonitor
