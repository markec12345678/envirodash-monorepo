...
export interface InsuranceAgencyOfficeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function InsuranceAgencyOfficeMonitor({ onClose, showClose = true }: InsuranceAgencyOfficeMonitorProps) {
  return (
...
export default InsuranceAgencyOfficeMonitor
