...
export interface SportingGoodsOutdoorMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SportingGoodsOutdoorMonitor({ onClose, showClose = true }: SportingGoodsOutdoorMonitorProps) {
  return (
...
export default SportingGoodsOutdoorMonitor
