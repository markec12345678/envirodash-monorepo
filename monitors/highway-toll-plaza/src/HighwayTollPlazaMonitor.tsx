...
export interface HighwayTollPlazaMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HighwayTollPlazaMonitor({ onClose, showClose = true }: HighwayTollPlazaMonitorProps) {
  return (
...
export default HighwayTollPlazaMonitor
