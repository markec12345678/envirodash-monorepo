...
export interface MedicalResearchLabMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MedicalResearchLabMonitor({ onClose, showClose = true }: MedicalResearchLabMonitorProps) {
  return (
...
export default MedicalResearchLabMonitor
