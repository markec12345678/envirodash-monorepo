...
export interface SoilOrganicCarbonMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SoilOrganicCarbonMonitor({ onClose, showClose = true }: SoilOrganicCarbonMonitorProps) {
  return (
...
export default SoilOrganicCarbonMonitor
