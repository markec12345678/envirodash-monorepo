...
export interface BeachResortRestaurantMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BeachResortRestaurantMonitor({ onClose, showClose = true }: BeachResortRestaurantMonitorProps) {
  return (
...
export default BeachResortRestaurantMonitor
