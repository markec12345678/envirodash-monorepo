...
export interface MinistryHeadquartersMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MinistryHeadquartersMonitor({ onClose, showClose = true }: MinistryHeadquartersMonitorProps) {
  return (
...
export default MinistryHeadquartersMonitor
