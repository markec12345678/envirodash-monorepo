...
export interface IndoorSkydivingLoungeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function IndoorSkydivingLoungeMonitor({ onClose, showClose = true }: IndoorSkydivingLoungeMonitorProps) {
  return (
...
export default IndoorSkydivingLoungeMonitor
