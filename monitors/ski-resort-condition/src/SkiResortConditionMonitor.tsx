...
export interface SkiResortConditionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SkiResortConditionMonitor({ onClose, showClose = true }: SkiResortConditionMonitorProps) {
  return (
...
export default SkiResortConditionMonitor
