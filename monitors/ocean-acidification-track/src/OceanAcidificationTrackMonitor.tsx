...
export interface OceanAcidificationTrackMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function OceanAcidificationTrackMonitor({ onClose, showClose = true }: OceanAcidificationTrackMonitorProps) {
  return (
...
export default OceanAcidificationTrackMonitor
