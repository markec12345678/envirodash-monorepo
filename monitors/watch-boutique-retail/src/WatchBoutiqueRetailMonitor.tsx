...
export interface WatchBoutiqueRetailMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WatchBoutiqueRetailMonitor({ onClose, showClose = true }: WatchBoutiqueRetailMonitorProps) {
  return (
...
export default WatchBoutiqueRetailMonitor
