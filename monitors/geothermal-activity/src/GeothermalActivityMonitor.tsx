...
export interface GeothermalActivityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GeothermalActivityMonitor({ onClose, showClose = true }: GeothermalActivityMonitorProps) {
  return (
...
export default GeothermalActivityMonitor
