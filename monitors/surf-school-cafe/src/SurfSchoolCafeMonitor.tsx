...
export interface SurfSchoolCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SurfSchoolCafeMonitor({ onClose, showClose = true }: SurfSchoolCafeMonitorProps) {
  return (
...
export default SurfSchoolCafeMonitor
