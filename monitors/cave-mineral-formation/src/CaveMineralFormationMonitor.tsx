...
export interface CaveMineralFormationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CaveMineralFormationMonitor({ onClose, showClose = true }: CaveMineralFormationMonitorProps) {
  return (
...
export default CaveMineralFormationMonitor
