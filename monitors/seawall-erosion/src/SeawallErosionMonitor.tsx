...
export interface SeawallErosionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SeawallErosionMonitor({ onClose, showClose = true }: SeawallErosionMonitorProps) {
  return (
...
export default SeawallErosionMonitor
