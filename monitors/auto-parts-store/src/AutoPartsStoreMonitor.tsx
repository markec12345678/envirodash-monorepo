...
export interface AutoPartsStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AutoPartsStoreMonitor({ onClose, showClose = true }: AutoPartsStoreMonitorProps) {
  return (
...
export default AutoPartsStoreMonitor
