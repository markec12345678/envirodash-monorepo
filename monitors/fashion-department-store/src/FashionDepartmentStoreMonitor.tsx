...
export interface FashionDepartmentStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FashionDepartmentStoreMonitor({ onClose, showClose = true }: FashionDepartmentStoreMonitorProps) {
  return (
...
export default FashionDepartmentStoreMonitor
