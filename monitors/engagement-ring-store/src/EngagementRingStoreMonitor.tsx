...
export interface EngagementRingStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function EngagementRingStoreMonitor({ onClose, showClose = true }: EngagementRingStoreMonitorProps) {
  return (
...
export default EngagementRingStoreMonitor
