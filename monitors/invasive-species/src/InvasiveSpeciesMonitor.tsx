...
export interface InvasiveSpeciesMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function InvasiveSpeciesMonitor({ onClose, showClose = true }: InvasiveSpeciesMonitorProps) {
  return (
...
export default InvasiveSpeciesMonitor
