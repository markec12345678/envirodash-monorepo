...
export interface CoastalErosionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CoastalErosionMonitor({ onClose, showClose = true }: CoastalErosionMonitorProps) {
  return (
...
export default CoastalErosionMonitor
