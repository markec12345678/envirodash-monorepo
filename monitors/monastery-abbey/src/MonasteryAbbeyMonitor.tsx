...
export interface MonasteryAbbeyMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MonasteryAbbeyMonitor({ onClose, showClose = true }: MonasteryAbbeyMonitorProps) {
  return (
...
export default MonasteryAbbeyMonitor
