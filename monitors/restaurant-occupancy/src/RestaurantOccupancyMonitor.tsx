...
export interface RestaurantOccupancyMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RestaurantOccupancyMonitor({ onClose, showClose = true }: RestaurantOccupancyMonitorProps) {
  return (
...
export default RestaurantOccupancyMonitor
