...
export interface PolynyaIceMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PolynyaIceMonitor({ onClose, showClose = true }: PolynyaIceMonitorProps) {
  return (
...
export default PolynyaIceMonitor
