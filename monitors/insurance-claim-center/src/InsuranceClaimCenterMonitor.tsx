...
export interface InsuranceClaimCenterMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function InsuranceClaimCenterMonitor({ onClose, showClose = true }: InsuranceClaimCenterMonitorProps) {
  return (
...
export default InsuranceClaimCenterMonitor
