...
export interface DeepSeaVentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DeepSeaVentMonitor({ onClose, showClose = true }: DeepSeaVentMonitorProps) {
  return (
...
export default DeepSeaVentMonitor
