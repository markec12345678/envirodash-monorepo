...
export interface BioluminescentBayMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BioluminescentBayMonitor({ onClose, showClose = true }: BioluminescentBayMonitorProps) {
  return (
...
export default BioluminescentBayMonitor
