...
export interface TsunamiRunupMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TsunamiRunupMonitor({ onClose, showClose = true }: TsunamiRunupMonitorProps) {
  return (
...
export default TsunamiRunupMonitor
