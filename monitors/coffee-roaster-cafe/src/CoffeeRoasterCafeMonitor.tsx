...
export interface CoffeeRoasterCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CoffeeRoasterCafeMonitor({ onClose, showClose = true }: CoffeeRoasterCafeMonitorProps) {
  return (
...
export default CoffeeRoasterCafeMonitor
