...
export interface LightingCeilingFanStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LightingCeilingFanStoreMonitor({ onClose, showClose = true }: LightingCeilingFanStoreMonitorProps) {
  return (
...
export default LightingCeilingFanStoreMonitor
