...
export interface ChiropracticWellnessCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ChiropracticWellnessCafeMonitor({ onClose, showClose = true }: ChiropracticWellnessCafeMonitorProps) {
  return (
...
export default ChiropracticWellnessCafeMonitor
