...
export interface MakeupCosmeticsStudioMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MakeupCosmeticsStudioMonitor({ onClose, showClose = true }: MakeupCosmeticsStudioMonitorProps) {
  return (
...
export default MakeupCosmeticsStudioMonitor
