...
export interface TireRotationShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TireRotationShopMonitor({ onClose, showClose = true }: TireRotationShopMonitorProps) {
  return (
...
export default TireRotationShopMonitor
