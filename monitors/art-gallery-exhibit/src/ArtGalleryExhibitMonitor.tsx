...
export interface ArtGalleryExhibitMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ArtGalleryExhibitMonitor({ onClose, showClose = true }: ArtGalleryExhibitMonitorProps) {
  return (
...
export default ArtGalleryExhibitMonitor
