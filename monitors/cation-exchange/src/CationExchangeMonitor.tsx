...
export interface CationExchangeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CationExchangeMonitor({ onClose, showClose = true }: CationExchangeMonitorProps) {
  return (
...
export default CationExchangeMonitor
