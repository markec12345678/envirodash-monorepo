...
export interface RiverDeltaErosionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RiverDeltaErosionMonitor({ onClose, showClose = true }: RiverDeltaErosionMonitorProps) {
  return (
...
export default RiverDeltaErosionMonitor
