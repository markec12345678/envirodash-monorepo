...
export interface CoralReefRecoveryMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CoralReefRecoveryMonitor({ onClose, showClose = true }: CoralReefRecoveryMonitorProps) {
  return (
...
export default CoralReefRecoveryMonitor
