...
export interface EmergencyDispatch911MonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function EmergencyDispatch911Monitor({ onClose, showClose = true }: EmergencyDispatch911MonitorProps) {
  return (
...
export default EmergencyDispatch911Monitor
