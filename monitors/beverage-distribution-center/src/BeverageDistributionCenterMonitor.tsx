...
export interface BeverageDistributionCenterMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BeverageDistributionCenterMonitor({ onClose, showClose = true }: BeverageDistributionCenterMonitorProps) {
  return (
...
export default BeverageDistributionCenterMonitor
