...
export interface MarathonExpoSportsMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MarathonExpoSportsMonitor({ onClose, showClose = true }: MarathonExpoSportsMonitorProps) {
  return (
...
export default MarathonExpoSportsMonitor
