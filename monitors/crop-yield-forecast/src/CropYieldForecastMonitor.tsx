...
export interface CropYieldForecastMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CropYieldForecastMonitor({ onClose, showClose = true }: CropYieldForecastMonitorProps) {
  return (
...
export default CropYieldForecastMonitor
