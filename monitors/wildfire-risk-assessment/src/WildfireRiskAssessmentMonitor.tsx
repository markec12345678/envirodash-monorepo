...
export interface WildfireRiskAssessmentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WildfireRiskAssessmentMonitor({ onClose, showClose = true }: WildfireRiskAssessmentMonitorProps) {
  return (
...
export default WildfireRiskAssessmentMonitor
