...
export interface TacoBurritoCantinaMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TacoBurritoCantinaMonitor({ onClose, showClose = true }: TacoBurritoCantinaMonitorProps) {
  return (
...
export default TacoBurritoCantinaMonitor
