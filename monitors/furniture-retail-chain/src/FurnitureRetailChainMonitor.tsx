...
export interface FurnitureRetailChainMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FurnitureRetailChainMonitor({ onClose, showClose = true }: FurnitureRetailChainMonitorProps) {
  return (
...
export default FurnitureRetailChainMonitor
