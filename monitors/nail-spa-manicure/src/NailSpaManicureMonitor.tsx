...
export interface NailSpaManicureMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function NailSpaManicureMonitor({ onClose, showClose = true }: NailSpaManicureMonitorProps) {
  return (
...
export default NailSpaManicureMonitor
