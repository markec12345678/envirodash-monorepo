...
export interface KarstSpringDischargeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function KarstSpringDischargeMonitor({ onClose, showClose = true }: KarstSpringDischargeMonitorProps) {
  return (
...
export default KarstSpringDischargeMonitor
