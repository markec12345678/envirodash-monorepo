...
export interface DrinkingWaterQualityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DrinkingWaterQualityMonitor({ onClose, showClose = true }: DrinkingWaterQualityMonitorProps) {
  return (
...
export default DrinkingWaterQualityMonitor
