...
export interface BabysittingServiceMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BabysittingServiceMonitor({ onClose, showClose = true }: BabysittingServiceMonitorProps) {
  return (
...
export default BabysittingServiceMonitor
