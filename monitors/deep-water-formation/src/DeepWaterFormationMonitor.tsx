...
export interface DeepWaterFormationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DeepWaterFormationMonitor({ onClose, showClose = true }: DeepWaterFormationMonitorProps) {
  return (
...
export default DeepWaterFormationMonitor
