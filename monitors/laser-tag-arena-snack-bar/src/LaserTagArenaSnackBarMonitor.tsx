...
export interface LaserTagArenaSnackBarMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LaserTagArenaSnackBarMonitor({ onClose, showClose = true }: LaserTagArenaSnackBarMonitorProps) {
  return (
...
export default LaserTagArenaSnackBarMonitor
