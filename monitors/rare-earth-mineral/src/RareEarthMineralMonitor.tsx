...
export interface RareEarthMineralMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RareEarthMineralMonitor({ onClose, showClose = true }: RareEarthMineralMonitorProps) {
  return (
...
export default RareEarthMineralMonitor
