...
export interface ArcticPermafrostLakesMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ArcticPermafrostLakesMonitor({ onClose, showClose = true }: ArcticPermafrostLakesMonitorProps) {
  return (
...
export default ArcticPermafrostLakesMonitor
