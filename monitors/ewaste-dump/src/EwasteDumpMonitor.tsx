...
export interface EwasteDumpMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function EwasteDumpMonitor({ onClose, showClose = true }: EwasteDumpMonitorProps) {
  return (
...
export default EwasteDumpMonitor
