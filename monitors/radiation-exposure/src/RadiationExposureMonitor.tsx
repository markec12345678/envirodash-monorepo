...
export interface RadiationExposureMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RadiationExposureMonitor({ onClose, showClose = true }: RadiationExposureMonitorProps) {
  return (
...
export default RadiationExposureMonitor
