...
export interface SaltMarshCarbonMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SaltMarshCarbonMonitor({ onClose, showClose = true }: SaltMarshCarbonMonitorProps) {
  return (
...
export default SaltMarshCarbonMonitor
