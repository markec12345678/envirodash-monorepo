...
export interface TransitRidershipMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TransitRidershipMonitor({ onClose, showClose = true }: TransitRidershipMonitorProps) {
  return (
...
export default TransitRidershipMonitor
