...
export interface PaintDecoratingMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PaintDecoratingMonitor({ onClose, showClose = true }: PaintDecoratingMonitorProps) {
  return (
...
export default PaintDecoratingMonitor
