...
export interface PermafrostThawTrackMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PermafrostThawTrackMonitor({ onClose, showClose = true }: PermafrostThawTrackMonitorProps) {
  return (
...
export default PermafrostThawTrackMonitor
