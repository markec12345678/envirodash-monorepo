...
export interface IonosphericDisturbanceMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function IonosphericDisturbanceMonitor({ onClose, showClose = true }: IonosphericDisturbanceMonitorProps) {
  return (
...
export default IonosphericDisturbanceMonitor
