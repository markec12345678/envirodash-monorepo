...
export interface PlantNurseryRetailMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PlantNurseryRetailMonitor({ onClose, showClose = true }: PlantNurseryRetailMonitorProps) {
  return (
...
export default PlantNurseryRetailMonitor
