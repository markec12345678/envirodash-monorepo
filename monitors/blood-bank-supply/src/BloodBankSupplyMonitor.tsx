...
export interface BloodBankSupplyMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BloodBankSupplyMonitor({ onClose, showClose = true }: BloodBankSupplyMonitorProps) {
  return (
...
export default BloodBankSupplyMonitor
