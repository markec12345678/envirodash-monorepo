...
export interface GeomagneticallyInducedCurrentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GeomagneticallyInducedCurrentMonitor({ onClose, showClose = true }: GeomagneticallyInducedCurrentMonitorProps) {
  return (
...
export default GeomagneticallyInducedCurrentMonitor
