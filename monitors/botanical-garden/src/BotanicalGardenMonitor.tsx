...
export interface BotanicalGardenMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BotanicalGardenMonitor({ onClose, showClose = true }: BotanicalGardenMonitorProps) {
  return (
...
export default BotanicalGardenMonitor
