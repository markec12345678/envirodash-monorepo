...
export interface VolcanoThermalMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VolcanoThermalMonitor({ onClose, showClose = true }: VolcanoThermalMonitorProps) {
  return (
...
export default VolcanoThermalMonitor
