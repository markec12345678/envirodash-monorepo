...
export interface ReikiHealingCenterCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ReikiHealingCenterCafeMonitor({ onClose, showClose = true }: ReikiHealingCenterCafeMonitorProps) {
  return (
...
export default ReikiHealingCenterCafeMonitor
