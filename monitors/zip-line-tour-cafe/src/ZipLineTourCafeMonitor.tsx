...
export interface ZipLineTourCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ZipLineTourCafeMonitor({ onClose, showClose = true }: ZipLineTourCafeMonitorProps) {
  return (
...
export default ZipLineTourCafeMonitor
