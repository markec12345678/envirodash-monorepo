...
export interface CoralDiseaseMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CoralDiseaseMonitor({ onClose, showClose = true }: CoralDiseaseMonitorProps) {
  return (
...
export default CoralDiseaseMonitor
