...
export interface ElectricalSupplyMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ElectricalSupplyMonitor({ onClose, showClose = true }: ElectricalSupplyMonitorProps) {
  return (
...
export default ElectricalSupplyMonitor
