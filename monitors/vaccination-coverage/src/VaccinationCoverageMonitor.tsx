...
export interface VaccinationCoverageMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VaccinationCoverageMonitor({ onClose, showClose = true }: VaccinationCoverageMonitorProps) {
  return (
...
export default VaccinationCoverageMonitor
