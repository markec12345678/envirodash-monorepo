...
export interface PermafrostThawMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PermafrostThawMonitor({ onClose, showClose = true }: PermafrostThawMonitorProps) {
  return (
...
export default PermafrostThawMonitor
