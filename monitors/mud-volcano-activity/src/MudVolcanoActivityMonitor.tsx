...
export interface MudVolcanoActivityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MudVolcanoActivityMonitor({ onClose, showClose = true }: MudVolcanoActivityMonitorProps) {
  return (
...
export default MudVolcanoActivityMonitor
