...
export interface KatabaticWindMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function KatabaticWindMonitor({ onClose, showClose = true }: KatabaticWindMonitorProps) {
  return (
...
export default KatabaticWindMonitor
