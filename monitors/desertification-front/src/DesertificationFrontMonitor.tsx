...
export interface DesertificationFrontMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DesertificationFrontMonitor({ onClose, showClose = true }: DesertificationFrontMonitorProps) {
  return (
...
export default DesertificationFrontMonitor
