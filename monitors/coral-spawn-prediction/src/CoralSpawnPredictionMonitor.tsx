...
export interface CoralSpawnPredictionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CoralSpawnPredictionMonitor({ onClose, showClose = true }: CoralSpawnPredictionMonitorProps) {
  return (
...
export default CoralSpawnPredictionMonitor
