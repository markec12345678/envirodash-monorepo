...
export interface DentalOfficePracticeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DentalOfficePracticeMonitor({ onClose, showClose = true }: DentalOfficePracticeMonitorProps) {
  return (
...
export default DentalOfficePracticeMonitor
