...
export interface CryoconiteHoleMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CryoconiteHoleMonitor({ onClose, showClose = true }: CryoconiteHoleMonitorProps) {
  return (
...
export default CryoconiteHoleMonitor
