...
export interface SubmarineCanyonMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SubmarineCanyonMonitor({ onClose, showClose = true }: SubmarineCanyonMonitorProps) {
  return (
...
export default SubmarineCanyonMonitor
