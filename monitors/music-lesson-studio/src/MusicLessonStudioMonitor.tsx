...
export interface MusicLessonStudioMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MusicLessonStudioMonitor({ onClose, showClose = true }: MusicLessonStudioMonitorProps) {
  return (
...
export default MusicLessonStudioMonitor
