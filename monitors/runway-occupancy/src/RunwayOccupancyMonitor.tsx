...
export interface RunwayOccupancyMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RunwayOccupancyMonitor({ onClose, showClose = true }: RunwayOccupancyMonitorProps) {
  return (
...
export default RunwayOccupancyMonitor
