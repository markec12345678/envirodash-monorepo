...
export interface MethaneHydrateStabilityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MethaneHydrateStabilityMonitor({ onClose, showClose = true }: MethaneHydrateStabilityMonitorProps) {
  return (
...
export default MethaneHydrateStabilityMonitor
