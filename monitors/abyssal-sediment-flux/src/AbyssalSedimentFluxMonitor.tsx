...
export interface AbyssalSedimentFluxMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AbyssalSedimentFluxMonitor({ onClose, showClose = true }: AbyssalSedimentFluxMonitorProps) {
  return (
...
export default AbyssalSedimentFluxMonitor
