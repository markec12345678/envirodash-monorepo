...
export interface MangroveRootSystemMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MangroveRootSystemMonitor({ onClose, showClose = true }: MangroveRootSystemMonitorProps) {
  return (
...
export default MangroveRootSystemMonitor
