...
export interface MagnetopauseStandoffMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MagnetopauseStandoffMonitor({ onClose, showClose = true }: MagnetopauseStandoffMonitorProps) {
  return (
...
export default MagnetopauseStandoffMonitor
