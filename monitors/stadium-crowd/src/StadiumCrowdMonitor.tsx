...
export interface StadiumCrowdMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function StadiumCrowdMonitor({ onClose, showClose = true }: StadiumCrowdMonitorProps) {
  return (
...
export default StadiumCrowdMonitor
