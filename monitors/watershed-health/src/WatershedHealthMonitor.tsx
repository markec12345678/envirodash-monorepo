...
export interface WatershedHealthMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WatershedHealthMonitor({ onClose, showClose = true }: WatershedHealthMonitorProps) {
  return (
...
export default WatershedHealthMonitor
