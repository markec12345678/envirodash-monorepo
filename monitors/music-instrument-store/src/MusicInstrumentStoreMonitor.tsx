...
export interface MusicInstrumentStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MusicInstrumentStoreMonitor({ onClose, showClose = true }: MusicInstrumentStoreMonitorProps) {
  return (
...
export default MusicInstrumentStoreMonitor
