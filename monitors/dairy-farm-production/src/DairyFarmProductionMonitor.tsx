...
export interface DairyFarmProductionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DairyFarmProductionMonitor({ onClose, showClose = true }: DairyFarmProductionMonitorProps) {
  return (
...
export default DairyFarmProductionMonitor
