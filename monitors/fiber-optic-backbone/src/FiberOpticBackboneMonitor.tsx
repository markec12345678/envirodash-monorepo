...
export interface FiberOpticBackboneMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FiberOpticBackboneMonitor({ onClose, showClose = true }: FiberOpticBackboneMonitorProps) {
  return (
...
export default FiberOpticBackboneMonitor
