...
export interface HomeDecorBoutiqueMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HomeDecorBoutiqueMonitor({ onClose, showClose = true }: HomeDecorBoutiqueMonitorProps) {
  return (
...
export default HomeDecorBoutiqueMonitor
