...
export interface DamageAssessmentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DamageAssessmentMonitor({ onClose, showClose = true }: DamageAssessmentMonitorProps) {
  return (
...
export default DamageAssessmentMonitor
