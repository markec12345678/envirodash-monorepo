...
export interface AirTrafficControlMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AirTrafficControlMonitor({ onClose, showClose = true }: AirTrafficControlMonitorProps) {
  return (
...
export default AirTrafficControlMonitor
