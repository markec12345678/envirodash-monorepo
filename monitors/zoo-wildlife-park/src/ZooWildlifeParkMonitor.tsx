...
export interface ZooWildlifeParkMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ZooWildlifeParkMonitor({ onClose, showClose = true }: ZooWildlifeParkMonitorProps) {
  return (
...
export default ZooWildlifeParkMonitor
