...
export interface GroinSedimentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GroinSedimentMonitor({ onClose, showClose = true }: GroinSedimentMonitorProps) {
  return (
...
export default GroinSedimentMonitor
