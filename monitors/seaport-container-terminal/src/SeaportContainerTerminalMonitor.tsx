...
export interface SeaportContainerTerminalMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SeaportContainerTerminalMonitor({ onClose, showClose = true }: SeaportContainerTerminalMonitorProps) {
  return (
...
export default SeaportContainerTerminalMonitor
