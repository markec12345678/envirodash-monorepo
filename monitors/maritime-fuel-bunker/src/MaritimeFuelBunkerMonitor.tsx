...
export interface MaritimeFuelBunkerMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MaritimeFuelBunkerMonitor({ onClose, showClose = true }: MaritimeFuelBunkerMonitorProps) {
  return (
...
export default MaritimeFuelBunkerMonitor
