...
export interface SolarIrradianceMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SolarIrradianceMonitor({ onClose, showClose = true }: SolarIrradianceMonitorProps) {
  return (
...
export default SolarIrradianceMonitor
