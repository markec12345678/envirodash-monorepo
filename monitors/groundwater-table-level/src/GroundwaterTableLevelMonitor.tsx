...
export interface GroundwaterTableLevelMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GroundwaterTableLevelMonitor({ onClose, showClose = true }: GroundwaterTableLevelMonitorProps) {
  return (
...
export default GroundwaterTableLevelMonitor
