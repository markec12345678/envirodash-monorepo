...
export interface UrbanSprawlMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function UrbanSprawlMonitor({ onClose, showClose = true }: UrbanSprawlMonitorProps) {
  return (
...
export default UrbanSprawlMonitor
