...
export interface SeamountBiodiversityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SeamountBiodiversityMonitor({ onClose, showClose = true }: SeamountBiodiversityMonitorProps) {
  return (
...
export default SeamountBiodiversityMonitor
