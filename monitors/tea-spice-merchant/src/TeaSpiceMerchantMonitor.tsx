...
export interface TeaSpiceMerchantMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TeaSpiceMerchantMonitor({ onClose, showClose = true }: TeaSpiceMerchantMonitorProps) {
  return (
...
export default TeaSpiceMerchantMonitor
