...
export interface WineryVineyardMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WineryVineyardMonitor({ onClose, showClose = true }: WineryVineyardMonitorProps) {
  return (
...
export default WineryVineyardMonitor
