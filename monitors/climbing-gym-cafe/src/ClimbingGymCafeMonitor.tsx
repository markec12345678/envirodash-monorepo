...
export interface ClimbingGymCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ClimbingGymCafeMonitor({ onClose, showClose = true }: ClimbingGymCafeMonitorProps) {
  return (
...
export default ClimbingGymCafeMonitor
