...
export interface HostelBackpackerMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HostelBackpackerMonitor({ onClose, showClose = true }: HostelBackpackerMonitorProps) {
  return (
...
export default HostelBackpackerMonitor
