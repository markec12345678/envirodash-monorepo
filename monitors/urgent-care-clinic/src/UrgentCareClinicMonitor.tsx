...
export interface UrgentCareClinicMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function UrgentCareClinicMonitor({ onClose, showClose = true }: UrgentCareClinicMonitorProps) {
  return (
...
export default UrgentCareClinicMonitor
