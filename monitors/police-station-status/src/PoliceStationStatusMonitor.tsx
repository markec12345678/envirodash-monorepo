...
export interface PoliceStationStatusMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PoliceStationStatusMonitor({ onClose, showClose = true }: PoliceStationStatusMonitorProps) {
  return (
...
export default PoliceStationStatusMonitor
