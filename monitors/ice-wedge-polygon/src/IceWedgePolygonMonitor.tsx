...
export interface IceWedgePolygonMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function IceWedgePolygonMonitor({ onClose, showClose = true }: IceWedgePolygonMonitorProps) {
  return (
...
export default IceWedgePolygonMonitor
