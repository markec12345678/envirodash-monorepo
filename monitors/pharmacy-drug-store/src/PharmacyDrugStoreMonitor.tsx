...
export interface PharmacyDrugStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PharmacyDrugStoreMonitor({ onClose, showClose = true }: PharmacyDrugStoreMonitorProps) {
  return (
...
export default PharmacyDrugStoreMonitor
