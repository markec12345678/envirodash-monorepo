...
export interface PetDaycareCenterMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PetDaycareCenterMonitor({ onClose, showClose = true }: PetDaycareCenterMonitorProps) {
  return (
...
export default PetDaycareCenterMonitor
