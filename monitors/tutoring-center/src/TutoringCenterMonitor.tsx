...
export interface TutoringCenterMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TutoringCenterMonitor({ onClose, showClose = true }: TutoringCenterMonitorProps) {
  return (
...
export default TutoringCenterMonitor
