...
export interface SkiSnowboardShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SkiSnowboardShopMonitor({ onClose, showClose = true }: SkiSnowboardShopMonitorProps) {
  return (
...
export default SkiSnowboardShopMonitor
