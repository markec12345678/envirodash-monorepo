...
export interface KarstSinkholeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function KarstSinkholeMonitor({ onClose, showClose = true }: KarstSinkholeMonitorProps) {
  return (
...
export default KarstSinkholeMonitor
