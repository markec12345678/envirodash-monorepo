...
export interface FintechHubActivityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FintechHubActivityMonitor({ onClose, showClose = true }: FintechHubActivityMonitorProps) {
  return (
...
export default FintechHubActivityMonitor
