...
export interface BridgeStructuralIntegrityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BridgeStructuralIntegrityMonitor({ onClose, showClose = true }: BridgeStructuralIntegrityMonitorProps) {
  return (
...
export default BridgeStructuralIntegrityMonitor
