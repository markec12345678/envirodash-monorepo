...
export interface ShippingPackagingStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ShippingPackagingStoreMonitor({ onClose, showClose = true }: ShippingPackagingStoreMonitorProps) {
  return (
...
export default ShippingPackagingStoreMonitor
