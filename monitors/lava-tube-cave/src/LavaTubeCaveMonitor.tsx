...
export interface LavaTubeCaveMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LavaTubeCaveMonitor({ onClose, showClose = true }: LavaTubeCaveMonitorProps) {
  return (
...
export default LavaTubeCaveMonitor
