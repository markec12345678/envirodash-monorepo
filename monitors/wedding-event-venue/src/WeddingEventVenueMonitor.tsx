...
export interface WeddingEventVenueMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WeddingEventVenueMonitor({ onClose, showClose = true }: WeddingEventVenueMonitorProps) {
  return (
...
export default WeddingEventVenueMonitor
