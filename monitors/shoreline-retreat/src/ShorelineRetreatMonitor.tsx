...
export interface ShorelineRetreatMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ShorelineRetreatMonitor({ onClose, showClose = true }: ShorelineRetreatMonitorProps) {
  return (
...
export default ShorelineRetreatMonitor
