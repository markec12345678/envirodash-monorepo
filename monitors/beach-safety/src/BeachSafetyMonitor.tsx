...
export interface BeachSafetyMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BeachSafetyMonitor({ onClose, showClose = true }: BeachSafetyMonitorProps) {
  return (
...
export default BeachSafetyMonitor
