...
export interface LandslideSusceptibilityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LandslideSusceptibilityMonitor({ onClose, showClose = true }: LandslideSusceptibilityMonitorProps) {
  return (
...
export default LandslideSusceptibilityMonitor
