...
export interface ThemeParkRestaurantMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ThemeParkRestaurantMonitor({ onClose, showClose = true }: ThemeParkRestaurantMonitorProps) {
  return (
...
export default ThemeParkRestaurantMonitor
