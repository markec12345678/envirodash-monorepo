...
export interface BiomassBurningMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BiomassBurningMonitor({ onClose, showClose = true }: BiomassBurningMonitorProps) {
  return (
...
export default BiomassBurningMonitor
