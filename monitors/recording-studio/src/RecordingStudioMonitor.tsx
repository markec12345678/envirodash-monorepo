...
export interface RecordingStudioMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RecordingStudioMonitor({ onClose, showClose = true }: RecordingStudioMonitorProps) {
  return (
...
export default RecordingStudioMonitor
