...
export interface VitaminSupplementShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VitaminSupplementShopMonitor({ onClose, showClose = true }: VitaminSupplementShopMonitorProps) {
  return (
...
export default VitaminSupplementShopMonitor
