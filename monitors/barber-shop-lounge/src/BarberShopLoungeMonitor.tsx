...
export interface BarberShopLoungeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BarberShopLoungeMonitor({ onClose, showClose = true }: BarberShopLoungeMonitorProps) {
  return (
...
export default BarberShopLoungeMonitor
