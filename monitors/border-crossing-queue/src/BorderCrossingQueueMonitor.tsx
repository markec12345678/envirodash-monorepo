...
export interface BorderCrossingQueueMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BorderCrossingQueueMonitor({ onClose, showClose = true }: BorderCrossingQueueMonitorProps) {
  return (
...
export default BorderCrossingQueueMonitor
