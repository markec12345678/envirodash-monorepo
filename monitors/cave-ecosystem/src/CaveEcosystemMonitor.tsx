...
export interface CaveEcosystemMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CaveEcosystemMonitor({ onClose, showClose = true }: CaveEcosystemMonitorProps) {
  return (
...
export default CaveEcosystemMonitor
