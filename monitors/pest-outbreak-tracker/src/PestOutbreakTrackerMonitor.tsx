...
export interface PestOutbreakTrackerMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PestOutbreakTrackerMonitor({ onClose, showClose = true }: PestOutbreakTrackerMonitorProps) {
  return (
...
export default PestOutbreakTrackerMonitor
