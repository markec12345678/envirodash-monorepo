...
export interface EkmanTransportMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function EkmanTransportMonitor({ onClose, showClose = true }: EkmanTransportMonitorProps) {
  return (
...
export default EkmanTransportMonitor
