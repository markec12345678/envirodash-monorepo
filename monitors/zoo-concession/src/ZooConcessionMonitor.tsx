...
export interface ZooConcessionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ZooConcessionMonitor({ onClose, showClose = true }: ZooConcessionMonitorProps) {
  return (
...
export default ZooConcessionMonitor
