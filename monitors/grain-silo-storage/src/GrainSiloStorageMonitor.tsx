...
export interface GrainSiloStorageMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GrainSiloStorageMonitor({ onClose, showClose = true }: GrainSiloStorageMonitorProps) {
  return (
...
export default GrainSiloStorageMonitor
