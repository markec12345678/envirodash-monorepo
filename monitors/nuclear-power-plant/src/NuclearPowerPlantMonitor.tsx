...
export interface NuclearPowerPlantMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function NuclearPowerPlantMonitor({ onClose, showClose = true }: NuclearPowerPlantMonitorProps) {
  return (
...
export default NuclearPowerPlantMonitor
