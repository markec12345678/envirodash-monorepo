...
export interface JetSkiRentalSnackBarMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function JetSkiRentalSnackBarMonitor({ onClose, showClose = true }: JetSkiRentalSnackBarMonitorProps) {
  return (
...
export default JetSkiRentalSnackBarMonitor
