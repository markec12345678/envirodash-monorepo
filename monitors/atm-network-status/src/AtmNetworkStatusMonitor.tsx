...
export interface AtmNetworkStatusMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AtmNetworkStatusMonitor({ onClose, showClose = true }: AtmNetworkStatusMonitorProps) {
  return (
...
export default AtmNetworkStatusMonitor
