...
export interface BaseballSpringTrainingMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BaseballSpringTrainingMonitor({ onClose, showClose = true }: BaseballSpringTrainingMonitorProps) {
  return (
...
export default BaseballSpringTrainingMonitor
