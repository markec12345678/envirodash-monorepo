...
export interface PowerToolsRetailMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PowerToolsRetailMonitor({ onClose, showClose = true }: PowerToolsRetailMonitorProps) {
  return (
...
export default PowerToolsRetailMonitor
