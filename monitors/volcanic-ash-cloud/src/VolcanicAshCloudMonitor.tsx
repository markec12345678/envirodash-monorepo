...
export interface VolcanicAshCloudMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VolcanicAshCloudMonitor({ onClose, showClose = true }: VolcanicAshCloudMonitorProps) {
  return (
...
export default VolcanicAshCloudMonitor
