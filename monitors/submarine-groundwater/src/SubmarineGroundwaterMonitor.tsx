...
export interface SubmarineGroundwaterMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SubmarineGroundwaterMonitor({ onClose, showClose = true }: SubmarineGroundwaterMonitorProps) {
  return (
...
export default SubmarineGroundwaterMonitor
