...
export interface HabitatFragmentationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HabitatFragmentationMonitor({ onClose, showClose = true }: HabitatFragmentationMonitorProps) {
  return (
...
export default HabitatFragmentationMonitor
