...
export interface ThermokarstLakeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ThermokarstLakeMonitor({ onClose, showClose = true }: ThermokarstLakeMonitorProps) {
  return (
...
export default ThermokarstLakeMonitor
