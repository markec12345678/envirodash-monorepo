...
export interface GoKartTrackConcessionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GoKartTrackConcessionMonitor({ onClose, showClose = true }: GoKartTrackConcessionMonitorProps) {
  return (
...
export default GoKartTrackConcessionMonitor
