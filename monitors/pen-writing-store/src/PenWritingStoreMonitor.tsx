...
export interface PenWritingStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PenWritingStoreMonitor({ onClose, showClose = true }: PenWritingStoreMonitorProps) {
  return (
...
export default PenWritingStoreMonitor
