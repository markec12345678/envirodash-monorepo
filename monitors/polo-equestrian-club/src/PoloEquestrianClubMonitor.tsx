...
export interface PoloEquestrianClubMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PoloEquestrianClubMonitor({ onClose, showClose = true }: PoloEquestrianClubMonitorProps) {
  return (
...
export default PoloEquestrianClubMonitor
