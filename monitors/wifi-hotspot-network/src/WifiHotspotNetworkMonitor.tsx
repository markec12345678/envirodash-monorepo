...
export interface WifiHotspotNetworkMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WifiHotspotNetworkMonitor({ onClose, showClose = true }: WifiHotspotNetworkMonitorProps) {
  return (
...
export default WifiHotspotNetworkMonitor
