...
export interface AviationFuelDepotMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AviationFuelDepotMonitor({ onClose, showClose = true }: AviationFuelDepotMonitorProps) {
  return (
...
export default AviationFuelDepotMonitor
