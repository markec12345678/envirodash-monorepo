...
export interface EnergyStorageLevelMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function EnergyStorageLevelMonitor({ onClose, showClose = true }: EnergyStorageLevelMonitorProps) {
  return (
...
export default EnergyStorageLevelMonitor
