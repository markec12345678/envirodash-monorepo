...
export interface HarvestYieldPredictMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HarvestYieldPredictMonitor({ onClose, showClose = true }: HarvestYieldPredictMonitorProps) {
  return (
...
export default HarvestYieldPredictMonitor
