...
export interface TropopauseHeightMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TropopauseHeightMonitor({ onClose, showClose = true }: TropopauseHeightMonitorProps) {
  return (
...
export default TropopauseHeightMonitor
