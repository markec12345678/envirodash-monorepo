...
export interface ThermalPollutionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ThermalPollutionMonitor({ onClose, showClose = true }: ThermalPollutionMonitorProps) {
  return (
...
export default ThermalPollutionMonitor
