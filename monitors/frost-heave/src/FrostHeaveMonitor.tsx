...
export interface FrostHeaveMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FrostHeaveMonitor({ onClose, showClose = true }: FrostHeaveMonitorProps) {
  return (
...
export default FrostHeaveMonitor
