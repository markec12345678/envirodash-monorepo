...
export interface DiseaseOutbreakMapMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DiseaseOutbreakMapMonitor({ onClose, showClose = true }: DiseaseOutbreakMapMonitorProps) {
  return (
...
export default DiseaseOutbreakMapMonitor
