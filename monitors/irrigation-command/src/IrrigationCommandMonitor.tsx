...
export interface IrrigationCommandMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function IrrigationCommandMonitor({ onClose, showClose = true }: IrrigationCommandMonitorProps) {
  return (
...
export default IrrigationCommandMonitor
