...
export interface BarberShopClassicMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BarberShopClassicMonitor({ onClose, showClose = true }: BarberShopClassicMonitorProps) {
  return (
...
export default BarberShopClassicMonitor
