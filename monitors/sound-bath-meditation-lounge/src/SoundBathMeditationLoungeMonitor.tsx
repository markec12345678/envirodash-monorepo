...
export interface SoundBathMeditationLoungeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SoundBathMeditationLoungeMonitor({ onClose, showClose = true }: SoundBathMeditationLoungeMonitorProps) {
  return (
...
export default SoundBathMeditationLoungeMonitor
