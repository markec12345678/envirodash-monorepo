...
export interface ComputerSpecialtyStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ComputerSpecialtyStoreMonitor({ onClose, showClose = true }: ComputerSpecialtyStoreMonitorProps) {
  return (
...
export default ComputerSpecialtyStoreMonitor
