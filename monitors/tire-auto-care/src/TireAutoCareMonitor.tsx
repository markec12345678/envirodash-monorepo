...
export interface TireAutoCareMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TireAutoCareMonitor({ onClose, showClose = true }: TireAutoCareMonitorProps) {
  return (
...
export default TireAutoCareMonitor
