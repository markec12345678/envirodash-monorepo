...
export interface DrivingSchoolAcademyMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DrivingSchoolAcademyMonitor({ onClose, showClose = true }: DrivingSchoolAcademyMonitorProps) {
  return (
...
export default DrivingSchoolAcademyMonitor
