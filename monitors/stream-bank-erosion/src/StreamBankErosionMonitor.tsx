...
export interface StreamBankErosionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function StreamBankErosionMonitor({ onClose, showClose = true }: StreamBankErosionMonitorProps) {
  return (
...
export default StreamBankErosionMonitor
