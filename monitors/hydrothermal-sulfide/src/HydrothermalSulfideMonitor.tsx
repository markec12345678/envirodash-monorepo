...
export interface HydrothermalSulfideMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HydrothermalSulfideMonitor({ onClose, showClose = true }: HydrothermalSulfideMonitorProps) {
  return (
...
export default HydrothermalSulfideMonitor
