...
export interface StationeryStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function StationeryStoreMonitor({ onClose, showClose = true }: StationeryStoreMonitorProps) {
  return (
...
export default StationeryStoreMonitor
