...
export interface MountainSkiLodgeRestaurantMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MountainSkiLodgeRestaurantMonitor({ onClose, showClose = true }: MountainSkiLodgeRestaurantMonitorProps) {
  return (
...
export default MountainSkiLodgeRestaurantMonitor
