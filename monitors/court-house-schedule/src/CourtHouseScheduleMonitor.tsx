...
export interface CourtHouseScheduleMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CourtHouseScheduleMonitor({ onClose, showClose = true }: CourtHouseScheduleMonitorProps) {
  return (
...
export default CourtHouseScheduleMonitor
