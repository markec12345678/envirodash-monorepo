...
export interface DisasterResponseCoordMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DisasterResponseCoordMonitor({ onClose, showClose = true }: DisasterResponseCoordMonitorProps) {
  return (
...
export default DisasterResponseCoordMonitor
