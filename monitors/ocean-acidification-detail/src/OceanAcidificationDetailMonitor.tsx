...
export interface OceanAcidificationDetailMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function OceanAcidificationDetailMonitor({ onClose, showClose = true }: OceanAcidificationDetailMonitorProps) {
  return (
...
export default OceanAcidificationDetailMonitor
