...
export interface ConferenceConventionCenterMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ConferenceConventionCenterMonitor({ onClose, showClose = true }: ConferenceConventionCenterMonitorProps) {
  return (
...
export default ConferenceConventionCenterMonitor
