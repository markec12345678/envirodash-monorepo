...
export interface ApplianceRetailStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ApplianceRetailStoreMonitor({ onClose, showClose = true }: ApplianceRetailStoreMonitorProps) {
  return (
...
export default ApplianceRetailStoreMonitor
