...
export interface SubmarineLandslideMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SubmarineLandslideMonitor({ onClose, showClose = true }: SubmarineLandslideMonitorProps) {
  return (
...
export default SubmarineLandslideMonitor
