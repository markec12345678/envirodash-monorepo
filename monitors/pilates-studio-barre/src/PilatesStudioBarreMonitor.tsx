...
export interface PilatesStudioBarreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PilatesStudioBarreMonitor({ onClose, showClose = true }: PilatesStudioBarreMonitorProps) {
  return (
...
export default PilatesStudioBarreMonitor
