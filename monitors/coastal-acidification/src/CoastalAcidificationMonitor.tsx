...
export interface CoastalAcidificationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CoastalAcidificationMonitor({ onClose, showClose = true }: CoastalAcidificationMonitorProps) {
  return (
...
export default CoastalAcidificationMonitor
