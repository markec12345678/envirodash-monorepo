...
export interface NationalParkLodgeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function NationalParkLodgeMonitor({ onClose, showClose = true }: NationalParkLodgeMonitorProps) {
  return (
...
export default NationalParkLodgeMonitor
