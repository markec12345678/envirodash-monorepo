...
export interface JuiceBarSmoothieShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function JuiceBarSmoothieShopMonitor({ onClose, showClose = true }: JuiceBarSmoothieShopMonitorProps) {
  return (
...
export default JuiceBarSmoothieShopMonitor
