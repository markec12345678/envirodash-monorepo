...
export interface HouseboatRentalCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HouseboatRentalCafeMonitor({ onClose, showClose = true }: HouseboatRentalCafeMonitorProps) {
  return (
...
export default HouseboatRentalCafeMonitor
