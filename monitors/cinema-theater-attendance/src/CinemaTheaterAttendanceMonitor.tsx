...
export interface CinemaTheaterAttendanceMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CinemaTheaterAttendanceMonitor({ onClose, showClose = true }: CinemaTheaterAttendanceMonitorProps) {
  return (
...
export default CinemaTheaterAttendanceMonitor
