...
export interface JewelryWatchStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function JewelryWatchStoreMonitor({ onClose, showClose = true }: JewelryWatchStoreMonitorProps) {
  return (
...
export default JewelryWatchStoreMonitor
