...
export interface GlassManufacturingMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GlassManufacturingMonitor({ onClose, showClose = true }: GlassManufacturingMonitorProps) {
  return (
...
export default GlassManufacturingMonitor
