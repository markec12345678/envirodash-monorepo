...
export interface AirportLoungeDiningMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AirportLoungeDiningMonitor({ onClose, showClose = true }: AirportLoungeDiningMonitorProps) {
  return (
...
export default AirportLoungeDiningMonitor
