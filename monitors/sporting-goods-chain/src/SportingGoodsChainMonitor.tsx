...
export interface SportingGoodsChainMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SportingGoodsChainMonitor({ onClose, showClose = true }: SportingGoodsChainMonitorProps) {
  return (
...
export default SportingGoodsChainMonitor
