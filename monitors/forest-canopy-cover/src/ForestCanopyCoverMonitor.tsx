...
export interface ForestCanopyCoverMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ForestCanopyCoverMonitor({ onClose, showClose = true }: ForestCanopyCoverMonitorProps) {
  return (
...
export default ForestCanopyCoverMonitor
