...
export interface PhytoBloomMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PhytoBloomMonitor({ onClose, showClose = true }: PhytoBloomMonitorProps) {
  return (
...
export default PhytoBloomMonitor
