...
export interface DamIntegrityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DamIntegrityMonitor({ onClose, showClose = true }: DamIntegrityMonitorProps) {
  return (
...
export default DamIntegrityMonitor
