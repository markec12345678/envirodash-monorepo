...
export interface BottlingPlantLineMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BottlingPlantLineMonitor({ onClose, showClose = true }: BottlingPlantLineMonitorProps) {
  return (
...
export default BottlingPlantLineMonitor
