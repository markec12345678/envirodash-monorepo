...
export interface TransferStationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TransferStationMonitor({ onClose, showClose = true }: TransferStationMonitorProps) {
  return (
...
export default TransferStationMonitor
