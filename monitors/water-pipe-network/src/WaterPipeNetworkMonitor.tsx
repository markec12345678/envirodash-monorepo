...
export interface WaterPipeNetworkMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WaterPipeNetworkMonitor({ onClose, showClose = true }: WaterPipeNetworkMonitorProps) {
  return (
...
export default WaterPipeNetworkMonitor
