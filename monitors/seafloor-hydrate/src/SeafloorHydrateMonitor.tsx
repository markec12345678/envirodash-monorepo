...
export interface SeafloorHydrateMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SeafloorHydrateMonitor({ onClose, showClose = true }: SeafloorHydrateMonitorProps) {
  return (
...
export default SeafloorHydrateMonitor
