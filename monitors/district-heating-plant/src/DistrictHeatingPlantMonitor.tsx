...
export interface DistrictHeatingPlantMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DistrictHeatingPlantMonitor({ onClose, showClose = true }: DistrictHeatingPlantMonitorProps) {
  return (
...
export default DistrictHeatingPlantMonitor
