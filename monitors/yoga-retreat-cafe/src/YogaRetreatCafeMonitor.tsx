...
export interface YogaRetreatCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function YogaRetreatCafeMonitor({ onClose, showClose = true }: YogaRetreatCafeMonitorProps) {
  return (
...
export default YogaRetreatCafeMonitor
