...
export interface FoodProcessingPlantMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FoodProcessingPlantMonitor({ onClose, showClose = true }: FoodProcessingPlantMonitorProps) {
  return (
...
export default FoodProcessingPlantMonitor
