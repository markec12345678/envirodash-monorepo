...
export interface CarWashDetailingMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CarWashDetailingMonitor({ onClose, showClose = true }: CarWashDetailingMonitorProps) {
  return (
...
export default CarWashDetailingMonitor
