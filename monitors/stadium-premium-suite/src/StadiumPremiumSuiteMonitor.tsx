...
export interface StadiumPremiumSuiteMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function StadiumPremiumSuiteMonitor({ onClose, showClose = true }: StadiumPremiumSuiteMonitorProps) {
  return (
...
export default StadiumPremiumSuiteMonitor
