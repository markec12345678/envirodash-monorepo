...
export interface DiamondMineOutputMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DiamondMineOutputMonitor({ onClose, showClose = true }: DiamondMineOutputMonitorProps) {
  return (
...
export default DiamondMineOutputMonitor
