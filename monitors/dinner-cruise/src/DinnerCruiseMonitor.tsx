...
export interface DinnerCruiseMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DinnerCruiseMonitor({ onClose, showClose = true }: DinnerCruiseMonitorProps) {
  return (
...
export default DinnerCruiseMonitor
