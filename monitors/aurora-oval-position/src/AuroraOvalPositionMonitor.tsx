...
export interface AuroraOvalPositionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AuroraOvalPositionMonitor({ onClose, showClose = true }: AuroraOvalPositionMonitorProps) {
  return (
...
export default AuroraOvalPositionMonitor
