...
export interface WatershedDischargeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WatershedDischargeMonitor({ onClose, showClose = true }: WatershedDischargeMonitorProps) {
  return (
...
export default WatershedDischargeMonitor
