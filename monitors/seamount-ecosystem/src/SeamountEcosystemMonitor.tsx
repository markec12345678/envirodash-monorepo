...
export interface SeamountEcosystemMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SeamountEcosystemMonitor({ onClose, showClose = true }: SeamountEcosystemMonitorProps) {
  return (
...
export default SeamountEcosystemMonitor
