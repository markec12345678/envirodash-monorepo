...
export interface SaltwaterIntrusionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SaltwaterIntrusionMonitor({ onClose, showClose = true }: SaltwaterIntrusionMonitorProps) {
  return (
...
export default SaltwaterIntrusionMonitor
