...
export interface OceanStratificationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function OceanStratificationMonitor({ onClose, showClose = true }: OceanStratificationMonitorProps) {
  return (
...
export default OceanStratificationMonitor
