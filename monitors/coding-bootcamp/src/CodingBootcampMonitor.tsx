...
export interface CodingBootcampMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CodingBootcampMonitor({ onClose, showClose = true }: CodingBootcampMonitorProps) {
  return (
...
export default CodingBootcampMonitor
