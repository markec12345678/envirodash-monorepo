...
export interface DefenseLogisticsDepotMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DefenseLogisticsDepotMonitor({ onClose, showClose = true }: DefenseLogisticsDepotMonitorProps) {
  return (
...
export default DefenseLogisticsDepotMonitor
