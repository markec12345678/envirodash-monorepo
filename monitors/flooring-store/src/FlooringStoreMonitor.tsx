...
export interface FlooringStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FlooringStoreMonitor({ onClose, showClose = true }: FlooringStoreMonitorProps) {
  return (
...
export default FlooringStoreMonitor
