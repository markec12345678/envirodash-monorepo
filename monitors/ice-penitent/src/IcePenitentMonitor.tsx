...
export interface IcePenitentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function IcePenitentMonitor({ onClose, showClose = true }: IcePenitentMonitorProps) {
  return (
...
export default IcePenitentMonitor
