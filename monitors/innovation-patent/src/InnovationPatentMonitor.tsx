...
export interface InnovationPatentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function InnovationPatentMonitor({ onClose, showClose = true }: InnovationPatentMonitorProps) {
  return (
...
export default InnovationPatentMonitor
