...
export interface StreetMarketActivityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function StreetMarketActivityMonitor({ onClose, showClose = true }: StreetMarketActivityMonitorProps) {
  return (
...
export default StreetMarketActivityMonitor
