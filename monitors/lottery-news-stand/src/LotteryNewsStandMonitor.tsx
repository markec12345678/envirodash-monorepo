...
export interface LotteryNewsStandMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LotteryNewsStandMonitor({ onClose, showClose = true }: LotteryNewsStandMonitorProps) {
  return (
...
export default LotteryNewsStandMonitor
