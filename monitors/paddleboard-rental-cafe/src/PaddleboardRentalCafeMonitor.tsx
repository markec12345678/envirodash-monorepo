...
export interface PaddleboardRentalCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PaddleboardRentalCafeMonitor({ onClose, showClose = true }: PaddleboardRentalCafeMonitorProps) {
  return (
...
export default PaddleboardRentalCafeMonitor
