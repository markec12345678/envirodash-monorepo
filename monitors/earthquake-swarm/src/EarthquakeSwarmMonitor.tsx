...
export interface EarthquakeSwarmMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function EarthquakeSwarmMonitor({ onClose, showClose = true }: EarthquakeSwarmMonitorProps) {
  return (
...
export default EarthquakeSwarmMonitor
