...
export interface VeterinaryHospitalEmergencyMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VeterinaryHospitalEmergencyMonitor({ onClose, showClose = true }: VeterinaryHospitalEmergencyMonitorProps) {
  return (
...
export default VeterinaryHospitalEmergencyMonitor
