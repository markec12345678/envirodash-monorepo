...
export interface BookstoreRetailChainMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BookstoreRetailChainMonitor({ onClose, showClose = true }: BookstoreRetailChainMonitorProps) {
  return (
...
export default BookstoreRetailChainMonitor
