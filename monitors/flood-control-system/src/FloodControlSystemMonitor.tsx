...
export interface FloodControlSystemMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FloodControlSystemMonitor({ onClose, showClose = true }: FloodControlSystemMonitorProps) {
  return (
...
export default FloodControlSystemMonitor
