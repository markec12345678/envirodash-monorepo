...
export interface SatelliteDragMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SatelliteDragMonitor({ onClose, showClose = true }: SatelliteDragMonitorProps) {
  return (
...
export default SatelliteDragMonitor
