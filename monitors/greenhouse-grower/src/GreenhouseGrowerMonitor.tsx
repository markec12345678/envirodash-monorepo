...
export interface GreenhouseGrowerMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GreenhouseGrowerMonitor({ onClose, showClose = true }: GreenhouseGrowerMonitorProps) {
  return (
...
export default GreenhouseGrowerMonitor
