...
export interface UpwellingIntensityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function UpwellingIntensityMonitor({ onClose, showClose = true }: UpwellingIntensityMonitorProps) {
  return (
...
export default UpwellingIntensityMonitor
