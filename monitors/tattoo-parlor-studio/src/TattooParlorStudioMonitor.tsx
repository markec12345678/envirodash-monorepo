...
export interface TattooParlorStudioMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TattooParlorStudioMonitor({ onClose, showClose = true }: TattooParlorStudioMonitorProps) {
  return (
...
export default TattooParlorStudioMonitor
