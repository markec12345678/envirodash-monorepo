...
export interface WomensHealthClinicMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WomensHealthClinicMonitor({ onClose, showClose = true }: WomensHealthClinicMonitorProps) {
  return (
...
export default WomensHealthClinicMonitor
