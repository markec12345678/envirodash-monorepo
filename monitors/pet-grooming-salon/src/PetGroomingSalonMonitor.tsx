...
export interface PetGroomingSalonMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PetGroomingSalonMonitor({ onClose, showClose = true }: PetGroomingSalonMonitorProps) {
  return (
...
export default PetGroomingSalonMonitor
