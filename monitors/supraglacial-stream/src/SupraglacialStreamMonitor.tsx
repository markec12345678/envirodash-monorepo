...
export interface SupraglacialStreamMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SupraglacialStreamMonitor({ onClose, showClose = true }: SupraglacialStreamMonitorProps) {
  return (
...
export default SupraglacialStreamMonitor
