...
export interface RollerRinkSnackBarMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RollerRinkSnackBarMonitor({ onClose, showClose = true }: RollerRinkSnackBarMonitorProps) {
  return (
...
export default RollerRinkSnackBarMonitor
