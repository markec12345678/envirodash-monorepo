...
export interface EstheticianMedSpaMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function EstheticianMedSpaMonitor({ onClose, showClose = true }: EstheticianMedSpaMonitorProps) {
  return (
...
export default EstheticianMedSpaMonitor
