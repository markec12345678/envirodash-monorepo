...
export interface KitchenBathFixtureStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function KitchenBathFixtureStoreMonitor({ onClose, showClose = true }: KitchenBathFixtureStoreMonitorProps) {
  return (
...
export default KitchenBathFixtureStoreMonitor
