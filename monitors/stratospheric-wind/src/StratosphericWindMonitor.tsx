...
export interface StratosphericWindMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function StratosphericWindMonitor({ onClose, showClose = true }: StratosphericWindMonitorProps) {
  return (
...
export default StratosphericWindMonitor
