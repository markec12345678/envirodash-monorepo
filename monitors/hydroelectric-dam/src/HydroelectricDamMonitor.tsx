...
export interface HydroelectricDamMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HydroelectricDamMonitor({ onClose, showClose = true }: HydroelectricDamMonitorProps) {
  return (
...
export default HydroelectricDamMonitor
