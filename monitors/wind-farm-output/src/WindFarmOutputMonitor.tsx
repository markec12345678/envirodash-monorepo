...
export interface WindFarmOutputMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WindFarmOutputMonitor({ onClose, showClose = true }: WindFarmOutputMonitorProps) {
  return (
...
export default WindFarmOutputMonitor
