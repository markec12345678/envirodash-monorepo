...
export interface CorporateGiftingStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CorporateGiftingStoreMonitor({ onClose, showClose = true }: CorporateGiftingStoreMonitorProps) {
  return (
...
export default CorporateGiftingStoreMonitor
