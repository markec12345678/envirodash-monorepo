...
export interface TidalEnergyPotentialMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TidalEnergyPotentialMonitor({ onClose, showClose = true }: TidalEnergyPotentialMonitorProps) {
  return (
...
export default TidalEnergyPotentialMonitor
