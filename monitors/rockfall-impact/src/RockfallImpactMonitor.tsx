...
export interface RockfallImpactMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RockfallImpactMonitor({ onClose, showClose = true }: RockfallImpactMonitorProps) {
  return (
...
export default RockfallImpactMonitor
