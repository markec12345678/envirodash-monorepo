...
export interface FertilizerRunoffMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FertilizerRunoffMonitor({ onClose, showClose = true }: FertilizerRunoffMonitorProps) {
  return (
...
export default FertilizerRunoffMonitor
