...
export interface HyporheicZoneMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HyporheicZoneMonitor({ onClose, showClose = true }: HyporheicZoneMonitorProps) {
  return (
...
export default HyporheicZoneMonitor
