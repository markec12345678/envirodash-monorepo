...
export interface SubmarineCanyonFisheriesMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SubmarineCanyonFisheriesMonitor({ onClose, showClose = true }: SubmarineCanyonFisheriesMonitorProps) {
  return (
...
export default SubmarineCanyonFisheriesMonitor
