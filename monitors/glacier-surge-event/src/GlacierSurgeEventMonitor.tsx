...
export interface GlacierSurgeEventMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GlacierSurgeEventMonitor({ onClose, showClose = true }: GlacierSurgeEventMonitorProps) {
  return (
...
export default GlacierSurgeEventMonitor
