...
export interface GlacialLakeOutburstMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GlacialLakeOutburstMonitor({ onClose, showClose = true }: GlacialLakeOutburstMonitorProps) {
  return (
...
export default GlacialLakeOutburstMonitor
