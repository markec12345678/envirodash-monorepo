...
export interface VesselTrafficManagementMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VesselTrafficManagementMonitor({ onClose, showClose = true }: VesselTrafficManagementMonitorProps) {
  return (
...
export default VesselTrafficManagementMonitor
