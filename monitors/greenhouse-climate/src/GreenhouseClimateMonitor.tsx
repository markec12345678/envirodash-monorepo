...
export interface GreenhouseClimateMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GreenhouseClimateMonitor({ onClose, showClose = true }: GreenhouseClimateMonitorProps) {
  return (
...
export default GreenhouseClimateMonitor
