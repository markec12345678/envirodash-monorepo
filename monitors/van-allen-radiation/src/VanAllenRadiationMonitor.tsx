...
export interface VanAllenRadiationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VanAllenRadiationMonitor({ onClose, showClose = true }: VanAllenRadiationMonitorProps) {
  return (
...
export default VanAllenRadiationMonitor
