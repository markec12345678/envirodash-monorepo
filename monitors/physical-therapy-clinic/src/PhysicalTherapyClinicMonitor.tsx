...
export interface PhysicalTherapyClinicMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PhysicalTherapyClinicMonitor({ onClose, showClose = true }: PhysicalTherapyClinicMonitorProps) {
  return (
...
export default PhysicalTherapyClinicMonitor
