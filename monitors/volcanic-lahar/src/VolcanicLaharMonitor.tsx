...
export interface VolcanicLaharMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VolcanicLaharMonitor({ onClose, showClose = true }: VolcanicLaharMonitorProps) {
  return (
...
export default VolcanicLaharMonitor
