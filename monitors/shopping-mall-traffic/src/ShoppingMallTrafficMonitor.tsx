...
export interface ShoppingMallTrafficMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ShoppingMallTrafficMonitor({ onClose, showClose = true }: ShoppingMallTrafficMonitorProps) {
  return (
...
export default ShoppingMallTrafficMonitor
