...
export interface MilitaryTrainingRangeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MilitaryTrainingRangeMonitor({ onClose, showClose = true }: MilitaryTrainingRangeMonitorProps) {
  return (
...
export default MilitaryTrainingRangeMonitor
