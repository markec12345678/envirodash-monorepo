...
export interface TeamSportApparelMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TeamSportApparelMonitor({ onClose, showClose = true }: TeamSportApparelMonitorProps) {
  return (
...
export default TeamSportApparelMonitor
