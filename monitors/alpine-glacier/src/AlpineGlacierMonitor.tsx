...
export interface AlpineGlacierMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AlpineGlacierMonitor({ onClose, showClose = true }: AlpineGlacierMonitorProps) {
  return (
...
export default AlpineGlacierMonitor
