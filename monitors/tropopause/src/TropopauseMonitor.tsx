...
export interface TropopauseMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TropopauseMonitor({ onClose, showClose = true }: TropopauseMonitorProps) {
  return (
...
export default TropopauseMonitor
