...
export interface MassageTherapySpaMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MassageTherapySpaMonitor({ onClose, showClose = true }: MassageTherapySpaMonitorProps) {
  return (
...
export default MassageTherapySpaMonitor
