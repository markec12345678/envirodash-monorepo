...
export interface DonutBakeryShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DonutBakeryShopMonitor({ onClose, showClose = true }: DonutBakeryShopMonitorProps) {
  return (
...
export default DonutBakeryShopMonitor
