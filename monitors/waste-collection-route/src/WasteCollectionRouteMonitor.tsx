...
export interface WasteCollectionRouteMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WasteCollectionRouteMonitor({ onClose, showClose = true }: WasteCollectionRouteMonitorProps) {
  return (
...
export default WasteCollectionRouteMonitor
