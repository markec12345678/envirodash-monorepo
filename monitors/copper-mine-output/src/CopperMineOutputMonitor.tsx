...
export interface CopperMineOutputMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CopperMineOutputMonitor({ onClose, showClose = true }: CopperMineOutputMonitorProps) {
  return (
...
export default CopperMineOutputMonitor
