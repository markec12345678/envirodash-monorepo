...
export interface CalcicHorizonMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CalcicHorizonMonitor({ onClose, showClose = true }: CalcicHorizonMonitorProps) {
  return (
...
export default CalcicHorizonMonitor
