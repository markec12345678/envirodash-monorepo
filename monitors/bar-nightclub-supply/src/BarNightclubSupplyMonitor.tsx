...
export interface BarNightclubSupplyMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BarNightclubSupplyMonitor({ onClose, showClose = true }: BarNightclubSupplyMonitorProps) {
  return (
...
export default BarNightclubSupplyMonitor
