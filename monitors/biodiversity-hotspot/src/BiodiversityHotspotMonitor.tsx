...
export interface BiodiversityHotspotMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BiodiversityHotspotMonitor({ onClose, showClose = true }: BiodiversityHotspotMonitorProps) {
  return (
...
export default BiodiversityHotspotMonitor
