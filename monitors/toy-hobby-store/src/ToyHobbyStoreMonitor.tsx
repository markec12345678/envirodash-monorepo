...
export interface ToyHobbyStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ToyHobbyStoreMonitor({ onClose, showClose = true }: ToyHobbyStoreMonitorProps) {
  return (
...
export default ToyHobbyStoreMonitor
