...
export interface NavalBaseOperationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function NavalBaseOperationMonitor({ onClose, showClose = true }: NavalBaseOperationMonitorProps) {
  return (
...
export default NavalBaseOperationMonitor
