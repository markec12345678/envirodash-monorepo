...
export interface HospitalCafeGiftShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HospitalCafeGiftShopMonitor({ onClose, showClose = true }: HospitalCafeGiftShopMonitorProps) {
  return (
...
export default HospitalCafeGiftShopMonitor
