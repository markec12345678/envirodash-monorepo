...
export interface NannyAgencyServiceMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function NannyAgencyServiceMonitor({ onClose, showClose = true }: NannyAgencyServiceMonitorProps) {
  return (
...
export default NannyAgencyServiceMonitor
