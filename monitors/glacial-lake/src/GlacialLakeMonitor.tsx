...
export interface GlacialLakeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GlacialLakeMonitor({ onClose, showClose = true }: GlacialLakeMonitorProps) {
  return (
...
export default GlacialLakeMonitor
