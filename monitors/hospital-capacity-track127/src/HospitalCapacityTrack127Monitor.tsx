...
export interface HospitalCapacityTrack127MonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HospitalCapacityTrack127Monitor({ onClose, showClose = true }: HospitalCapacityTrack127MonitorProps) {
  return (
...
export default HospitalCapacityTrack127Monitor
