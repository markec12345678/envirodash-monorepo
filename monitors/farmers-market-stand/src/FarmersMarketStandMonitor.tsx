...
export interface FarmersMarketStandMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FarmersMarketStandMonitor({ onClose, showClose = true }: FarmersMarketStandMonitorProps) {
  return (
...
export default FarmersMarketStandMonitor
