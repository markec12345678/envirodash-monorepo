...
export interface DebrisFlowSurgeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DebrisFlowSurgeMonitor({ onClose, showClose = true }: DebrisFlowSurgeMonitorProps) {
  return (
...
export default DebrisFlowSurgeMonitor
