...
export interface IceShelfCollapseMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function IceShelfCollapseMonitor({ onClose, showClose = true }: IceShelfCollapseMonitorProps) {
  return (
...
export default IceShelfCollapseMonitor
