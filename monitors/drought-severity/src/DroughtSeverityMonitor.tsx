...
export interface DroughtSeverityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DroughtSeverityMonitor({ onClose, showClose = true }: DroughtSeverityMonitorProps) {
  return (
...
export default DroughtSeverityMonitor
