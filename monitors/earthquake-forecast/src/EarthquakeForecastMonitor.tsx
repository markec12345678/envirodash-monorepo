...
export interface EarthquakeForecastMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function EarthquakeForecastMonitor({ onClose, showClose = true }: EarthquakeForecastMonitorProps) {
  return (
...
export default EarthquakeForecastMonitor
