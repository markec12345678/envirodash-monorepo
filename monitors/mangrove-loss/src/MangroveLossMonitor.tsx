...
export interface MangroveLossMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MangroveLossMonitor({ onClose, showClose = true }: MangroveLossMonitorProps) {
  return (
...
export default MangroveLossMonitor
