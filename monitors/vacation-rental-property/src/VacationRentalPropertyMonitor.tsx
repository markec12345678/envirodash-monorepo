...
export interface VacationRentalPropertyMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VacationRentalPropertyMonitor({ onClose, showClose = true }: VacationRentalPropertyMonitorProps) {
  return (
...
export default VacationRentalPropertyMonitor
