...
export interface SoilErosionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SoilErosionMonitor({ onClose, showClose = true }: SoilErosionMonitorProps) {
  return (
...
export default SoilErosionMonitor
