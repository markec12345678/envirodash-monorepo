...
export interface ExtremeWeatherIndexMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ExtremeWeatherIndexMonitor({ onClose, showClose = true }: ExtremeWeatherIndexMonitorProps) {
  return (
...
export default ExtremeWeatherIndexMonitor
