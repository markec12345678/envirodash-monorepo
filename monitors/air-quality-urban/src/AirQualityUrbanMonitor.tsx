...
export interface AirQualityUrbanMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AirQualityUrbanMonitor({ onClose, showClose = true }: AirQualityUrbanMonitorProps) {
  return (
...
export default AirQualityUrbanMonitor
