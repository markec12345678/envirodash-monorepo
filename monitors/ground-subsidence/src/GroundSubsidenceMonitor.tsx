...
export interface GroundSubsidenceMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GroundSubsidenceMonitor({ onClose, showClose = true }: GroundSubsidenceMonitorProps) {
  return (
...
export default GroundSubsidenceMonitor
