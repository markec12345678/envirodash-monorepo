...
export interface CasinoHotelBuffetMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CasinoHotelBuffetMonitor({ onClose, showClose = true }: CasinoHotelBuffetMonitorProps) {
  return (
...
export default CasinoHotelBuffetMonitor
