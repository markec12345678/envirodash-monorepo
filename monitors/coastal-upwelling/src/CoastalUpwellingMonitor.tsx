...
export interface CoastalUpwellingMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CoastalUpwellingMonitor({ onClose, showClose = true }: CoastalUpwellingMonitorProps) {
  return (
...
export default CoastalUpwellingMonitor
