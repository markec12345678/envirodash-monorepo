...
export interface SeaIceThicknessMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SeaIceThicknessMonitor({ onClose, showClose = true }: SeaIceThicknessMonitorProps) {
  return (
...
export default SeaIceThicknessMonitor
