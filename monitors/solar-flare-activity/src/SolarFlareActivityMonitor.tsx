...
export interface SolarFlareActivityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SolarFlareActivityMonitor({ onClose, showClose = true }: SolarFlareActivityMonitorProps) {
  return (
...
export default SolarFlareActivityMonitor
