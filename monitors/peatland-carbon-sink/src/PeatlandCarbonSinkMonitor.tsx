...
export interface PeatlandCarbonSinkMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PeatlandCarbonSinkMonitor({ onClose, showClose = true }: PeatlandCarbonSinkMonitorProps) {
  return (
...
export default PeatlandCarbonSinkMonitor
