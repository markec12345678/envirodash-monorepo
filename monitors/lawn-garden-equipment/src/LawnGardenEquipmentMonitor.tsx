...
export interface LawnGardenEquipmentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LawnGardenEquipmentMonitor({ onClose, showClose = true }: LawnGardenEquipmentMonitorProps) {
  return (
...
export default LawnGardenEquipmentMonitor
