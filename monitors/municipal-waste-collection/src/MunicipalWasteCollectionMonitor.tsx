...
export interface MunicipalWasteCollectionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MunicipalWasteCollectionMonitor({ onClose, showClose = true }: MunicipalWasteCollectionMonitorProps) {
  return (
...
export default MunicipalWasteCollectionMonitor
