...
export interface FurnitureHomeDecorStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FurnitureHomeDecorStoreMonitor({ onClose, showClose = true }: FurnitureHomeDecorStoreMonitorProps) {
  return (
...
export default FurnitureHomeDecorStoreMonitor
