...
export interface CandySweetShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CandySweetShopMonitor({ onClose, showClose = true }: CandySweetShopMonitorProps) {
  return (
...
export default CandySweetShopMonitor
