...
export interface TestPrepCenterMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TestPrepCenterMonitor({ onClose, showClose = true }: TestPrepCenterMonitorProps) {
  return (
...
export default TestPrepCenterMonitor
