...
export interface DogParkActivityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DogParkActivityMonitor({ onClose, showClose = true }: DogParkActivityMonitorProps) {
  return (
...
export default DogParkActivityMonitor
