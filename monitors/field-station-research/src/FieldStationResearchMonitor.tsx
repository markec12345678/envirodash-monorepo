...
export interface FieldStationResearchMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FieldStationResearchMonitor({ onClose, showClose = true }: FieldStationResearchMonitorProps) {
  return (
...
export default FieldStationResearchMonitor
