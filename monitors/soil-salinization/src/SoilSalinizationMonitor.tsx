...
export interface SoilSalinizationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SoilSalinizationMonitor({ onClose, showClose = true }: SoilSalinizationMonitorProps) {
  return (
...
export default SoilSalinizationMonitor
