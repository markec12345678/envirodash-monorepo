...
export interface SprayTanStudioMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SprayTanStudioMonitor({ onClose, showClose = true }: SprayTanStudioMonitorProps) {
  return (
...
export default SprayTanStudioMonitor
