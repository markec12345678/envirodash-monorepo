...
export interface RockburstRiskMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RockburstRiskMonitor({ onClose, showClose = true }: RockburstRiskMonitorProps) {
  return (
...
export default RockburstRiskMonitor
