...
export interface GlacierCalvingMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GlacierCalvingMonitor({ onClose, showClose = true }: GlacierCalvingMonitorProps) {
  return (
...
export default GlacierCalvingMonitor
