...
export interface SeismicHarmonicMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SeismicHarmonicMonitor({ onClose, showClose = true }: SeismicHarmonicMonitorProps) {
  return (
...
export default SeismicHarmonicMonitor
