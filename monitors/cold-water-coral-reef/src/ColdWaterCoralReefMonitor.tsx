...
export interface ColdWaterCoralReefMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ColdWaterCoralReefMonitor({ onClose, showClose = true }: ColdWaterCoralReefMonitorProps) {
  return (
...
export default ColdWaterCoralReefMonitor
