...
export interface HabitatCorridorMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HabitatCorridorMonitor({ onClose, showClose = true }: HabitatCorridorMonitorProps) {
  return (
...
export default HabitatCorridorMonitor
