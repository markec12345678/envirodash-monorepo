...
export interface SpaceRadiationDoseMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SpaceRadiationDoseMonitor({ onClose, showClose = true }: SpaceRadiationDoseMonitorProps) {
  return (
...
export default SpaceRadiationDoseMonitor
