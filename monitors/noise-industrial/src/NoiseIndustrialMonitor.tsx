...
export interface NoiseIndustrialMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function NoiseIndustrialMonitor({ onClose, showClose = true }: NoiseIndustrialMonitorProps) {
  return (
...
export default NoiseIndustrialMonitor
