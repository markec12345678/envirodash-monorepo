...
export interface GuitarShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GuitarShopMonitor({ onClose, showClose = true }: GuitarShopMonitorProps) {
  return (
...
export default GuitarShopMonitor
