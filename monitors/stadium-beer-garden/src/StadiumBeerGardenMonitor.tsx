...
export interface StadiumBeerGardenMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function StadiumBeerGardenMonitor({ onClose, showClose = true }: StadiumBeerGardenMonitorProps) {
  return (
...
export default StadiumBeerGardenMonitor
