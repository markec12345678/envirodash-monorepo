...
export interface JuiceProcessingLineMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function JuiceProcessingLineMonitor({ onClose, showClose = true }: JuiceProcessingLineMonitorProps) {
  return (
...
export default JuiceProcessingLineMonitor
