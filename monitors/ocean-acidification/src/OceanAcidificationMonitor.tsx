...
export interface OceanAcidificationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function OceanAcidificationMonitor({ onClose, showClose = true }: OceanAcidificationMonitorProps) {
  return (
...
export default OceanAcidificationMonitor
