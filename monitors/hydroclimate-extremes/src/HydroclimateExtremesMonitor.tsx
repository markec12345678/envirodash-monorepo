...
export interface HydroclimateExtremesMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HydroclimateExtremesMonitor({ onClose, showClose = true }: HydroclimateExtremesMonitorProps) {
  return (
...
export default HydroclimateExtremesMonitor
