...
export interface PortCongestionMapMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PortCongestionMapMonitor({ onClose, showClose = true }: PortCongestionMapMonitorProps) {
  return (
...
export default PortCongestionMapMonitor
