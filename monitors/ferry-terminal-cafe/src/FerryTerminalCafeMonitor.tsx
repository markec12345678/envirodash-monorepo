...
export interface FerryTerminalCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FerryTerminalCafeMonitor({ onClose, showClose = true }: FerryTerminalCafeMonitorProps) {
  return (
...
export default FerryTerminalCafeMonitor
