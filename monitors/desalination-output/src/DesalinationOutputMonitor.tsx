...
export interface DesalinationOutputMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DesalinationOutputMonitor({ onClose, showClose = true }: DesalinationOutputMonitorProps) {
  return (
...
export default DesalinationOutputMonitor
