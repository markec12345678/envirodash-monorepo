...
export interface UrbanHeatVentilationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function UrbanHeatVentilationMonitor({ onClose, showClose = true }: UrbanHeatVentilationMonitorProps) {
  return (
...
export default UrbanHeatVentilationMonitor
