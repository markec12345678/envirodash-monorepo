...
export interface StockExchangeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function StockExchangeMonitor({ onClose, showClose = true }: StockExchangeMonitorProps) {
  return (
...
export default StockExchangeMonitor
