...
export interface TransmissionRepairShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TransmissionRepairShopMonitor({ onClose, showClose = true }: TransmissionRepairShopMonitorProps) {
  return (
...
export default TransmissionRepairShopMonitor
