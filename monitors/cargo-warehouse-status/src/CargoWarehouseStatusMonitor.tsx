...
export interface CargoWarehouseStatusMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CargoWarehouseStatusMonitor({ onClose, showClose = true }: CargoWarehouseStatusMonitorProps) {
  return (
...
export default CargoWarehouseStatusMonitor
