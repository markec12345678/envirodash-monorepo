...
export interface StadiumArenaConcessionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function StadiumArenaConcessionMonitor({ onClose, showClose = true }: StadiumArenaConcessionMonitorProps) {
  return (
...
export default StadiumArenaConcessionMonitor
