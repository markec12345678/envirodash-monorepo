...
export interface PrisonFacilityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PrisonFacilityMonitor({ onClose, showClose = true }: PrisonFacilityMonitorProps) {
  return (
...
export default PrisonFacilityMonitor
