...
export interface HighwayRestAreaMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HighwayRestAreaMonitor({ onClose, showClose = true }: HighwayRestAreaMonitorProps) {
  return (
...
export default HighwayRestAreaMonitor
