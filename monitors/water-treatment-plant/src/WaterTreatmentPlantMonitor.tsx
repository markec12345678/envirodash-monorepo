...
export interface WaterTreatmentPlantMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WaterTreatmentPlantMonitor({ onClose, showClose = true }: WaterTreatmentPlantMonitorProps) {
  return (
...
export default WaterTreatmentPlantMonitor
