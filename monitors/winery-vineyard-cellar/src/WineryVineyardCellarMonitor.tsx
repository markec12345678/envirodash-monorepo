...
export interface WineryVineyardCellarMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WineryVineyardCellarMonitor({ onClose, showClose = true }: WineryVineyardCellarMonitorProps) {
  return (
...
export default WineryVineyardCellarMonitor
