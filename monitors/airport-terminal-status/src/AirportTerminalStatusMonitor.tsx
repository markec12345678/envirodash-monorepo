...
export interface AirportTerminalStatusMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AirportTerminalStatusMonitor({ onClose, showClose = true }: AirportTerminalStatusMonitorProps) {
  return (
...
export default AirportTerminalStatusMonitor
