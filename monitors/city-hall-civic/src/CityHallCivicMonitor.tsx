...
export interface CityHallCivicMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CityHallCivicMonitor({ onClose, showClose = true }: CityHallCivicMonitorProps) {
  return (
...
export default CityHallCivicMonitor
