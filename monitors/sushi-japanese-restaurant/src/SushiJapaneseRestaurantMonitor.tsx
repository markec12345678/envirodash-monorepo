...
export interface SushiJapaneseRestaurantMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SushiJapaneseRestaurantMonitor({ onClose, showClose = true }: SushiJapaneseRestaurantMonitorProps) {
  return (
...
export default SushiJapaneseRestaurantMonitor
