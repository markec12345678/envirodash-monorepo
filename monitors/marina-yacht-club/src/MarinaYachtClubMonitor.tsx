...
export interface MarinaYachtClubMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MarinaYachtClubMonitor({ onClose, showClose = true }: MarinaYachtClubMonitorProps) {
  return (
...
export default MarinaYachtClubMonitor
