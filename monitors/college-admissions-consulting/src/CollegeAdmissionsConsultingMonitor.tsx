...
export interface CollegeAdmissionsConsultingMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CollegeAdmissionsConsultingMonitor({ onClose, showClose = true }: CollegeAdmissionsConsultingMonitorProps) {
  return (
...
export default CollegeAdmissionsConsultingMonitor
