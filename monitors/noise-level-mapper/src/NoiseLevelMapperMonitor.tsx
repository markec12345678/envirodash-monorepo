...
export interface NoiseLevelMapperMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function NoiseLevelMapperMonitor({ onClose, showClose = true }: NoiseLevelMapperMonitorProps) {
  return (
...
export default NoiseLevelMapperMonitor
