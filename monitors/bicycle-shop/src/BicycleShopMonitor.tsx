...
export interface BicycleShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BicycleShopMonitor({ onClose, showClose = true }: BicycleShopMonitorProps) {
  return (
...
export default BicycleShopMonitor
