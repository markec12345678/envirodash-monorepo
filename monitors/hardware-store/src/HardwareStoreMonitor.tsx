...
export interface HardwareStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HardwareStoreMonitor({ onClose, showClose = true }: HardwareStoreMonitorProps) {
  return (
...
export default HardwareStoreMonitor
