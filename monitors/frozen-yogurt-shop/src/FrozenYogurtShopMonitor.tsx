...
export interface FrozenYogurtShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FrozenYogurtShopMonitor({ onClose, showClose = true }: FrozenYogurtShopMonitorProps) {
  return (
...
export default FrozenYogurtShopMonitor
