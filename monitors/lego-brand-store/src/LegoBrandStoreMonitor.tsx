...
export interface LegoBrandStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LegoBrandStoreMonitor({ onClose, showClose = true }: LegoBrandStoreMonitorProps) {
  return (
...
export default LegoBrandStoreMonitor
