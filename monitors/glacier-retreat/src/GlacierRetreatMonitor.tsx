...
export interface GlacierRetreatMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GlacierRetreatMonitor({ onClose, showClose = true }: GlacierRetreatMonitorProps) {
  return (
...
export default GlacierRetreatMonitor
