...
export interface BeachNourishmentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BeachNourishmentMonitor({ onClose, showClose = true }: BeachNourishmentMonitorProps) {
  return (
...
export default BeachNourishmentMonitor
