...
export interface DesertOasisMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DesertOasisMonitor({ onClose, showClose = true }: DesertOasisMonitorProps) {
  return (
...
export default DesertOasisMonitor
