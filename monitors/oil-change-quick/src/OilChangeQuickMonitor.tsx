...
export interface OilChangeQuickMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function OilChangeQuickMonitor({ onClose, showClose = true }: OilChangeQuickMonitorProps) {
  return (
...
export default OilChangeQuickMonitor
