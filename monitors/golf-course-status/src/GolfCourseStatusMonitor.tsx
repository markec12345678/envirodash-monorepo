...
export interface GolfCourseStatusMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GolfCourseStatusMonitor({ onClose, showClose = true }: GolfCourseStatusMonitorProps) {
  return (
...
export default GolfCourseStatusMonitor
