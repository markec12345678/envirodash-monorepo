...
export interface HydroseismicActivityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HydroseismicActivityMonitor({ onClose, showClose = true }: HydroseismicActivityMonitorProps) {
  return (
...
export default HydroseismicActivityMonitor
