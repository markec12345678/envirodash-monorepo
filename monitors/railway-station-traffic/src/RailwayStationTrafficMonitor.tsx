...
export interface RailwayStationTrafficMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RailwayStationTrafficMonitor({ onClose, showClose = true }: RailwayStationTrafficMonitorProps) {
  return (
...
export default RailwayStationTrafficMonitor
