...
export interface AthleticFootwearStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AthleticFootwearStoreMonitor({ onClose, showClose = true }: AthleticFootwearStoreMonitorProps) {
  return (
...
export default AthleticFootwearStoreMonitor
