...
export interface ReflexologyLoungeCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ReflexologyLoungeCafeMonitor({ onClose, showClose = true }: ReflexologyLoungeCafeMonitorProps) {
  return (
...
export default ReflexologyLoungeCafeMonitor
