...
export interface RossbyWaveAmplitudeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RossbyWaveAmplitudeMonitor({ onClose, showClose = true }: RossbyWaveAmplitudeMonitorProps) {
  return (
...
export default RossbyWaveAmplitudeMonitor
