...
export interface ThermohalineCirculationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ThermohalineCirculationMonitor({ onClose, showClose = true }: ThermohalineCirculationMonitorProps) {
  return (
...
export default ThermohalineCirculationMonitor
