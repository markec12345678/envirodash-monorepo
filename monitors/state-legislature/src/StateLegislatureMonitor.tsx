...
export interface StateLegislatureMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function StateLegislatureMonitor({ onClose, showClose = true }: StateLegislatureMonitorProps) {
  return (
...
export default StateLegislatureMonitor
