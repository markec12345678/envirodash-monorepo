...
export interface DesertFlashFloodMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DesertFlashFloodMonitor({ onClose, showClose = true }: DesertFlashFloodMonitorProps) {
  return (
...
export default DesertFlashFloodMonitor
