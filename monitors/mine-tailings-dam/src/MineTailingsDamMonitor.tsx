...
export interface MineTailingsDamMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MineTailingsDamMonitor({ onClose, showClose = true }: MineTailingsDamMonitorProps) {
  return (
...
export default MineTailingsDamMonitor
