...
export interface OperaHouseScheduleMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function OperaHouseScheduleMonitor({ onClose, showClose = true }: OperaHouseScheduleMonitorProps) {
  return (
...
export default OperaHouseScheduleMonitor
