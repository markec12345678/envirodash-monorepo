...
export interface BarreFitnessStudioCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BarreFitnessStudioCafeMonitor({ onClose, showClose = true }: BarreFitnessStudioCafeMonitorProps) {
  return (
...
export default BarreFitnessStudioCafeMonitor
