...
export interface AcidMineDrainageMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AcidMineDrainageMonitor({ onClose, showClose = true }: AcidMineDrainageMonitorProps) {
  return (
...
export default AcidMineDrainageMonitor
