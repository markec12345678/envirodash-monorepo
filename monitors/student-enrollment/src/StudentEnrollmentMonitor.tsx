...
export interface StudentEnrollmentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function StudentEnrollmentMonitor({ onClose, showClose = true }: StudentEnrollmentMonitorProps) {
  return (
...
export default StudentEnrollmentMonitor
