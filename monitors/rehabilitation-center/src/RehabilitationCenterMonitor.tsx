...
export interface RehabilitationCenterMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RehabilitationCenterMonitor({ onClose, showClose = true }: RehabilitationCenterMonitorProps) {
  return (
...
export default RehabilitationCenterMonitor
