...
export interface SearchRescueGridMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SearchRescueGridMonitor({ onClose, showClose = true }: SearchRescueGridMonitorProps) {
  return (
...
export default SearchRescueGridMonitor
