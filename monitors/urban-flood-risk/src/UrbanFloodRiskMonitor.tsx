...
export interface UrbanFloodRiskMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function UrbanFloodRiskMonitor({ onClose, showClose = true }: UrbanFloodRiskMonitorProps) {
  return (
...
export default UrbanFloodRiskMonitor
