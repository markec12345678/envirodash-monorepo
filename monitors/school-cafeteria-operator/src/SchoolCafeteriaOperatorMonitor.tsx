...
export interface SchoolCafeteriaOperatorMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SchoolCafeteriaOperatorMonitor({ onClose, showClose = true }: SchoolCafeteriaOperatorMonitorProps) {
  return (
...
export default SchoolCafeteriaOperatorMonitor
