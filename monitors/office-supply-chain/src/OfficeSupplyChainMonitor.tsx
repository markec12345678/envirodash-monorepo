...
export interface OfficeSupplyChainMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function OfficeSupplyChainMonitor({ onClose, showClose = true }: OfficeSupplyChainMonitorProps) {
  return (
...
export default OfficeSupplyChainMonitor
