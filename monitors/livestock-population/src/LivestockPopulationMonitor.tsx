...
export interface LivestockPopulationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LivestockPopulationMonitor({ onClose, showClose = true }: LivestockPopulationMonitorProps) {
  return (
...
export default LivestockPopulationMonitor
