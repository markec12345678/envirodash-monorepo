...
export interface SaltFlatCrustMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SaltFlatCrustMonitor({ onClose, showClose = true }: SaltFlatCrustMonitorProps) {
  return (
...
export default SaltFlatCrustMonitor
