...
export interface FjordEcosystemMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FjordEcosystemMonitor({ onClose, showClose = true }: FjordEcosystemMonitorProps) {
  return (
...
export default FjordEcosystemMonitor
