...
export interface BankBranchOfficeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BankBranchOfficeMonitor({ onClose, showClose = true }: BankBranchOfficeMonitorProps) {
  return (
...
export default BankBranchOfficeMonitor
