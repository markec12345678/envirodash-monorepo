...
export interface IceStreamVelocityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function IceStreamVelocityMonitor({ onClose, showClose = true }: IceStreamVelocityMonitorProps) {
  return (
...
export default IceStreamVelocityMonitor
