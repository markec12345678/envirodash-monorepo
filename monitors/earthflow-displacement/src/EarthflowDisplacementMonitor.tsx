...
export interface EarthflowDisplacementMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function EarthflowDisplacementMonitor({ onClose, showClose = true }: EarthflowDisplacementMonitorProps) {
  return (
...
export default EarthflowDisplacementMonitor
