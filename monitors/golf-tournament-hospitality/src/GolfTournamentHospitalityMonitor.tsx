...
export interface GolfTournamentHospitalityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GolfTournamentHospitalityMonitor({ onClose, showClose = true }: GolfTournamentHospitalityMonitorProps) {
  return (
...
export default GolfTournamentHospitalityMonitor
