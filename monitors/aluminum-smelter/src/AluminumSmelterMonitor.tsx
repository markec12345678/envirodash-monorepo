...
export interface AluminumSmelterMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AluminumSmelterMonitor({ onClose, showClose = true }: AluminumSmelterMonitorProps) {
  return (
...
export default AluminumSmelterMonitor
