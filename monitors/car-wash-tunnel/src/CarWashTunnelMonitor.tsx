...
export interface CarWashTunnelMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CarWashTunnelMonitor({ onClose, showClose = true }: CarWashTunnelMonitorProps) {
  return (
...
export default CarWashTunnelMonitor
