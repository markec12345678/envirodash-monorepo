...
export interface RollerDerbyVenueBarMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RollerDerbyVenueBarMonitor({ onClose, showClose = true }: RollerDerbyVenueBarMonitorProps) {
  return (
...
export default RollerDerbyVenueBarMonitor
