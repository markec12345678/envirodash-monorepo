...
export interface MuseumFootfallMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MuseumFootfallMonitor({ onClose, showClose = true }: MuseumFootfallMonitorProps) {
  return (
...
export default MuseumFootfallMonitor
