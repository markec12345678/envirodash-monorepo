...
export interface VolcanicFumaroleMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VolcanicFumaroleMonitor({ onClose, showClose = true }: VolcanicFumaroleMonitorProps) {
  return (
...
export default VolcanicFumaroleMonitor
