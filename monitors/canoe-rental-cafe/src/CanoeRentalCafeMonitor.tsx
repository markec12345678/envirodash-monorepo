...
export interface CanoeRentalCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CanoeRentalCafeMonitor({ onClose, showClose = true }: CanoeRentalCafeMonitorProps) {
  return (
...
export default CanoeRentalCafeMonitor
