...
export interface VaccinationDriveMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VaccinationDriveMonitor({ onClose, showClose = true }: VaccinationDriveMonitorProps) {
  return (
...
export default VaccinationDriveMonitor
