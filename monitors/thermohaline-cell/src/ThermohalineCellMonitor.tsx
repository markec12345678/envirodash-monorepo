...
export interface ThermohalineCellMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ThermohalineCellMonitor({ onClose, showClose = true }: ThermohalineCellMonitorProps) {
  return (
...
export default ThermohalineCellMonitor
