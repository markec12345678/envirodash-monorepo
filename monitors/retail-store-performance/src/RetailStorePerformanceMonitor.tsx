...
export interface RetailStorePerformanceMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RetailStorePerformanceMonitor({ onClose, showClose = true }: RetailStorePerformanceMonitorProps) {
  return (
...
export default RetailStorePerformanceMonitor
