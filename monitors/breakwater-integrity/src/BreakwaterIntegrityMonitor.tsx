...
export interface BreakwaterIntegrityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BreakwaterIntegrityMonitor({ onClose, showClose = true }: BreakwaterIntegrityMonitorProps) {
  return (
...
export default BreakwaterIntegrityMonitor
