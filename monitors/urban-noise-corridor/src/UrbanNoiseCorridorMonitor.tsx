...
export interface UrbanNoiseCorridorMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function UrbanNoiseCorridorMonitor({ onClose, showClose = true }: UrbanNoiseCorridorMonitorProps) {
  return (
...
export default UrbanNoiseCorridorMonitor
