...
export interface ConcertMusicHallMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ConcertMusicHallMonitor({ onClose, showClose = true }: ConcertMusicHallMonitorProps) {
  return (
...
export default ConcertMusicHallMonitor
