...
export interface SoccerSpecialtyStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SoccerSpecialtyStoreMonitor({ onClose, showClose = true }: SoccerSpecialtyStoreMonitorProps) {
  return (
...
export default SoccerSpecialtyStoreMonitor
