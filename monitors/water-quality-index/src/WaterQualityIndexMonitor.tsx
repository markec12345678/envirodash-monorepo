...
export interface WaterQualityIndexMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WaterQualityIndexMonitor({ onClose, showClose = true }: WaterQualityIndexMonitorProps) {
  return (
...
export default WaterQualityIndexMonitor
