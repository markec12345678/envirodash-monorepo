...
export interface MangroveCarbonMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MangroveCarbonMonitor({ onClose, showClose = true }: MangroveCarbonMonitorProps) {
  return (
...
export default MangroveCarbonMonitor
