...
export interface KarstGroundwaterMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function KarstGroundwaterMonitor({ onClose, showClose = true }: KarstGroundwaterMonitorProps) {
  return (
...
export default KarstGroundwaterMonitor
