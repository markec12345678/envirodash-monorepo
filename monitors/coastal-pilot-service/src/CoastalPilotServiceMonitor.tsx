...
export interface CoastalPilotServiceMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CoastalPilotServiceMonitor({ onClose, showClose = true }: CoastalPilotServiceMonitorProps) {
  return (
...
export default CoastalPilotServiceMonitor
