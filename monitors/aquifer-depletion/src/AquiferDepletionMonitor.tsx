...
export interface AquiferDepletionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AquiferDepletionMonitor({ onClose, showClose = true }: AquiferDepletionMonitorProps) {
  return (
...
export default AquiferDepletionMonitor
