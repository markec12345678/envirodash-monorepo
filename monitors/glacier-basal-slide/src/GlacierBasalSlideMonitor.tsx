...
export interface GlacierBasalSlideMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GlacierBasalSlideMonitor({ onClose, showClose = true }: GlacierBasalSlideMonitorProps) {
  return (
...
export default GlacierBasalSlideMonitor
