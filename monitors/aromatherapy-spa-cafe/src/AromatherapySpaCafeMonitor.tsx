...
export interface AromatherapySpaCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AromatherapySpaCafeMonitor({ onClose, showClose = true }: AromatherapySpaCafeMonitorProps) {
  return (
...
export default AromatherapySpaCafeMonitor
