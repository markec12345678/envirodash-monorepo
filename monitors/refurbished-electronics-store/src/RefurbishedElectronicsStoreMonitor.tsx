...
export interface RefurbishedElectronicsStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RefurbishedElectronicsStoreMonitor({ onClose, showClose = true }: RefurbishedElectronicsStoreMonitorProps) {
  return (
...
export default RefurbishedElectronicsStoreMonitor
