...
export interface BaseflowIndexMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BaseflowIndexMonitor({ onClose, showClose = true }: BaseflowIndexMonitorProps) {
  return (
...
export default BaseflowIndexMonitor
