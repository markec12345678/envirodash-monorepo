...
export interface PianoShowroomMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PianoShowroomMonitor({ onClose, showClose = true }: PianoShowroomMonitorProps) {
  return (
...
export default PianoShowroomMonitor
