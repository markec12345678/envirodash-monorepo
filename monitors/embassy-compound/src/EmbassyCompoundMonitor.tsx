...
export interface EmbassyCompoundMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function EmbassyCompoundMonitor({ onClose, showClose = true }: EmbassyCompoundMonitorProps) {
  return (
...
export default EmbassyCompoundMonitor
