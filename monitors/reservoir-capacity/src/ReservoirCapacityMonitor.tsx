...
export interface ReservoirCapacityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ReservoirCapacityMonitor({ onClose, showClose = true }: ReservoirCapacityMonitorProps) {
  return (
...
export default ReservoirCapacityMonitor
