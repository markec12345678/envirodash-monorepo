...
export interface TectonicPlateBoundaryMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TectonicPlateBoundaryMonitor({ onClose, showClose = true }: TectonicPlateBoundaryMonitorProps) {
  return (
...
export default TectonicPlateBoundaryMonitor
