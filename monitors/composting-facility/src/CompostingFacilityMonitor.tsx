...
export interface CompostingFacilityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CompostingFacilityMonitor({ onClose, showClose = true }: CompostingFacilityMonitorProps) {
  return (
...
export default CompostingFacilityMonitor
