...
export interface ParticulateMatterMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ParticulateMatterMonitor({ onClose, showClose = true }: ParticulateMatterMonitorProps) {
  return (
...
export default ParticulateMatterMonitor
