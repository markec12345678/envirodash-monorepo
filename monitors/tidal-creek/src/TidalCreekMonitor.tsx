...
export interface TidalCreekMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TidalCreekMonitor({ onClose, showClose = true }: TidalCreekMonitorProps) {
  return (
...
export default TidalCreekMonitor
