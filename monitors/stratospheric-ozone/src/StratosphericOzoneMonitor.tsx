...
export interface StratosphericOzoneMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function StratosphericOzoneMonitor({ onClose, showClose = true }: StratosphericOzoneMonitorProps) {
  return (
...
export default StratosphericOzoneMonitor
