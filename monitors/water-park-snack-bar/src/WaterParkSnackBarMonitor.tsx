...
export interface WaterParkSnackBarMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WaterParkSnackBarMonitor({ onClose, showClose = true }: WaterParkSnackBarMonitorProps) {
  return (
...
export default WaterParkSnackBarMonitor
