...
export interface LakeHouseRestaurantMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LakeHouseRestaurantMonitor({ onClose, showClose = true }: LakeHouseRestaurantMonitorProps) {
  return (
...
export default LakeHouseRestaurantMonitor
