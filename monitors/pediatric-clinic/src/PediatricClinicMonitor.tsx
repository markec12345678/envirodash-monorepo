...
export interface PediatricClinicMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PediatricClinicMonitor({ onClose, showClose = true }: PediatricClinicMonitorProps) {
  return (
...
export default PediatricClinicMonitor
