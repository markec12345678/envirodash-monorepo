...
export interface HadleyCellCirculationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HadleyCellCirculationMonitor({ onClose, showClose = true }: HadleyCellCirculationMonitorProps) {
  return (
...
export default HadleyCellCirculationMonitor
