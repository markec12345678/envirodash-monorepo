...
export interface BusinessFurnitureStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BusinessFurnitureStoreMonitor({ onClose, showClose = true }: BusinessFurnitureStoreMonitorProps) {
  return (
...
export default BusinessFurnitureStoreMonitor
