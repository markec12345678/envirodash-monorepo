...
export interface SubsurfaceFluidFlowMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SubsurfaceFluidFlowMonitor({ onClose, showClose = true }: SubsurfaceFluidFlowMonitorProps) {
  return (
...
export default SubsurfaceFluidFlowMonitor
