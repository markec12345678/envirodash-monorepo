...
export interface ReefHealthMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ReefHealthMonitor({ onClose, showClose = true }: ReefHealthMonitorProps) {
  return (
...
export default ReefHealthMonitor
