...
export interface SteakhouseGrillMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SteakhouseGrillMonitor({ onClose, showClose = true }: SteakhouseGrillMonitorProps) {
  return (
...
export default SteakhouseGrillMonitor
