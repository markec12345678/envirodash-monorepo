...
export interface ThemeParkQueueMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ThemeParkQueueMonitor({ onClose, showClose = true }: ThemeParkQueueMonitorProps) {
  return (
...
export default ThemeParkQueueMonitor
