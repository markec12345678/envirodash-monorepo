...
export interface CoralReefBleachingDetailMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CoralReefBleachingDetailMonitor({ onClose, showClose = true }: CoralReefBleachingDetailMonitorProps) {
  return (
...
export default CoralReefBleachingDetailMonitor
