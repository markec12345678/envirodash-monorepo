...
export interface HotelChainOperationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HotelChainOperationMonitor({ onClose, showClose = true }: HotelChainOperationMonitorProps) {
  return (
...
export default HotelChainOperationMonitor
