...
export interface LibraryResourceMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LibraryResourceMonitor({ onClose, showClose = true }: LibraryResourceMonitorProps) {
  return (
...
export default LibraryResourceMonitor
