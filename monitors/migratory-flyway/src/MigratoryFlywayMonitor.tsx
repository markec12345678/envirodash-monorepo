...
export interface MigratoryFlywayMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MigratoryFlywayMonitor({ onClose, showClose = true }: MigratoryFlywayMonitorProps) {
  return (
...
export default MigratoryFlywayMonitor
