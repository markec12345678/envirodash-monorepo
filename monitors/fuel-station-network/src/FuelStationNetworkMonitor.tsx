...
export interface FuelStationNetworkMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FuelStationNetworkMonitor({ onClose, showClose = true }: FuelStationNetworkMonitorProps) {
  return (
...
export default FuelStationNetworkMonitor
