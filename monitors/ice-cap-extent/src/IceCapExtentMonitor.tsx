...
export interface IceCapExtentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function IceCapExtentMonitor({ onClose, showClose = true }: IceCapExtentMonitorProps) {
  return (
...
export default IceCapExtentMonitor
