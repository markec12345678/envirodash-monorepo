...
export interface SubmarineFanMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SubmarineFanMonitor({ onClose, showClose = true }: SubmarineFanMonitorProps) {
  return (
...
export default SubmarineFanMonitor
