...
export interface VinylRecordStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VinylRecordStoreMonitor({ onClose, showClose = true }: VinylRecordStoreMonitorProps) {
  return (
...
export default VinylRecordStoreMonitor
