...
export interface WholesaleClubWarehouseMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WholesaleClubWarehouseMonitor({ onClose, showClose = true }: WholesaleClubWarehouseMonitorProps) {
  return (
...
export default WholesaleClubWarehouseMonitor
