...
export interface BurgerFryJointMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BurgerFryJointMonitor({ onClose, showClose = true }: BurgerFryJointMonitorProps) {
  return (
...
export default BurgerFryJointMonitor
