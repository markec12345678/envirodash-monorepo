...
export interface HobbyCraftStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HobbyCraftStoreMonitor({ onClose, showClose = true }: HobbyCraftStoreMonitorProps) {
  return (
...
export default HobbyCraftStoreMonitor
