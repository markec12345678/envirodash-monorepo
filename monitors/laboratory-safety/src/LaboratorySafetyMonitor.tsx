...
export interface LaboratorySafetyMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LaboratorySafetyMonitor({ onClose, showClose = true }: LaboratorySafetyMonitorProps) {
  return (
...
export default LaboratorySafetyMonitor
