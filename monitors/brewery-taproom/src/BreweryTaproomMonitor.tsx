...
export interface BreweryTaproomMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BreweryTaproomMonitor({ onClose, showClose = true }: BreweryTaproomMonitorProps) {
  return (
...
export default BreweryTaproomMonitor
