...
export interface DesertSandSeaMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DesertSandSeaMonitor({ onClose, showClose = true }: DesertSandSeaMonitorProps) {
  return (
...
export default DesertSandSeaMonitor
