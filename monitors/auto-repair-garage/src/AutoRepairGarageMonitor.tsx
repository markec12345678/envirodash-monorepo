...
export interface AutoRepairGarageMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AutoRepairGarageMonitor({ onClose, showClose = true }: AutoRepairGarageMonitorProps) {
  return (
...
export default AutoRepairGarageMonitor
