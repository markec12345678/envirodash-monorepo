...
export interface BagelDeliShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BagelDeliShopMonitor({ onClose, showClose = true }: BagelDeliShopMonitorProps) {
  return (
...
export default BagelDeliShopMonitor
