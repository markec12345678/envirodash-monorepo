...
export interface AquariumMarineExhibitMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AquariumMarineExhibitMonitor({ onClose, showClose = true }: AquariumMarineExhibitMonitorProps) {
  return (
...
export default AquariumMarineExhibitMonitor
