...
export interface BankBranchTrafficMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BankBranchTrafficMonitor({ onClose, showClose = true }: BankBranchTrafficMonitorProps) {
  return (
...
export default BankBranchTrafficMonitor
