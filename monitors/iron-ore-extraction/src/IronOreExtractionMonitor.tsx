...
export interface IronOreExtractionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function IronOreExtractionMonitor({ onClose, showClose = true }: IronOreExtractionMonitorProps) {
  return (
...
export default IronOreExtractionMonitor
