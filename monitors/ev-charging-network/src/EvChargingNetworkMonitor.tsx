...
export interface EvChargingNetworkMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function EvChargingNetworkMonitor({ onClose, showClose = true }: EvChargingNetworkMonitorProps) {
  return (
...
export default EvChargingNetworkMonitor
