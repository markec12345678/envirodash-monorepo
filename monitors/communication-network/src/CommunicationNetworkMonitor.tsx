...
export interface CommunicationNetworkMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CommunicationNetworkMonitor({ onClose, showClose = true }: CommunicationNetworkMonitorProps) {
  return (
...
export default CommunicationNetworkMonitor
