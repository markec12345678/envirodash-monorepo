...
export interface EstuaryAcidificationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function EstuaryAcidificationMonitor({ onClose, showClose = true }: EstuaryAcidificationMonitorProps) {
  return (
...
export default EstuaryAcidificationMonitor
