...
export interface DataCenterCloudMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DataCenterCloudMonitor({ onClose, showClose = true }: DataCenterCloudMonitorProps) {
  return (
...
export default DataCenterCloudMonitor
