...
export interface RodeoArenaConcessionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RodeoArenaConcessionMonitor({ onClose, showClose = true }: RodeoArenaConcessionMonitorProps) {
  return (
...
export default RodeoArenaConcessionMonitor
