...
export interface ButcherCharcuterieShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ButcherCharcuterieShopMonitor({ onClose, showClose = true }: ButcherCharcuterieShopMonitorProps) {
  return (
...
export default ButcherCharcuterieShopMonitor
