...
export interface LogisticsDepotStatusMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LogisticsDepotStatusMonitor({ onClose, showClose = true }: LogisticsDepotStatusMonitorProps) {
  return (
...
export default LogisticsDepotStatusMonitor
