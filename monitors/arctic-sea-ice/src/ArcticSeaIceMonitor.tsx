...
export interface ArcticSeaIceMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ArcticSeaIceMonitor({ onClose, showClose = true }: ArcticSeaIceMonitorProps) {
  return (
...
export default ArcticSeaIceMonitor
