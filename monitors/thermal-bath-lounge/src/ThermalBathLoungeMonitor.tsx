...
export interface ThermalBathLoungeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ThermalBathLoungeMonitor({ onClose, showClose = true }: ThermalBathLoungeMonitorProps) {
  return (
...
export default ThermalBathLoungeMonitor
