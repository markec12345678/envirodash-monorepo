...
export interface ConcertVenueMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ConcertVenueMonitor({ onClose, showClose = true }: ConcertVenueMonitorProps) {
  return (
...
export default ConcertVenueMonitor
