...
export interface DinerBreakfastSpotMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DinerBreakfastSpotMonitor({ onClose, showClose = true }: DinerBreakfastSpotMonitorProps) {
  return (
...
export default DinerBreakfastSpotMonitor
