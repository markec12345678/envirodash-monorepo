...
export interface LashBrowBarMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LashBrowBarMonitor({ onClose, showClose = true }: LashBrowBarMonitorProps) {
  return (
...
export default LashBrowBarMonitor
