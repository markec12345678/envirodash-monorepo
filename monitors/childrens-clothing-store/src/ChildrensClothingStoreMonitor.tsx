...
export interface ChildrensClothingStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ChildrensClothingStoreMonitor({ onClose, showClose = true }: ChildrensClothingStoreMonitorProps) {
  return (
...
export default ChildrensClothingStoreMonitor
