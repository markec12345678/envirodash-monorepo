...
export interface SeicheWaveOscillationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SeicheWaveOscillationMonitor({ onClose, showClose = true }: SeicheWaveOscillationMonitorProps) {
  return (
...
export default SeicheWaveOscillationMonitor
