...
export interface HospitalFoodServiceMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HospitalFoodServiceMonitor({ onClose, showClose = true }: HospitalFoodServiceMonitorProps) {
  return (
...
export default HospitalFoodServiceMonitor
