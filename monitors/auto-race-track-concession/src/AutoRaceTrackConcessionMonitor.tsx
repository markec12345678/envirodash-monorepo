...
export interface AutoRaceTrackConcessionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AutoRaceTrackConcessionMonitor({ onClose, showClose = true }: AutoRaceTrackConcessionMonitorProps) {
  return (
...
export default AutoRaceTrackConcessionMonitor
