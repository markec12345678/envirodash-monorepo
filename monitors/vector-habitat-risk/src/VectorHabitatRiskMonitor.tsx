...
export interface VectorHabitatRiskMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VectorHabitatRiskMonitor({ onClose, showClose = true }: VectorHabitatRiskMonitorProps) {
  return (
...
export default VectorHabitatRiskMonitor
