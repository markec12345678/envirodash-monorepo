...
export interface CryptocurrencyMiningMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CryptocurrencyMiningMonitor({ onClose, showClose = true }: CryptocurrencyMiningMonitorProps) {
  return (
...
export default CryptocurrencyMiningMonitor
