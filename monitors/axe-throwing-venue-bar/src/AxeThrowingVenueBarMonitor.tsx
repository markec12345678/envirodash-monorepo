...
export interface AxeThrowingVenueBarMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AxeThrowingVenueBarMonitor({ onClose, showClose = true }: AxeThrowingVenueBarMonitorProps) {
  return (
...
export default AxeThrowingVenueBarMonitor
