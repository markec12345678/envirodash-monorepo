...
export interface MethaneCraterMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MethaneCraterMonitor({ onClose, showClose = true }: MethaneCraterMonitorProps) {
  return (
...
export default MethaneCraterMonitor
