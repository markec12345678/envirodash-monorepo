...
export interface TundraCarbonMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TundraCarbonMonitor({ onClose, showClose = true }: TundraCarbonMonitorProps) {
  return (
...
export default TundraCarbonMonitor
