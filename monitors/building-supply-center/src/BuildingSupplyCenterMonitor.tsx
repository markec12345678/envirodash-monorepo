...
export interface BuildingSupplyCenterMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BuildingSupplyCenterMonitor({ onClose, showClose = true }: BuildingSupplyCenterMonitorProps) {
  return (
...
export default BuildingSupplyCenterMonitor
