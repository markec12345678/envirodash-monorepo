...
export interface CoastalAquiferMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CoastalAquiferMonitor({ onClose, showClose = true }: CoastalAquiferMonitorProps) {
  return (
...
export default CoastalAquiferMonitor
