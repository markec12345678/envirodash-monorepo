...
export interface ScrapMetalYardMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ScrapMetalYardMonitor({ onClose, showClose = true }: ScrapMetalYardMonitorProps) {
  return (
...
export default ScrapMetalYardMonitor
