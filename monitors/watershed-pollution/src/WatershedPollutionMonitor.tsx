...
export interface WatershedPollutionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WatershedPollutionMonitor({ onClose, showClose = true }: WatershedPollutionMonitorProps) {
  return (
...
export default WatershedPollutionMonitor
