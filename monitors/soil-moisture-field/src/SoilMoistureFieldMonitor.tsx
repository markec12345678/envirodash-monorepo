...
export interface SoilMoistureFieldMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SoilMoistureFieldMonitor({ onClose, showClose = true }: SoilMoistureFieldMonitorProps) {
  return (
...
export default SoilMoistureFieldMonitor
