...
export interface CampgroundRvParkMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CampgroundRvParkMonitor({ onClose, showClose = true }: CampgroundRvParkMonitorProps) {
  return (
...
export default CampgroundRvParkMonitor
