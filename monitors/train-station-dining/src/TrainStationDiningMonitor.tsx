...
export interface TrainStationDiningMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TrainStationDiningMonitor({ onClose, showClose = true }: TrainStationDiningMonitorProps) {
  return (
...
export default TrainStationDiningMonitor
