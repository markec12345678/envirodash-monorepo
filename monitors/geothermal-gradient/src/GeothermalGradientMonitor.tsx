...
export interface GeothermalGradientMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GeothermalGradientMonitor({ onClose, showClose = true }: GeothermalGradientMonitorProps) {
  return (
...
export default GeothermalGradientMonitor
