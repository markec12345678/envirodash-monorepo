...
export interface StreetwearBoutiqueMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function StreetwearBoutiqueMonitor({ onClose, showClose = true }: StreetwearBoutiqueMonitorProps) {
  return (
...
export default StreetwearBoutiqueMonitor
