...
export interface IcebergTrackerMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function IcebergTrackerMonitor({ onClose, showClose = true }: IcebergTrackerMonitorProps) {
  return (
...
export default IcebergTrackerMonitor
