...
export interface CoastalArmorMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CoastalArmorMonitor({ onClose, showClose = true }: CoastalArmorMonitorProps) {
  return (
...
export default CoastalArmorMonitor
