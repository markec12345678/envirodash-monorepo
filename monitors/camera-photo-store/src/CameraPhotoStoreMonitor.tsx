...
export interface CameraPhotoStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CameraPhotoStoreMonitor({ onClose, showClose = true }: CameraPhotoStoreMonitorProps) {
  return (
...
export default CameraPhotoStoreMonitor
