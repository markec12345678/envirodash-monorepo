...
export interface StratosphericAerosolMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function StratosphericAerosolMonitor({ onClose, showClose = true }: StratosphericAerosolMonitorProps) {
  return (
...
export default StratosphericAerosolMonitor
