...
export interface FirstAidStationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FirstAidStationMonitor({ onClose, showClose = true }: FirstAidStationMonitorProps) {
  return (
...
export default FirstAidStationMonitor
