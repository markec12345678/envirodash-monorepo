...
export interface ElectronicWasteFacilityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ElectronicWasteFacilityMonitor({ onClose, showClose = true }: ElectronicWasteFacilityMonitorProps) {
  return (
...
export default ElectronicWasteFacilityMonitor
