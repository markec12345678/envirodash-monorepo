...
export interface SoilPhosphorusMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SoilPhosphorusMonitor({ onClose, showClose = true }: SoilPhosphorusMonitorProps) {
  return (
...
export default SoilPhosphorusMonitor
