...
export interface PolarBearHabitatMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PolarBearHabitatMonitor({ onClose, showClose = true }: PolarBearHabitatMonitorProps) {
  return (
...
export default PolarBearHabitatMonitor
