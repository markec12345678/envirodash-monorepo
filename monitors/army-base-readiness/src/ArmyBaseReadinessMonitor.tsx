...
export interface ArmyBaseReadinessMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ArmyBaseReadinessMonitor({ onClose, showClose = true }: ArmyBaseReadinessMonitorProps) {
  return (
...
export default ArmyBaseReadinessMonitor
