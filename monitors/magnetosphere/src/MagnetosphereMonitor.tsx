...
export interface MagnetosphereMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MagnetosphereMonitor({ onClose, showClose = true }: MagnetosphereMonitorProps) {
  return (
...
export default MagnetosphereMonitor
