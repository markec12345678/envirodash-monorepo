...
export interface IntertidalZoneMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function IntertidalZoneMonitor({ onClose, showClose = true }: IntertidalZoneMonitorProps) {
  return (
...
export default IntertidalZoneMonitor
