...
export interface SolarFluxIndexMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SolarFluxIndexMonitor({ onClose, showClose = true }: SolarFluxIndexMonitorProps) {
  return (
...
export default SolarFluxIndexMonitor
