...
export interface LawFirmPracticeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LawFirmPracticeMonitor({ onClose, showClose = true }: LawFirmPracticeMonitorProps) {
  return (
...
export default LawFirmPracticeMonitor
