...
export interface UndergroundMineVentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function UndergroundMineVentMonitor({ onClose, showClose = true }: UndergroundMineVentMonitorProps) {
  return (
...
export default UndergroundMineVentMonitor
