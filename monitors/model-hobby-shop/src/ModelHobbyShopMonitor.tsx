...
export interface ModelHobbyShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ModelHobbyShopMonitor({ onClose, showClose = true }: ModelHobbyShopMonitorProps) {
  return (
...
export default ModelHobbyShopMonitor
