...
export interface OreReserveEstimateMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function OreReserveEstimateMonitor({ onClose, showClose = true }: OreReserveEstimateMonitorProps) {
  return (
...
export default OreReserveEstimateMonitor
