...
export interface KitchenBathShowroomMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function KitchenBathShowroomMonitor({ onClose, showClose = true }: KitchenBathShowroomMonitorProps) {
  return (
...
export default KitchenBathShowroomMonitor
