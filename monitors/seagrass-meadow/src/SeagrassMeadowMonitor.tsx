...
export interface SeagrassMeadowMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SeagrassMeadowMonitor({ onClose, showClose = true }: SeagrassMeadowMonitorProps) {
  return (
...
export default SeagrassMeadowMonitor
