...
export interface FireDepartmentResponseMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FireDepartmentResponseMonitor({ onClose, showClose = true }: FireDepartmentResponseMonitorProps) {
  return (
...
export default FireDepartmentResponseMonitor
