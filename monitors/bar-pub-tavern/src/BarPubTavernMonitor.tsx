...
export interface BarPubTavernMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BarPubTavernMonitor({ onClose, showClose = true }: BarPubTavernMonitorProps) {
  return (
...
export default BarPubTavernMonitor
