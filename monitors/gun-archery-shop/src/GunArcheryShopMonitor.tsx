...
export interface GunArcheryShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GunArcheryShopMonitor({ onClose, showClose = true }: GunArcheryShopMonitorProps) {
  return (
...
export default GunArcheryShopMonitor
