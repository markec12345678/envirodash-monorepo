...
export interface ToyRetailChainMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ToyRetailChainMonitor({ onClose, showClose = true }: ToyRetailChainMonitorProps) {
  return (
...
export default ToyRetailChainMonitor
