...
export interface MicroplasticOceanMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MicroplasticOceanMonitor({ onClose, showClose = true }: MicroplasticOceanMonitorProps) {
  return (
...
export default MicroplasticOceanMonitor
