...
export interface NightlifeVenueMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function NightlifeVenueMonitor({ onClose, showClose = true }: NightlifeVenueMonitorProps) {
  return (
...
export default NightlifeVenueMonitor
