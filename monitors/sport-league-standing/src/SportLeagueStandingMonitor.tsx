...
export interface SportLeagueStandingMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SportLeagueStandingMonitor({ onClose, showClose = true }: SportLeagueStandingMonitorProps) {
  return (
...
export default SportLeagueStandingMonitor
