...
export interface LivestockMovementMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LivestockMovementMonitor({ onClose, showClose = true }: LivestockMovementMonitorProps) {
  return (
...
export default LivestockMovementMonitor
