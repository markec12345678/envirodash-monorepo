...
export interface FloristBoutiqueShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FloristBoutiqueShopMonitor({ onClose, showClose = true }: FloristBoutiqueShopMonitorProps) {
  return (
...
export default FloristBoutiqueShopMonitor
