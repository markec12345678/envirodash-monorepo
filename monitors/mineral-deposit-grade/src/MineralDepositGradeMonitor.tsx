...
export interface MineralDepositGradeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MineralDepositGradeMonitor({ onClose, showClose = true }: MineralDepositGradeMonitorProps) {
  return (
...
export default MineralDepositGradeMonitor
