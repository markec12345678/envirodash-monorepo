...
export interface SolifluctionLobeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SolifluctionLobeMonitor({ onClose, showClose = true }: SolifluctionLobeMonitorProps) {
  return (
...
export default SolifluctionLobeMonitor
