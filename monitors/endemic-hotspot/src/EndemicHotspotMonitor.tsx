...
export interface EndemicHotspotMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function EndemicHotspotMonitor({ onClose, showClose = true }: EndemicHotspotMonitorProps) {
  return (
...
export default EndemicHotspotMonitor
