...
export interface SkateParkSnackBarMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SkateParkSnackBarMonitor({ onClose, showClose = true }: SkateParkSnackBarMonitorProps) {
  return (
...
export default SkateParkSnackBarMonitor
