...
export interface WaterTreatmentUtilityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WaterTreatmentUtilityMonitor({ onClose, showClose = true }: WaterTreatmentUtilityMonitorProps) {
  return (
...
export default WaterTreatmentUtilityMonitor
