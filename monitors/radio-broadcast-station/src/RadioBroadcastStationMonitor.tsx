...
export interface RadioBroadcastStationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RadioBroadcastStationMonitor({ onClose, showClose = true }: RadioBroadcastStationMonitorProps) {
  return (
...
export default RadioBroadcastStationMonitor
