...
export interface GridStabilityIndexMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GridStabilityIndexMonitor({ onClose, showClose = true }: GridStabilityIndexMonitorProps) {
  return (
...
export default GridStabilityIndexMonitor
