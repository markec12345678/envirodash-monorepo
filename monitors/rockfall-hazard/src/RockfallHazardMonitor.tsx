...
export interface RockfallHazardMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RockfallHazardMonitor({ onClose, showClose = true }: RockfallHazardMonitorProps) {
  return (
...
export default RockfallHazardMonitor
