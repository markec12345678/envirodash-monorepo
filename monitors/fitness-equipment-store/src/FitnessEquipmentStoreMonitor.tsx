...
export interface FitnessEquipmentStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FitnessEquipmentStoreMonitor({ onClose, showClose = true }: FitnessEquipmentStoreMonitorProps) {
  return (
...
export default FitnessEquipmentStoreMonitor
