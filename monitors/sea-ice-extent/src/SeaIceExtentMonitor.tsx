...
export interface SeaIceExtentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SeaIceExtentMonitor({ onClose, showClose = true }: SeaIceExtentMonitorProps) {
  return (
...
export default SeaIceExtentMonitor
