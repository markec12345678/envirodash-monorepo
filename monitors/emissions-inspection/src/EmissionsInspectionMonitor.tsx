...
export interface EmissionsInspectionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function EmissionsInspectionMonitor({ onClose, showClose = true }: EmissionsInspectionMonitorProps) {
  return (
...
export default EmissionsInspectionMonitor
