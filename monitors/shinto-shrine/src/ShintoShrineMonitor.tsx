...
export interface ShintoShrineMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ShintoShrineMonitor({ onClose, showClose = true }: ShintoShrineMonitorProps) {
  return (
...
export default ShintoShrineMonitor
