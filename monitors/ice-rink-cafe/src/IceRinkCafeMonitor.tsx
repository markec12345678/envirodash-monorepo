...
export interface IceRinkCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function IceRinkCafeMonitor({ onClose, showClose = true }: IceRinkCafeMonitorProps) {
  return (
...
export default IceRinkCafeMonitor
