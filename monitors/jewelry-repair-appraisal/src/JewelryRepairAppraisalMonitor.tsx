...
export interface JewelryRepairAppraisalMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function JewelryRepairAppraisalMonitor({ onClose, showClose = true }: JewelryRepairAppraisalMonitorProps) {
  return (
...
export default JewelryRepairAppraisalMonitor
