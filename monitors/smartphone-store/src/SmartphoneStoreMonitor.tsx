...
export interface SmartphoneStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SmartphoneStoreMonitor({ onClose, showClose = true }: SmartphoneStoreMonitorProps) {
  return (
...
export default SmartphoneStoreMonitor
