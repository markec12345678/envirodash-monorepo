...
export interface CosmeticsBeautyStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CosmeticsBeautyStoreMonitor({ onClose, showClose = true }: CosmeticsBeautyStoreMonitorProps) {
  return (
...
export default CosmeticsBeautyStoreMonitor
