...
export interface SurfWatersportShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SurfWatersportShopMonitor({ onClose, showClose = true }: SurfWatersportShopMonitorProps) {
  return (
...
export default SurfWatersportShopMonitor
