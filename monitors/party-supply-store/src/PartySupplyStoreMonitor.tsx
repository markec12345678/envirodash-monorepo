...
export interface PartySupplyStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PartySupplyStoreMonitor({ onClose, showClose = true }: PartySupplyStoreMonitorProps) {
  return (
...
export default PartySupplyStoreMonitor
