...
export interface AfterSchoolProgramMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AfterSchoolProgramMonitor({ onClose, showClose = true }: AfterSchoolProgramMonitorProps) {
  return (
...
export default AfterSchoolProgramMonitor
