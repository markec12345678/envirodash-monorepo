...
export interface PizzeriaChainMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PizzeriaChainMonitor({ onClose, showClose = true }: PizzeriaChainMonitorProps) {
  return (
...
export default PizzeriaChainMonitor
