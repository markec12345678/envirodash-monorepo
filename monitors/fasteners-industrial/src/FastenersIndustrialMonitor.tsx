...
export interface FastenersIndustrialMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FastenersIndustrialMonitor({ onClose, showClose = true }: FastenersIndustrialMonitorProps) {
  return (
...
export default FastenersIndustrialMonitor
