...
export interface CasinoGamingFloorMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CasinoGamingFloorMonitor({ onClose, showClose = true }: CasinoGamingFloorMonitorProps) {
  return (
...
export default CasinoGamingFloorMonitor
