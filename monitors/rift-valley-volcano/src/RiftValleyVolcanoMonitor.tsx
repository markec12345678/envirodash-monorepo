...
export interface RiftValleyVolcanoMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RiftValleyVolcanoMonitor({ onClose, showClose = true }: RiftValleyVolcanoMonitorProps) {
  return (
...
export default RiftValleyVolcanoMonitor
