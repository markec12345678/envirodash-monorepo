...
export interface BMXTrackConcessionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BMXTrackConcessionMonitor({ onClose, showClose = true }: BMXTrackConcessionMonitorProps) {
  return (
...
export default BMXTrackConcessionMonitor
