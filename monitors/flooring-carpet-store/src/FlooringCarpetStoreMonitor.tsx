...
export interface FlooringCarpetStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FlooringCarpetStoreMonitor({ onClose, showClose = true }: FlooringCarpetStoreMonitorProps) {
  return (
...
export default FlooringCarpetStoreMonitor
