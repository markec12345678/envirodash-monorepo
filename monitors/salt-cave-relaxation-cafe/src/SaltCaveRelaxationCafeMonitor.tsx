...
export interface SaltCaveRelaxationCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SaltCaveRelaxationCafeMonitor({ onClose, showClose = true }: SaltCaveRelaxationCafeMonitorProps) {
  return (
...
export default SaltCaveRelaxationCafeMonitor
