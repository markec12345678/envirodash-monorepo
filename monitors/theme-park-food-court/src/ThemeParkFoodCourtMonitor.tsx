...
export interface ThemeParkFoodCourtMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ThemeParkFoodCourtMonitor({ onClose, showClose = true }: ThemeParkFoodCourtMonitorProps) {
  return (
...
export default ThemeParkFoodCourtMonitor
