...
export interface WildlifeCorridorMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WildlifeCorridorMonitor({ onClose, showClose = true }: WildlifeCorridorMonitorProps) {
  return (
...
export default WildlifeCorridorMonitor
