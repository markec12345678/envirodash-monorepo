...
export interface BicycleRetailerMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BicycleRetailerMonitor({ onClose, showClose = true }: BicycleRetailerMonitorProps) {
  return (
...
export default BicycleRetailerMonitor
