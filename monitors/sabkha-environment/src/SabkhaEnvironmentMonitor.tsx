...
export interface SabkhaEnvironmentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SabkhaEnvironmentMonitor({ onClose, showClose = true }: SabkhaEnvironmentMonitorProps) {
  return (
...
export default SabkhaEnvironmentMonitor
