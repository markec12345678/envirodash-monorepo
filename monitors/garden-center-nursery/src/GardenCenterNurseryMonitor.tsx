...
export interface GardenCenterNurseryMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GardenCenterNurseryMonitor({ onClose, showClose = true }: GardenCenterNurseryMonitorProps) {
  return (
...
export default GardenCenterNurseryMonitor
