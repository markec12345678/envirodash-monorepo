...
export interface MontessoriEarlyLearningMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MontessoriEarlyLearningMonitor({ onClose, showClose = true }: MontessoriEarlyLearningMonitorProps) {
  return (
...
export default MontessoriEarlyLearningMonitor
