...
export interface SheetMusicShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SheetMusicShopMonitor({ onClose, showClose = true }: SheetMusicShopMonitorProps) {
  return (
...
export default SheetMusicShopMonitor
