...
export interface AirportFoodCourtMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AirportFoodCourtMonitor({ onClose, showClose = true }: AirportFoodCourtMonitorProps) {
  return (
...
export default AirportFoodCourtMonitor
