...
export interface HotelOccupancyMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HotelOccupancyMonitor({ onClose, showClose = true }: HotelOccupancyMonitorProps) {
  return (
...
export default HotelOccupancyMonitor
