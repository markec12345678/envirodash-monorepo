...
export interface CathedralBasilicaMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CathedralBasilicaMonitor({ onClose, showClose = true }: CathedralBasilicaMonitorProps) {
  return (
...
export default CathedralBasilicaMonitor
