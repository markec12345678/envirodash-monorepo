...
export interface LastMileDeliveryHubMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LastMileDeliveryHubMonitor({ onClose, showClose = true }: LastMileDeliveryHubMonitorProps) {
  return (
...
export default LastMileDeliveryHubMonitor
