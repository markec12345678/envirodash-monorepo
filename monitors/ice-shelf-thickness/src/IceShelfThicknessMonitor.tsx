...
export interface IceShelfThicknessMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function IceShelfThicknessMonitor({ onClose, showClose = true }: IceShelfThicknessMonitorProps) {
  return (
...
export default IceShelfThicknessMonitor
