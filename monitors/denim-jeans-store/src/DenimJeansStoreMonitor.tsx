...
export interface DenimJeansStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DenimJeansStoreMonitor({ onClose, showClose = true }: DenimJeansStoreMonitorProps) {
  return (
...
export default DenimJeansStoreMonitor
