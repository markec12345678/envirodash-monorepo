...
export interface SailingClubBarMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SailingClubBarMonitor({ onClose, showClose = true }: SailingClubBarMonitorProps) {
  return (
...
export default SailingClubBarMonitor
