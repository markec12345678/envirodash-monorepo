...
export interface JettyCurrentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function JettyCurrentMonitor({ onClose, showClose = true }: JettyCurrentMonitorProps) {
  return (
...
export default JettyCurrentMonitor
