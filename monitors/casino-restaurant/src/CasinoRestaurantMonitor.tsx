...
export interface CasinoRestaurantMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CasinoRestaurantMonitor({ onClose, showClose = true }: CasinoRestaurantMonitorProps) {
  return (
...
export default CasinoRestaurantMonitor
