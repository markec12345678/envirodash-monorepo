...
export interface HighwayBottleneckMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HighwayBottleneckMonitor({ onClose, showClose = true }: HighwayBottleneckMonitorProps) {
  return (
...
export default HighwayBottleneckMonitor
