...
export interface SlumpFailureMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SlumpFailureMonitor({ onClose, showClose = true }: SlumpFailureMonitorProps) {
  return (
...
export default SlumpFailureMonitor
