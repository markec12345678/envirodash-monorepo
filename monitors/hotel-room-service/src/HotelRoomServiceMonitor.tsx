...
export interface HotelRoomServiceMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HotelRoomServiceMonitor({ onClose, showClose = true }: HotelRoomServiceMonitorProps) {
  return (
...
export default HotelRoomServiceMonitor
