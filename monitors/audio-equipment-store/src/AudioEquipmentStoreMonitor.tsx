...
export interface AudioEquipmentStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AudioEquipmentStoreMonitor({ onClose, showClose = true }: AudioEquipmentStoreMonitorProps) {
  return (
...
export default AudioEquipmentStoreMonitor
