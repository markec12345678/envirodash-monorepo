...
export interface EscapeRoomLoungeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function EscapeRoomLoungeMonitor({ onClose, showClose = true }: EscapeRoomLoungeMonitorProps) {
  return (
...
export default EscapeRoomLoungeMonitor
