...
export interface SkinCareClinicMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SkinCareClinicMonitor({ onClose, showClose = true }: SkinCareClinicMonitorProps) {
  return (
...
export default SkinCareClinicMonitor
