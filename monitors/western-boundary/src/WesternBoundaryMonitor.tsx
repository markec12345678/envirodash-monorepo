...
export interface WesternBoundaryMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WesternBoundaryMonitor({ onClose, showClose = true }: WesternBoundaryMonitorProps) {
  return (
...
export default WesternBoundaryMonitor
