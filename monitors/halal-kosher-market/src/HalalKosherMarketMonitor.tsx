...
export interface HalalKosherMarketMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HalalKosherMarketMonitor({ onClose, showClose = true }: HalalKosherMarketMonitorProps) {
  return (
...
export default HalalKosherMarketMonitor
