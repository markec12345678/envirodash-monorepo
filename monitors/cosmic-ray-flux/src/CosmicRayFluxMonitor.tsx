...
export interface CosmicRayFluxMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CosmicRayFluxMonitor({ onClose, showClose = true }: CosmicRayFluxMonitorProps) {
  return (
...
export default CosmicRayFluxMonitor
