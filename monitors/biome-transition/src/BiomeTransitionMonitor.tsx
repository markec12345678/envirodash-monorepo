...
export interface BiomeTransitionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BiomeTransitionMonitor({ onClose, showClose = true }: BiomeTransitionMonitorProps) {
  return (
...
export default BiomeTransitionMonitor
