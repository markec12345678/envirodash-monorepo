...
export interface OzoneLayerMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function OzoneLayerMonitor({ onClose, showClose = true }: OzoneLayerMonitorProps) {
  return (
...
export default OzoneLayerMonitor
