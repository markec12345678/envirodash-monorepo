...
export interface PetBoardingKennelMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PetBoardingKennelMonitor({ onClose, showClose = true }: PetBoardingKennelMonitorProps) {
  return (
...
export default PetBoardingKennelMonitor
