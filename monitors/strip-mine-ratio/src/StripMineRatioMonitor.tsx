...
export interface StripMineRatioMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function StripMineRatioMonitor({ onClose, showClose = true }: StripMineRatioMonitorProps) {
  return (
...
export default StripMineRatioMonitor
