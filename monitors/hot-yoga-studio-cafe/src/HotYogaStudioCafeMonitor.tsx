...
export interface HotYogaStudioCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HotYogaStudioCafeMonitor({ onClose, showClose = true }: HotYogaStudioCafeMonitorProps) {
  return (
...
export default HotYogaStudioCafeMonitor
