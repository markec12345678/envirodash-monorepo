...
export interface TropicalCurrentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TropicalCurrentMonitor({ onClose, showClose = true }: TropicalCurrentMonitorProps) {
  return (
...
export default TropicalCurrentMonitor
