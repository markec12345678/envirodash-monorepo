...
export interface ThermoclineDepthMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ThermoclineDepthMonitor({ onClose, showClose = true }: ThermoclineDepthMonitorProps) {
  return (
...
export default ThermoclineDepthMonitor
