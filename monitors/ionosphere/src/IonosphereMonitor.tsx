...
export interface IonosphereMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function IonosphereMonitor({ onClose, showClose = true }: IonosphereMonitorProps) {
  return (
...
export default IonosphereMonitor
