...
export interface CreditUnionBranchMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CreditUnionBranchMonitor({ onClose, showClose = true }: CreditUnionBranchMonitorProps) {
  return (
...
export default CreditUnionBranchMonitor
