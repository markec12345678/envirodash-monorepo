...
export interface SkyscraperElevatorMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SkyscraperElevatorMonitor({ onClose, showClose = true }: SkyscraperElevatorMonitorProps) {
  return (
...
export default SkyscraperElevatorMonitor
