...
export interface GardenCenterFloristMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GardenCenterFloristMonitor({ onClose, showClose = true }: GardenCenterFloristMonitorProps) {
  return (
...
export default GardenCenterFloristMonitor
