...
export interface DesertificationDetailMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DesertificationDetailMonitor({ onClose, showClose = true }: DesertificationDetailMonitorProps) {
  return (
...
export default DesertificationDetailMonitor
