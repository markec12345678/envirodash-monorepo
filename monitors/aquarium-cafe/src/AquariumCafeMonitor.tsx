...
export interface AquariumCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AquariumCafeMonitor({ onClose, showClose = true }: AquariumCafeMonitorProps) {
  return (
...
export default AquariumCafeMonitor
