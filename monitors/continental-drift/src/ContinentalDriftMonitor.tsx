...
export interface ContinentalDriftMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ContinentalDriftMonitor({ onClose, showClose = true }: ContinentalDriftMonitorProps) {
  return (
...
export default ContinentalDriftMonitor
