...
export interface CoralBleachingMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CoralBleachingMonitor({ onClose, showClose = true }: CoralBleachingMonitorProps) {
  return (
...
export default CoralBleachingMonitor
