...
export interface OilChangeExpressMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function OilChangeExpressMonitor({ onClose, showClose = true }: OilChangeExpressMonitorProps) {
  return (
...
export default OilChangeExpressMonitor
