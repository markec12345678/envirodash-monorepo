...
export interface CoastalWetlandLossMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CoastalWetlandLossMonitor({ onClose, showClose = true }: CoastalWetlandLossMonitorProps) {
  return (
...
export default CoastalWetlandLossMonitor
