...
export interface MattressBeddingStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MattressBeddingStoreMonitor({ onClose, showClose = true }: MattressBeddingStoreMonitorProps) {
  return (
...
export default MattressBeddingStoreMonitor
