...
export interface CoalMineProductionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CoalMineProductionMonitor({ onClose, showClose = true }: CoalMineProductionMonitorProps) {
  return (
...
export default CoalMineProductionMonitor
