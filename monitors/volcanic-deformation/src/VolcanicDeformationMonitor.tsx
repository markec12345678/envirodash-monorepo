...
export interface VolcanicDeformationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VolcanicDeformationMonitor({ onClose, showClose = true }: VolcanicDeformationMonitorProps) {
  return (
...
export default VolcanicDeformationMonitor
