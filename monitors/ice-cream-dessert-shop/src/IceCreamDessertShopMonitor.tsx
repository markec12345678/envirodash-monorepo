...
export interface IceCreamDessertShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function IceCreamDessertShopMonitor({ onClose, showClose = true }: IceCreamDessertShopMonitorProps) {
  return (
...
export default IceCreamDessertShopMonitor
