...
export interface OreGradeAssayMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function OreGradeAssayMonitor({ onClose, showClose = true }: OreGradeAssayMonitorProps) {
  return (
...
export default OreGradeAssayMonitor
