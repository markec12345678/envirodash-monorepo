...
export interface GeostrophicCurrentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GeostrophicCurrentMonitor({ onClose, showClose = true }: GeostrophicCurrentMonitorProps) {
  return (
...
export default GeostrophicCurrentMonitor
