...
export interface RipCurrentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RipCurrentMonitor({ onClose, showClose = true }: RipCurrentMonitorProps) {
  return (
...
export default RipCurrentMonitor
