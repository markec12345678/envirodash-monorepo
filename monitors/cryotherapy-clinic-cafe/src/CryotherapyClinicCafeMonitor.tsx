...
export interface CryotherapyClinicCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CryotherapyClinicCafeMonitor({ onClose, showClose = true }: CryotherapyClinicCafeMonitorProps) {
  return (
...
export default CryotherapyClinicCafeMonitor
