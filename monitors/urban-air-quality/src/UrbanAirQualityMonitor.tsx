...
export interface UrbanAirQualityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function UrbanAirQualityMonitor({ onClose, showClose = true }: UrbanAirQualityMonitorProps) {
  return (
...
export default UrbanAirQualityMonitor
