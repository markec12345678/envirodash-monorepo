...
export interface AutoMechanicShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AutoMechanicShopMonitor({ onClose, showClose = true }: AutoMechanicShopMonitorProps) {
  return (
...
export default AutoMechanicShopMonitor
