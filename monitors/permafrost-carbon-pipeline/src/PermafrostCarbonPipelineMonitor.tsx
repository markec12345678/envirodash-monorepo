...
export interface PermafrostCarbonPipelineMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PermafrostCarbonPipelineMonitor({ onClose, showClose = true }: PermafrostCarbonPipelineMonitorProps) {
  return (
...
export default PermafrostCarbonPipelineMonitor
