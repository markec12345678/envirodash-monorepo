...
export interface LandscapeSupplyYardMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LandscapeSupplyYardMonitor({ onClose, showClose = true }: LandscapeSupplyYardMonitorProps) {
  return (
...
export default LandscapeSupplyYardMonitor
