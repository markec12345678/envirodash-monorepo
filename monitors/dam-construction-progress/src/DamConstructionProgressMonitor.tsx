...
export interface DamConstructionProgressMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DamConstructionProgressMonitor({ onClose, showClose = true }: DamConstructionProgressMonitorProps) {
  return (
...
export default DamConstructionProgressMonitor
