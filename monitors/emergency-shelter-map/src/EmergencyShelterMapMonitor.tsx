...
export interface EmergencyShelterMapMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function EmergencyShelterMapMonitor({ onClose, showClose = true }: EmergencyShelterMapMonitorProps) {
  return (
...
export default EmergencyShelterMapMonitor
