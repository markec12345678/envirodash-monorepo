...
export interface MufflerExhaustShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MufflerExhaustShopMonitor({ onClose, showClose = true }: MufflerExhaustShopMonitorProps) {
  return (
...
export default MufflerExhaustShopMonitor
