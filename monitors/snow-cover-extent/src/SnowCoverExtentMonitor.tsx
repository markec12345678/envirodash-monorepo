...
export interface SnowCoverExtentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SnowCoverExtentMonitor({ onClose, showClose = true }: SnowCoverExtentMonitorProps) {
  return (
...
export default SnowCoverExtentMonitor
