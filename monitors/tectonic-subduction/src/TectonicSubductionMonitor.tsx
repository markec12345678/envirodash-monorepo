...
export interface TectonicSubductionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TectonicSubductionMonitor({ onClose, showClose = true }: TectonicSubductionMonitorProps) {
  return (
...
export default TectonicSubductionMonitor
