...
export interface Co2AtmosphericMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function Co2AtmosphericMonitor({ onClose, showClose = true }: Co2AtmosphericMonitorProps) {
  return (
...
export default Co2AtmosphericMonitor
