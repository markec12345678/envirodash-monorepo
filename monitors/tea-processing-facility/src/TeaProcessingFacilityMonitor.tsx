...
export interface TeaProcessingFacilityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TeaProcessingFacilityMonitor({ onClose, showClose = true }: TeaProcessingFacilityMonitorProps) {
  return (
...
export default TeaProcessingFacilityMonitor
