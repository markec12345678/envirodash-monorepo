...
export interface ColdChainLogisticsMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ColdChainLogisticsMonitor({ onClose, showClose = true }: ColdChainLogisticsMonitorProps) {
  return (
...
export default ColdChainLogisticsMonitor
