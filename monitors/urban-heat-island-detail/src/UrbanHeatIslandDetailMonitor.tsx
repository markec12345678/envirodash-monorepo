...
export interface UrbanHeatIslandDetailMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function UrbanHeatIslandDetailMonitor({ onClose, showClose = true }: UrbanHeatIslandDetailMonitorProps) {
  return (
...
export default UrbanHeatIslandDetailMonitor
