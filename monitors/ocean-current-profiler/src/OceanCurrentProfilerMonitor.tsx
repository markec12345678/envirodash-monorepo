...
export interface OceanCurrentProfilerMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function OceanCurrentProfilerMonitor({ onClose, showClose = true }: OceanCurrentProfilerMonitorProps) {
  return (
...
export default OceanCurrentProfilerMonitor
