...
export interface AtmosphericPressureCellMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AtmosphericPressureCellMonitor({ onClose, showClose = true }: AtmosphericPressureCellMonitorProps) {
  return (
...
export default AtmosphericPressureCellMonitor
