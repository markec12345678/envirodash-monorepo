...
export interface FilingStorageStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FilingStorageStoreMonitor({ onClose, showClose = true }: FilingStorageStoreMonitorProps) {
  return (
...
export default FilingStorageStoreMonitor
