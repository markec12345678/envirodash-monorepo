...
export interface PlumbingSupplyMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PlumbingSupplyMonitor({ onClose, showClose = true }: PlumbingSupplyMonitorProps) {
  return (
...
export default PlumbingSupplyMonitor
