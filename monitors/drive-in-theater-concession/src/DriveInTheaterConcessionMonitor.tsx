...
export interface DriveInTheaterConcessionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DriveInTheaterConcessionMonitor({ onClose, showClose = true }: DriveInTheaterConcessionMonitorProps) {
  return (
...
export default DriveInTheaterConcessionMonitor
