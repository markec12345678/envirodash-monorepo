...
export interface MaritimePiracyAlertMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MaritimePiracyAlertMonitor({ onClose, showClose = true }: MaritimePiracyAlertMonitorProps) {
  return (
...
export default MaritimePiracyAlertMonitor
