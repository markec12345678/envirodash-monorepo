...
export interface SpaceportLaunchSiteMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SpaceportLaunchSiteMonitor({ onClose, showClose = true }: SpaceportLaunchSiteMonitorProps) {
  return (
...
export default SpaceportLaunchSiteMonitor
