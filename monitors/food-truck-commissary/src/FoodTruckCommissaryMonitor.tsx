...
export interface FoodTruckCommissaryMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FoodTruckCommissaryMonitor({ onClose, showClose = true }: FoodTruckCommissaryMonitorProps) {
  return (
...
export default FoodTruckCommissaryMonitor
