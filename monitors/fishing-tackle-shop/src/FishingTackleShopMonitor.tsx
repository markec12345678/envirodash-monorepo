...
export interface FishingTackleShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FishingTackleShopMonitor({ onClose, showClose = true }: FishingTackleShopMonitorProps) {
  return (
...
export default FishingTackleShopMonitor
