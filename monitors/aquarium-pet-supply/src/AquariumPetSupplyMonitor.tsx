...
export interface AquariumPetSupplyMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AquariumPetSupplyMonitor({ onClose, showClose = true }: AquariumPetSupplyMonitorProps) {
  return (
...
export default AquariumPetSupplyMonitor
