...
export interface TectonicStrainMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TectonicStrainMonitor({ onClose, showClose = true }: TectonicStrainMonitorProps) {
  return (
...
export default TectonicStrainMonitor
