...
export interface FastFoodChainMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FastFoodChainMonitor({ onClose, showClose = true }: FastFoodChainMonitorProps) {
  return (
...
export default FastFoodChainMonitor
