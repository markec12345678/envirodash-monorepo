...
export interface GlacierMassBalanceMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GlacierMassBalanceMonitor({ onClose, showClose = true }: GlacierMassBalanceMonitorProps) {
  return (
...
export default GlacierMassBalanceMonitor
