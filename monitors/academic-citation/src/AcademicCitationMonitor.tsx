...
export interface AcademicCitationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AcademicCitationMonitor({ onClose, showClose = true }: AcademicCitationMonitorProps) {
  return (
...
export default AcademicCitationMonitor
