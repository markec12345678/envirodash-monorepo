...
export interface JetStreamPositionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function JetStreamPositionMonitor({ onClose, showClose = true }: JetStreamPositionMonitorProps) {
  return (
...
export default JetStreamPositionMonitor
