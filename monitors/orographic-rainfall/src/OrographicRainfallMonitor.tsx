...
export interface OrographicRainfallMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function OrographicRainfallMonitor({ onClose, showClose = true }: OrographicRainfallMonitorProps) {
  return (
...
export default OrographicRainfallMonitor
