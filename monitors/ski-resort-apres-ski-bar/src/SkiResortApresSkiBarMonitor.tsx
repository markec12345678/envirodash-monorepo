...
export interface SkiResortApresSkiBarMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SkiResortApresSkiBarMonitor({ onClose, showClose = true }: SkiResortApresSkiBarMonitorProps) {
  return (
...
export default SkiResortApresSkiBarMonitor
