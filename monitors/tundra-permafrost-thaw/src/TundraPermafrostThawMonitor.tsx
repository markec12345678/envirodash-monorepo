...
export interface TundraPermafrostThawMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TundraPermafrostThawMonitor({ onClose, showClose = true }: TundraPermafrostThawMonitorProps) {
  return (
...
export default TundraPermafrostThawMonitor
