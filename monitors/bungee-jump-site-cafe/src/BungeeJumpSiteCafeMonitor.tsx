...
export interface BungeeJumpSiteCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BungeeJumpSiteCafeMonitor({ onClose, showClose = true }: BungeeJumpSiteCafeMonitorProps) {
  return (
...
export default BungeeJumpSiteCafeMonitor
