...
export interface PreschoolKindergartenMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PreschoolKindergartenMonitor({ onClose, showClose = true }: PreschoolKindergartenMonitorProps) {
  return (
...
export default PreschoolKindergartenMonitor
