...
export interface RiverSedimentLoadMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RiverSedimentLoadMonitor({ onClose, showClose = true }: RiverSedimentLoadMonitorProps) {
  return (
...
export default RiverSedimentLoadMonitor
