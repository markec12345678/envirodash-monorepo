...
export interface RevetmentStabilityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RevetmentStabilityMonitor({ onClose, showClose = true }: RevetmentStabilityMonitorProps) {
  return (
...
export default RevetmentStabilityMonitor
