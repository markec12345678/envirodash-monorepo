...
export interface InternetExchangePointMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function InternetExchangePointMonitor({ onClose, showClose = true }: InternetExchangePointMonitorProps) {
  return (
...
export default InternetExchangePointMonitor
