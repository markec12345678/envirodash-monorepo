...
export interface VideoGameRetailerMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VideoGameRetailerMonitor({ onClose, showClose = true }: VideoGameRetailerMonitorProps) {
  return (
...
export default VideoGameRetailerMonitor
