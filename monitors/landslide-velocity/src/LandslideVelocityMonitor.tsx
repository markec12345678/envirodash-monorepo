...
export interface LandslideVelocityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LandslideVelocityMonitor({ onClose, showClose = true }: LandslideVelocityMonitorProps) {
  return (
...
export default LandslideVelocityMonitor
