...
export interface DiamondWholesaleDealerMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DiamondWholesaleDealerMonitor({ onClose, showClose = true }: DiamondWholesaleDealerMonitorProps) {
  return (
...
export default DiamondWholesaleDealerMonitor
