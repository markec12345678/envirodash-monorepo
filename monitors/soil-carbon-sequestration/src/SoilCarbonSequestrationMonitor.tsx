...
export interface SoilCarbonSequestrationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SoilCarbonSequestrationMonitor({ onClose, showClose = true }: SoilCarbonSequestrationMonitorProps) {
  return (
...
export default SoilCarbonSequestrationMonitor
