...
export interface CateringEventHallMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CateringEventHallMonitor({ onClose, showClose = true }: CateringEventHallMonitorProps) {
  return (
...
export default CateringEventHallMonitor
