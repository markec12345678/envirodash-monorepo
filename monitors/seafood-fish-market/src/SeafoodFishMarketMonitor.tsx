...
export interface SeafoodFishMarketMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SeafoodFishMarketMonitor({ onClose, showClose = true }: SeafoodFishMarketMonitorProps) {
  return (
...
export default SeafoodFishMarketMonitor
