...
export interface VolcanicGasEmissionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VolcanicGasEmissionMonitor({ onClose, showClose = true }: VolcanicGasEmissionMonitorProps) {
  return (
...
export default VolcanicGasEmissionMonitor
