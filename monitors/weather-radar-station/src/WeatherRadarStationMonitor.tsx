...
export interface WeatherRadarStationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WeatherRadarStationMonitor({ onClose, showClose = true }: WeatherRadarStationMonitorProps) {
  return (
...
export default WeatherRadarStationMonitor
