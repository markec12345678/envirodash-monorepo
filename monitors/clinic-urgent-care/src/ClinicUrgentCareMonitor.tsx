...
export interface ClinicUrgentCareMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ClinicUrgentCareMonitor({ onClose, showClose = true }: ClinicUrgentCareMonitorProps) {
  return (
...
export default ClinicUrgentCareMonitor
