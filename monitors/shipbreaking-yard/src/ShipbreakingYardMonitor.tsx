...
export interface ShipbreakingYardMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ShipbreakingYardMonitor({ onClose, showClose = true }: ShipbreakingYardMonitorProps) {
  return (
...
export default ShipbreakingYardMonitor
