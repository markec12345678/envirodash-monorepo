...
export interface BatteryStorageFacilityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BatteryStorageFacilityMonitor({ onClose, showClose = true }: BatteryStorageFacilityMonitorProps) {
  return (
...
export default BatteryStorageFacilityMonitor
