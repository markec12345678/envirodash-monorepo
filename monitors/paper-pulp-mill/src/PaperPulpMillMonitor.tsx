...
export interface PaperPulpMillMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PaperPulpMillMonitor({ onClose, showClose = true }: PaperPulpMillMonitorProps) {
  return (
...
export default PaperPulpMillMonitor
