...
export interface SmartHomeTechStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SmartHomeTechStoreMonitor({ onClose, showClose = true }: SmartHomeTechStoreMonitorProps) {
  return (
...
export default SmartHomeTechStoreMonitor
