...
export interface BotanicalGardenCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BotanicalGardenCafeMonitor({ onClose, showClose = true }: BotanicalGardenCafeMonitorProps) {
  return (
...
export default BotanicalGardenCafeMonitor
