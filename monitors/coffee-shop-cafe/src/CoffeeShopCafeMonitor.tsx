...
export interface CoffeeShopCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CoffeeShopCafeMonitor({ onClose, showClose = true }: CoffeeShopCafeMonitorProps) {
  return (
...
export default CoffeeShopCafeMonitor
