...
export interface HospitalCapacityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HospitalCapacityMonitor({ onClose, showClose = true }: HospitalCapacityMonitorProps) {
  return (
...
export default HospitalCapacityMonitor
