...
export interface FlowerMarketWholesaleMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FlowerMarketWholesaleMonitor({ onClose, showClose = true }: FlowerMarketWholesaleMonitorProps) {
  return (
...
export default FlowerMarketWholesaleMonitor
