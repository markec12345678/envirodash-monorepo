...
export interface SemiconductorFabMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SemiconductorFabMonitor({ onClose, showClose = true }: SemiconductorFabMonitorProps) {
  return (
...
export default SemiconductorFabMonitor
