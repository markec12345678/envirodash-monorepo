...
export interface RecyclingCenterMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RecyclingCenterMonitor({ onClose, showClose = true }: RecyclingCenterMonitorProps) {
  return (
...
export default RecyclingCenterMonitor
