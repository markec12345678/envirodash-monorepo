...
export interface FoodBankPantryMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FoodBankPantryMonitor({ onClose, showClose = true }: FoodBankPantryMonitorProps) {
  return (
...
export default FoodBankPantryMonitor
