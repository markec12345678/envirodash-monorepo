...
export interface ResearchOutputMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ResearchOutputMonitor({ onClose, showClose = true }: ResearchOutputMonitorProps) {
  return (
...
export default ResearchOutputMonitor
