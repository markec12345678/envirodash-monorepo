...
export interface WomensClothingStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WomensClothingStoreMonitor({ onClose, showClose = true }: WomensClothingStoreMonitorProps) {
  return (
...
export default WomensClothingStoreMonitor
