...
export interface RiverboatCruiseDiningMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RiverboatCruiseDiningMonitor({ onClose, showClose = true }: RiverboatCruiseDiningMonitorProps) {
  return (
...
export default RiverboatCruiseDiningMonitor
