...
export interface IceCreamParlorMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function IceCreamParlorMonitor({ onClose, showClose = true }: IceCreamParlorMonitorProps) {
  return (
...
export default IceCreamParlorMonitor
