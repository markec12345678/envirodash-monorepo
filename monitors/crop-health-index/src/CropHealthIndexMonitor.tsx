...
export interface CropHealthIndexMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CropHealthIndexMonitor({ onClose, showClose = true }: CropHealthIndexMonitorProps) {
  return (
...
export default CropHealthIndexMonitor
