...
export interface RiverDeltaMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RiverDeltaMonitor({ onClose, showClose = true }: RiverDeltaMonitorProps) {
  return (
...
export default RiverDeltaMonitor
