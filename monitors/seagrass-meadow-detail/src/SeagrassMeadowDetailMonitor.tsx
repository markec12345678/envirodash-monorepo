...
export interface SeagrassMeadowDetailMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SeagrassMeadowDetailMonitor({ onClose, showClose = true }: SeagrassMeadowDetailMonitorProps) {
  return (
...
export default SeagrassMeadowDetailMonitor
