...
export interface FlightPathTrackerMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FlightPathTrackerMonitor({ onClose, showClose = true }: FlightPathTrackerMonitorProps) {
  return (
...
export default FlightPathTrackerMonitor
