...
export interface SeaLevelRiseMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SeaLevelRiseMonitor({ onClose, showClose = true }: SeaLevelRiseMonitorProps) {
  return (
...
export default SeaLevelRiseMonitor
