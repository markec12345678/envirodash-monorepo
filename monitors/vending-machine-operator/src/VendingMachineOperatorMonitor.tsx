...
export interface VendingMachineOperatorMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VendingMachineOperatorMonitor({ onClose, showClose = true }: VendingMachineOperatorMonitorProps) {
  return (
...
export default VendingMachineOperatorMonitor
