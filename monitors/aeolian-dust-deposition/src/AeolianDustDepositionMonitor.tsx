...
export interface AeolianDustDepositionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AeolianDustDepositionMonitor({ onClose, showClose = true }: AeolianDustDepositionMonitorProps) {
  return (
...
export default AeolianDustDepositionMonitor
