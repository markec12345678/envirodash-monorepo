...
export interface FloatSpaLoungeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FloatSpaLoungeMonitor({ onClose, showClose = true }: FloatSpaLoungeMonitorProps) {
  return (
...
export default FloatSpaLoungeMonitor
