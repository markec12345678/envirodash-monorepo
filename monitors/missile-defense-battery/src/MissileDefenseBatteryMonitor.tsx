...
export interface MissileDefenseBatteryMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MissileDefenseBatteryMonitor({ onClose, showClose = true }: MissileDefenseBatteryMonitorProps) {
  return (
...
export default MissileDefenseBatteryMonitor
