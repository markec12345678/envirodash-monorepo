...
export interface PhytoplanktonBloomMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PhytoplanktonBloomMonitor({ onClose, showClose = true }: PhytoplanktonBloomMonitorProps) {
  return (
...
export default PhytoplanktonBloomMonitor
