...
export interface CoffeeRoasteryBatchMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CoffeeRoasteryBatchMonitor({ onClose, showClose = true }: CoffeeRoasteryBatchMonitorProps) {
  return (
...
export default CoffeeRoasteryBatchMonitor
