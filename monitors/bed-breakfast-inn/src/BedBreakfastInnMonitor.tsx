...
export interface BedBreakfastInnMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BedBreakfastInnMonitor({ onClose, showClose = true }: BedBreakfastInnMonitorProps) {
  return (
...
export default BedBreakfastInnMonitor
