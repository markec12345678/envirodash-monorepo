...
export interface SupervolcanoMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SupervolcanoMonitor({ onClose, showClose = true }: SupervolcanoMonitorProps) {
  return (
...
export default SupervolcanoMonitor
