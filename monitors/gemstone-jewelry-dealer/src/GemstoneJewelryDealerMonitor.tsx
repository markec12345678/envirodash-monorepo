...
export interface GemstoneJewelryDealerMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GemstoneJewelryDealerMonitor({ onClose, showClose = true }: GemstoneJewelryDealerMonitorProps) {
  return (
...
export default GemstoneJewelryDealerMonitor
