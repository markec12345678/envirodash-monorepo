...
export interface IrrigationEfficiencyMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function IrrigationEfficiencyMonitor({ onClose, showClose = true }: IrrigationEfficiencyMonitorProps) {
  return (
...
export default IrrigationEfficiencyMonitor
