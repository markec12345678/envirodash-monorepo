...
export interface HighwayExpansionProjectMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HighwayExpansionProjectMonitor({ onClose, showClose = true }: HighwayExpansionProjectMonitorProps) {
  return (
...
export default HighwayExpansionProjectMonitor
