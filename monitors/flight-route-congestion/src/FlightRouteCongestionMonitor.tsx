...
export interface FlightRouteCongestionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FlightRouteCongestionMonitor({ onClose, showClose = true }: FlightRouteCongestionMonitorProps) {
  return (
...
export default FlightRouteCongestionMonitor
