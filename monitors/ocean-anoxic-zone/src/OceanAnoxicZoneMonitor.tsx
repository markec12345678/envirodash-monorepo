...
export interface OceanAnoxicZoneMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function OceanAnoxicZoneMonitor({ onClose, showClose = true }: OceanAnoxicZoneMonitorProps) {
  return (
...
export default OceanAnoxicZoneMonitor
