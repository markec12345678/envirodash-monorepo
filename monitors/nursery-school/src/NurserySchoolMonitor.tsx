...
export interface NurserySchoolMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function NurserySchoolMonitor({ onClose, showClose = true }: NurserySchoolMonitorProps) {
  return (
...
export default NurserySchoolMonitor
