...
export interface AvalancheDebrisFlowMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AvalancheDebrisFlowMonitor({ onClose, showClose = true }: AvalancheDebrisFlowMonitorProps) {
  return (
...
export default AvalancheDebrisFlowMonitor
