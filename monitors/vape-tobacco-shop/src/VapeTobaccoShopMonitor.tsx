...
export interface VapeTobaccoShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VapeTobaccoShopMonitor({ onClose, showClose = true }: VapeTobaccoShopMonitorProps) {
  return (
...
export default VapeTobaccoShopMonitor
