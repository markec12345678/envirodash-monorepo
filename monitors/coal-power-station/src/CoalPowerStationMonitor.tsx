...
export interface CoalPowerStationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CoalPowerStationMonitor({ onClose, showClose = true }: CoalPowerStationMonitorProps) {
  return (
...
export default CoalPowerStationMonitor
