...
export interface MethaneHydrateMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MethaneHydrateMonitor({ onClose, showClose = true }: MethaneHydrateMonitorProps) {
  return (
...
export default MethaneHydrateMonitor
