...
export interface ResortSpaWellnessMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ResortSpaWellnessMonitor({ onClose, showClose = true }: ResortSpaWellnessMonitorProps) {
  return (
...
export default ResortSpaWellnessMonitor
