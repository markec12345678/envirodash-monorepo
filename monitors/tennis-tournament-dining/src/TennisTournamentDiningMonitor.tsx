...
export interface TennisTournamentDiningMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TennisTournamentDiningMonitor({ onClose, showClose = true }: TennisTournamentDiningMonitorProps) {
  return (
...
export default TennisTournamentDiningMonitor
