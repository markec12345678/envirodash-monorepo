...
export interface AquacultureFisheryMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AquacultureFisheryMonitor({ onClose, showClose = true }: AquacultureFisheryMonitorProps) {
  return (
...
export default AquacultureFisheryMonitor
