...
export interface CargoShipTrackerMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CargoShipTrackerMonitor({ onClose, showClose = true }: CargoShipTrackerMonitorProps) {
  return (
...
export default CargoShipTrackerMonitor
