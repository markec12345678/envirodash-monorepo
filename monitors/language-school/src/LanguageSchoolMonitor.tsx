...
export interface LanguageSchoolMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LanguageSchoolMonitor({ onClose, showClose = true }: LanguageSchoolMonitorProps) {
  return (
...
export default LanguageSchoolMonitor
