...
export interface PilgrimageSiteMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PilgrimageSiteMonitor({ onClose, showClose = true }: PilgrimageSiteMonitorProps) {
  return (
...
export default PilgrimageSiteMonitor
