...
export interface EstuaryHealthMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function EstuaryHealthMonitor({ onClose, showClose = true }: EstuaryHealthMonitorProps) {
  return (
...
export default EstuaryHealthMonitor
