...
export interface PaymentGatewayStatusMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PaymentGatewayStatusMonitor({ onClose, showClose = true }: PaymentGatewayStatusMonitorProps) {
  return (
...
export default PaymentGatewayStatusMonitor
