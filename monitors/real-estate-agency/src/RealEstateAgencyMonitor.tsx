...
export interface RealEstateAgencyMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RealEstateAgencyMonitor({ onClose, showClose = true }: RealEstateAgencyMonitorProps) {
  return (
...
export default RealEstateAgencyMonitor
