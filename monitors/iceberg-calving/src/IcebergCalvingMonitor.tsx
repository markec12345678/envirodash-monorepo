...
export interface IcebergCalvingMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function IcebergCalvingMonitor({ onClose, showClose = true }: IcebergCalvingMonitorProps) {
  return (
...
export default IcebergCalvingMonitor
