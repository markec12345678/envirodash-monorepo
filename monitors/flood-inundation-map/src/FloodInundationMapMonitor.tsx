...
export interface FloodInundationMapMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FloodInundationMapMonitor({ onClose, showClose = true }: FloodInundationMapMonitorProps) {
  return (
...
export default FloodInundationMapMonitor
