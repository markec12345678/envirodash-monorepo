...
export interface EndangeredSpeciesMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function EndangeredSpeciesMonitor({ onClose, showClose = true }: EndangeredSpeciesMonitorProps) {
  return (
...
export default EndangeredSpeciesMonitor
