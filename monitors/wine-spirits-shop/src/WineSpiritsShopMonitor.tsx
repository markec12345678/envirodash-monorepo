...
export interface WineSpiritsShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WineSpiritsShopMonitor({ onClose, showClose = true }: WineSpiritsShopMonitorProps) {
  return (
...
export default WineSpiritsShopMonitor
