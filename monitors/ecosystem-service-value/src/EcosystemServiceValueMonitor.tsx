...
export interface EcosystemServiceValueMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function EcosystemServiceValueMonitor({ onClose, showClose = true }: EcosystemServiceValueMonitorProps) {
  return (
...
export default EcosystemServiceValueMonitor
