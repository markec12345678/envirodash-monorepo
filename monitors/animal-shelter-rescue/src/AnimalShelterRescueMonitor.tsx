...
export interface AnimalShelterRescueMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AnimalShelterRescueMonitor({ onClose, showClose = true }: AnimalShelterRescueMonitorProps) {
  return (
...
export default AnimalShelterRescueMonitor
