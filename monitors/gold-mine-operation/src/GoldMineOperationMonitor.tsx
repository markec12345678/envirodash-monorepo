...
export interface GoldMineOperationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GoldMineOperationMonitor({ onClose, showClose = true }: GoldMineOperationMonitorProps) {
  return (
...
export default GoldMineOperationMonitor
