...
export interface CookingSchoolCulinaryInstituteMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CookingSchoolCulinaryInstituteMonitor({ onClose, showClose = true }: CookingSchoolCulinaryInstituteMonitorProps) {
  return (
...
export default CookingSchoolCulinaryInstituteMonitor
