...
export interface PizzaItalianRestaurantMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PizzaItalianRestaurantMonitor({ onClose, showClose = true }: PizzaItalianRestaurantMonitorProps) {
  return (
...
export default PizzaItalianRestaurantMonitor
