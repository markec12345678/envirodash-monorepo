...
export interface PlanetariumShowMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PlanetariumShowMonitor({ onClose, showClose = true }: PlanetariumShowMonitorProps) {
  return (
...
export default PlanetariumShowMonitor
