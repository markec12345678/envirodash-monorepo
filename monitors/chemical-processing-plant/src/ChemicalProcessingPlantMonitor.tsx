...
export interface ChemicalProcessingPlantMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ChemicalProcessingPlantMonitor({ onClose, showClose = true }: ChemicalProcessingPlantMonitorProps) {
  return (
...
export default ChemicalProcessingPlantMonitor
