...
export interface DistilleryOperationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DistilleryOperationMonitor({ onClose, showClose = true }: DistilleryOperationMonitorProps) {
  return (
...
export default DistilleryOperationMonitor
