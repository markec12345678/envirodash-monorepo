...
export interface VolcanicIslandFormationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VolcanicIslandFormationMonitor({ onClose, showClose = true }: VolcanicIslandFormationMonitorProps) {
  return (
...
export default VolcanicIslandFormationMonitor
