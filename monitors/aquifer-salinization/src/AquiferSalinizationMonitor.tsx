...
export interface AquiferSalinizationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AquiferSalinizationMonitor({ onClose, showClose = true }: AquiferSalinizationMonitorProps) {
  return (
...
export default AquiferSalinizationMonitor
