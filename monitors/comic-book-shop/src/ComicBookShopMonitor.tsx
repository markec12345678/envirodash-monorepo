...
export interface ComicBookShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ComicBookShopMonitor({ onClose, showClose = true }: ComicBookShopMonitorProps) {
  return (
...
export default ComicBookShopMonitor
