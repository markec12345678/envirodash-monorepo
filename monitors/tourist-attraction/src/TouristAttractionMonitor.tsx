...
export interface TouristAttractionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TouristAttractionMonitor({ onClose, showClose = true }: TouristAttractionMonitorProps) {
  return (
...
export default TouristAttractionMonitor
