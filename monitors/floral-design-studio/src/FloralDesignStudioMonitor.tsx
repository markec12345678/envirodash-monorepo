...
export interface FloralDesignStudioMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FloralDesignStudioMonitor({ onClose, showClose = true }: FloralDesignStudioMonitorProps) {
  return (
...
export default FloralDesignStudioMonitor
