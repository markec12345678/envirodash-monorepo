...
export interface DustStormTrackerMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DustStormTrackerMonitor({ onClose, showClose = true }: DustStormTrackerMonitorProps) {
  return (
...
export default DustStormTrackerMonitor
