...
export interface PaintballParkCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PaintballParkCafeMonitor({ onClose, showClose = true }: PaintballParkCafeMonitorProps) {
  return (
...
export default PaintballParkCafeMonitor
