...
export interface NaturalGasTerminalMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function NaturalGasTerminalMonitor({ onClose, showClose = true }: NaturalGasTerminalMonitorProps) {
  return (
...
export default NaturalGasTerminalMonitor
