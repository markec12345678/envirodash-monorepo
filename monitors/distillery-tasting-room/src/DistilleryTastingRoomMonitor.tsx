...
export interface DistilleryTastingRoomMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DistilleryTastingRoomMonitor({ onClose, showClose = true }: DistilleryTastingRoomMonitorProps) {
  return (
...
export default DistilleryTastingRoomMonitor
