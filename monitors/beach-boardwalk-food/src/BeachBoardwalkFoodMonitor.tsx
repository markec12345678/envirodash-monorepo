...
export interface BeachBoardwalkFoodMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BeachBoardwalkFoodMonitor({ onClose, showClose = true }: BeachBoardwalkFoodMonitorProps) {
  return (
...
export default BeachBoardwalkFoodMonitor
