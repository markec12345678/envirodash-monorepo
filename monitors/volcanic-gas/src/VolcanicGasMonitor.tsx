...
export interface VolcanicGasMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VolcanicGasMonitor({ onClose, showClose = true }: VolcanicGasMonitorProps) {
  return (
...
export default VolcanicGasMonitor
