...
export interface DesertificationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DesertificationMonitor({ onClose, showClose = true }: DesertificationMonitorProps) {
  return (
...
export default DesertificationMonitor
