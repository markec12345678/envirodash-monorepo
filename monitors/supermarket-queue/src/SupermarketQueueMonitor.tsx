...
export interface SupermarketQueueMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SupermarketQueueMonitor({ onClose, showClose = true }: SupermarketQueueMonitorProps) {
  return (
...
export default SupermarketQueueMonitor
