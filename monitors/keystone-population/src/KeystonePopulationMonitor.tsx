...
export interface KeystonePopulationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function KeystonePopulationMonitor({ onClose, showClose = true }: KeystonePopulationMonitorProps) {
  return (
...
export default KeystonePopulationMonitor
