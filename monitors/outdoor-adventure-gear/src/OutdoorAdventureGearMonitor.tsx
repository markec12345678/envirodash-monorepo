...
export interface OutdoorAdventureGearMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function OutdoorAdventureGearMonitor({ onClose, showClose = true }: OutdoorAdventureGearMonitorProps) {
  return (
...
export default OutdoorAdventureGearMonitor
