...
export interface IndustrialEmissionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function IndustrialEmissionMonitor({ onClose, showClose = true }: IndustrialEmissionMonitorProps) {
  return (
...
export default IndustrialEmissionMonitor
