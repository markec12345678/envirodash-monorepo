...
export interface GeothermalEnergyMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GeothermalEnergyMonitor({ onClose, showClose = true }: GeothermalEnergyMonitorProps) {
  return (
...
export default GeothermalEnergyMonitor
