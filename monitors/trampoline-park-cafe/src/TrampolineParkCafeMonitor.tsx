...
export interface TrampolineParkCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TrampolineParkCafeMonitor({ onClose, showClose = true }: TrampolineParkCafeMonitorProps) {
  return (
...
export default TrampolineParkCafeMonitor
