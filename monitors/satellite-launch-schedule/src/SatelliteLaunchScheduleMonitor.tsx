...
export interface SatelliteLaunchScheduleMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SatelliteLaunchScheduleMonitor({ onClose, showClose = true }: SatelliteLaunchScheduleMonitorProps) {
  return (
...
export default SatelliteLaunchScheduleMonitor
