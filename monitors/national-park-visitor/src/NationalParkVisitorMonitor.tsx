...
export interface NationalParkVisitorMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function NationalParkVisitorMonitor({ onClose, showClose = true }: NationalParkVisitorMonitorProps) {
  return (
...
export default NationalParkVisitorMonitor
