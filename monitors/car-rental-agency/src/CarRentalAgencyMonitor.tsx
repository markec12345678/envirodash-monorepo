...
export interface CarRentalAgencyMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CarRentalAgencyMonitor({ onClose, showClose = true }: CarRentalAgencyMonitorProps) {
  return (
...
export default CarRentalAgencyMonitor
