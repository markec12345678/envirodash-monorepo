...
export interface OceanHeatContentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function OceanHeatContentMonitor({ onClose, showClose = true }: OceanHeatContentMonitorProps) {
  return (
...
export default OceanHeatContentMonitor
