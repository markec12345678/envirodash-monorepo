...
export interface GymFitnessCenterMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GymFitnessCenterMonitor({ onClose, showClose = true }: GymFitnessCenterMonitorProps) {
  return (
...
export default GymFitnessCenterMonitor
