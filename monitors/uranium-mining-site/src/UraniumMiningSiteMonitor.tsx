...
export interface UraniumMiningSiteMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function UraniumMiningSiteMonitor({ onClose, showClose = true }: UraniumMiningSiteMonitorProps) {
  return (
...
export default UraniumMiningSiteMonitor
