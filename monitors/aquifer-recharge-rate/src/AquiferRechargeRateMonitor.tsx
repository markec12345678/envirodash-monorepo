...
export interface AquiferRechargeRateMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AquiferRechargeRateMonitor({ onClose, showClose = true }: AquiferRechargeRateMonitorProps) {
  return (
...
export default AquiferRechargeRateMonitor
