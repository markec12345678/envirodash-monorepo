...
export interface SearchAndRescueOperationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SearchAndRescueOperationMonitor({ onClose, showClose = true }: SearchAndRescueOperationMonitorProps) {
  return (
...
export default SearchAndRescueOperationMonitor
