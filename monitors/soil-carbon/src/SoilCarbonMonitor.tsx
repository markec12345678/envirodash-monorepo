...
export interface SoilCarbonMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SoilCarbonMonitor({ onClose, showClose = true }: SoilCarbonMonitorProps) {
  return (
...
export default SoilCarbonMonitor
