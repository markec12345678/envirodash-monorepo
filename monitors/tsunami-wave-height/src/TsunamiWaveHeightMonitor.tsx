...
export interface TsunamiWaveHeightMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TsunamiWaveHeightMonitor({ onClose, showClose = true }: TsunamiWaveHeightMonitorProps) {
  return (
...
export default TsunamiWaveHeightMonitor
