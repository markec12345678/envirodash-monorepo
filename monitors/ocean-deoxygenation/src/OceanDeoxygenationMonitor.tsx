...
export interface OceanDeoxygenationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function OceanDeoxygenationMonitor({ onClose, showClose = true }: OceanDeoxygenationMonitorProps) {
  return (
...
export default OceanDeoxygenationMonitor
