...
export interface TvTransmissionTowerMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TvTransmissionTowerMonitor({ onClose, showClose = true }: TvTransmissionTowerMonitorProps) {
  return (
...
export default TvTransmissionTowerMonitor
