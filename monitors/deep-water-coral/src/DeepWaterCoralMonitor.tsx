...
export interface DeepWaterCoralMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DeepWaterCoralMonitor({ onClose, showClose = true }: DeepWaterCoralMonitorProps) {
  return (
...
export default DeepWaterCoralMonitor
