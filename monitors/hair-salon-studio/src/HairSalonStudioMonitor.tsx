...
export interface HairSalonStudioMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HairSalonStudioMonitor({ onClose, showClose = true }: HairSalonStudioMonitorProps) {
  return (
...
export default HairSalonStudioMonitor
