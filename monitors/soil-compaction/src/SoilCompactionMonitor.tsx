...
export interface SoilCompactionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SoilCompactionMonitor({ onClose, showClose = true }: SoilCompactionMonitorProps) {
  return (
...
export default SoilCompactionMonitor
