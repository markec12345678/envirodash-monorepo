...
export interface DaycareInfantCenterMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DaycareInfantCenterMonitor({ onClose, showClose = true }: DaycareInfantCenterMonitorProps) {
  return (
...
export default DaycareInfantCenterMonitor
