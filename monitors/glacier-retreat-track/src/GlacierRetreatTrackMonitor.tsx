...
export interface GlacierRetreatTrackMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GlacierRetreatTrackMonitor({ onClose, showClose = true }: GlacierRetreatTrackMonitorProps) {
  return (
...
export default GlacierRetreatTrackMonitor
