...
export interface CarDealershipShowroomMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CarDealershipShowroomMonitor({ onClose, showClose = true }: CarDealershipShowroomMonitorProps) {
  return (
...
export default CarDealershipShowroomMonitor
