...
export interface SupplyChainReliefMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SupplyChainReliefMonitor({ onClose, showClose = true }: SupplyChainReliefMonitorProps) {
  return (
...
export default SupplyChainReliefMonitor
