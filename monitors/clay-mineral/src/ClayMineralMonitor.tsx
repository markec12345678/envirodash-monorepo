...
export interface ClayMineralMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ClayMineralMonitor({ onClose, showClose = true }: ClayMineralMonitorProps) {
  return (
...
export default ClayMineralMonitor
