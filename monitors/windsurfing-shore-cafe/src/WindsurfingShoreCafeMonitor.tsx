...
export interface WindsurfingShoreCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WindsurfingShoreCafeMonitor({ onClose, showClose = true }: WindsurfingShoreCafeMonitorProps) {
  return (
...
export default WindsurfingShoreCafeMonitor
