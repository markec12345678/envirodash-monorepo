...
export interface ServicedApartmentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ServicedApartmentMonitor({ onClose, showClose = true }: ServicedApartmentMonitorProps) {
  return (
...
export default ServicedApartmentMonitor
