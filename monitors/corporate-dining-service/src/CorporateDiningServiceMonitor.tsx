...
export interface CorporateDiningServiceMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CorporateDiningServiceMonitor({ onClose, showClose = true }: CorporateDiningServiceMonitorProps) {
  return (
...
export default CorporateDiningServiceMonitor
