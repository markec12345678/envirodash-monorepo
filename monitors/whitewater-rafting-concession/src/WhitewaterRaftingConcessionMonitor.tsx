...
export interface WhitewaterRaftingConcessionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WhitewaterRaftingConcessionMonitor({ onClose, showClose = true }: WhitewaterRaftingConcessionMonitorProps) {
  return (
...
export default WhitewaterRaftingConcessionMonitor
