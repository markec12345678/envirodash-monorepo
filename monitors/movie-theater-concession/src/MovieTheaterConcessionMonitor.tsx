...
export interface MovieTheaterConcessionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MovieTheaterConcessionMonitor({ onClose, showClose = true }: MovieTheaterConcessionMonitorProps) {
  return (
...
export default MovieTheaterConcessionMonitor
