...
export interface ApparelRetailChainMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ApparelRetailChainMonitor({ onClose, showClose = true }: ApparelRetailChainMonitorProps) {
  return (
...
export default ApparelRetailChainMonitor
