...
export interface SubsidenceHazardMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SubsidenceHazardMonitor({ onClose, showClose = true }: SubsidenceHazardMonitorProps) {
  return (
...
export default SubsidenceHazardMonitor
