...
export interface HydrothermalDiffuseFlowMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HydrothermalDiffuseFlowMonitor({ onClose, showClose = true }: HydrothermalDiffuseFlowMonitorProps) {
  return (
...
export default HydrothermalDiffuseFlowMonitor
