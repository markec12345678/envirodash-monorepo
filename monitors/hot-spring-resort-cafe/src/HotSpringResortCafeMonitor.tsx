...
export interface HotSpringResortCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HotSpringResortCafeMonitor({ onClose, showClose = true }: HotSpringResortCafeMonitorProps) {
  return (
...
export default HotSpringResortCafeMonitor
