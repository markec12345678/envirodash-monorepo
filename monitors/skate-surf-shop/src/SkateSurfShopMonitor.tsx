...
export interface SkateSurfShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SkateSurfShopMonitor({ onClose, showClose = true }: SkateSurfShopMonitorProps) {
  return (
...
export default SkateSurfShopMonitor
