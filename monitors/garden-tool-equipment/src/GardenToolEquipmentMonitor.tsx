...
export interface GardenToolEquipmentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GardenToolEquipmentMonitor({ onClose, showClose = true }: GardenToolEquipmentMonitorProps) {
  return (
...
export default GardenToolEquipmentMonitor
