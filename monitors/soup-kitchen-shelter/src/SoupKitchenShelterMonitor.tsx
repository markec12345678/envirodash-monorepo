...
export interface SoupKitchenShelterMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SoupKitchenShelterMonitor({ onClose, showClose = true }: SoupKitchenShelterMonitorProps) {
  return (
...
export default SoupKitchenShelterMonitor
