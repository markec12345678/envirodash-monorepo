...
export interface VolcanicAshDispersionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VolcanicAshDispersionMonitor({ onClose, showClose = true }: VolcanicAshDispersionMonitorProps) {
  return (
...
export default VolcanicAshDispersionMonitor
