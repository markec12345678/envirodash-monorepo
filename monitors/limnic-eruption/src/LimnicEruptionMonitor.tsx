...
export interface LimnicEruptionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LimnicEruptionMonitor({ onClose, showClose = true }: LimnicEruptionMonitorProps) {
  return (
...
export default LimnicEruptionMonitor
