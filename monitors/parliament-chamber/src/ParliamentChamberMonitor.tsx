...
export interface ParliamentChamberMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ParliamentChamberMonitor({ onClose, showClose = true }: ParliamentChamberMonitorProps) {
  return (
...
export default ParliamentChamberMonitor
