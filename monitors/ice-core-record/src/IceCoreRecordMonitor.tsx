...
export interface IceCoreRecordMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function IceCoreRecordMonitor({ onClose, showClose = true }: IceCoreRecordMonitorProps) {
  return (
...
export default IceCoreRecordMonitor
