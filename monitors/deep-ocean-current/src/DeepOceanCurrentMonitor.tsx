...
export interface DeepOceanCurrentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function DeepOceanCurrentMonitor({ onClose, showClose = true }: DeepOceanCurrentMonitorProps) {
  return (
...
export default DeepOceanCurrentMonitor
