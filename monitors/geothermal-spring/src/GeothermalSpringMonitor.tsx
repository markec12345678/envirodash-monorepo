...
export interface GeothermalSpringMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GeothermalSpringMonitor({ onClose, showClose = true }: GeothermalSpringMonitorProps) {
  return (
...
export default GeothermalSpringMonitor
