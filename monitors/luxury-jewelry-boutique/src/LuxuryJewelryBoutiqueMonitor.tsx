...
export interface LuxuryJewelryBoutiqueMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LuxuryJewelryBoutiqueMonitor({ onClose, showClose = true }: LuxuryJewelryBoutiqueMonitorProps) {
  return (
...
export default LuxuryJewelryBoutiqueMonitor
