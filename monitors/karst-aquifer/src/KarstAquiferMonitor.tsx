...
export interface KarstAquiferMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function KarstAquiferMonitor({ onClose, showClose = true }: KarstAquiferMonitorProps) {
  return (
...
export default KarstAquiferMonitor
