...
export interface KelpForestMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function KelpForestMonitor({ onClose, showClose = true }: KelpForestMonitorProps) {
  return (
...
export default KelpForestMonitor
