...
export interface AudioVideoStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AudioVideoStoreMonitor({ onClose, showClose = true }: AudioVideoStoreMonitorProps) {
  return (
...
export default AudioVideoStoreMonitor
