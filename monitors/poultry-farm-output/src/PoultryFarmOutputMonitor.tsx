...
export interface PoultryFarmOutputMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PoultryFarmOutputMonitor({ onClose, showClose = true }: PoultryFarmOutputMonitorProps) {
  return (
...
export default PoultryFarmOutputMonitor
