...
export interface AccountingFirmOfficeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AccountingFirmOfficeMonitor({ onClose, showClose = true }: AccountingFirmOfficeMonitorProps) {
  return (
...
export default AccountingFirmOfficeMonitor
