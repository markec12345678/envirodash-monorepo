...
export interface BiomassEnergyYieldMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BiomassEnergyYieldMonitor({ onClose, showClose = true }: BiomassEnergyYieldMonitorProps) {
  return (
...
export default BiomassEnergyYieldMonitor
