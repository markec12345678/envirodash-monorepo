...
export interface VolcanicIslandMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VolcanicIslandMonitor({ onClose, showClose = true }: VolcanicIslandMonitorProps) {
  return (
...
export default VolcanicIslandMonitor
