...
export interface PetTrainingObedienceSchoolMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PetTrainingObedienceSchoolMonitor({ onClose, showClose = true }: PetTrainingObedienceSchoolMonitorProps) {
  return (
...
export default PetTrainingObedienceSchoolMonitor
