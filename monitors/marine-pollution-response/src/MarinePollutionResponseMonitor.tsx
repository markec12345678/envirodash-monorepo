...
export interface MarinePollutionResponseMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MarinePollutionResponseMonitor({ onClose, showClose = true }: MarinePollutionResponseMonitorProps) {
  return (
...
export default MarinePollutionResponseMonitor
