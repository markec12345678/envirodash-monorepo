...
export interface IceShelfCalvingMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function IceShelfCalvingMonitor({ onClose, showClose = true }: IceShelfCalvingMonitorProps) {
  return (
...
export default IceShelfCalvingMonitor
