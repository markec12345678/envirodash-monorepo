...
export interface AircraftHangarFacilityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AircraftHangarFacilityMonitor({ onClose, showClose = true }: AircraftHangarFacilityMonitorProps) {
  return (
...
export default AircraftHangarFacilityMonitor
