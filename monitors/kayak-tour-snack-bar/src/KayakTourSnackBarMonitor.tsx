...
export interface KayakTourSnackBarMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function KayakTourSnackBarMonitor({ onClose, showClose = true }: KayakTourSnackBarMonitorProps) {
  return (
...
export default KayakTourSnackBarMonitor
