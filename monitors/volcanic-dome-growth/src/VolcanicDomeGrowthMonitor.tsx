...
export interface VolcanicDomeGrowthMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VolcanicDomeGrowthMonitor({ onClose, showClose = true }: VolcanicDomeGrowthMonitorProps) {
  return (
...
export default VolcanicDomeGrowthMonitor
