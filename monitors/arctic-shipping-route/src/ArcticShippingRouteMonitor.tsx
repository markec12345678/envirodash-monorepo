...
export interface ArcticShippingRouteMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ArcticShippingRouteMonitor({ onClose, showClose = true }: ArcticShippingRouteMonitorProps) {
  return (
...
export default ArcticShippingRouteMonitor
