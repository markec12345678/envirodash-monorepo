...
export interface MosqueCompoundMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MosqueCompoundMonitor({ onClose, showClose = true }: MosqueCompoundMonitorProps) {
  return (
...
export default MosqueCompoundMonitor
