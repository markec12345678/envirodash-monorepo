...
export interface FineDiningRestaurantMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FineDiningRestaurantMonitor({ onClose, showClose = true }: FineDiningRestaurantMonitorProps) {
  return (
...
export default FineDiningRestaurantMonitor
