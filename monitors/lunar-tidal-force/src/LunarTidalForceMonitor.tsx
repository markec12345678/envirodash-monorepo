...
export interface LunarTidalForceMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LunarTidalForceMonitor({ onClose, showClose = true }: LunarTidalForceMonitorProps) {
  return (
...
export default LunarTidalForceMonitor
