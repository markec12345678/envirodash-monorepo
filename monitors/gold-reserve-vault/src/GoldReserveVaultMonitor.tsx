...
export interface GoldReserveVaultMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GoldReserveVaultMonitor({ onClose, showClose = true }: GoldReserveVaultMonitorProps) {
  return (
...
export default GoldReserveVaultMonitor
