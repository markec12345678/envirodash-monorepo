...
export interface PrintCopyCenterMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PrintCopyCenterMonitor({ onClose, showClose = true }: PrintCopyCenterMonitorProps) {
  return (
...
export default PrintCopyCenterMonitor
