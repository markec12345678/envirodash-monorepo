...
export interface TradeWindBeltMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TradeWindBeltMonitor({ onClose, showClose = true }: TradeWindBeltMonitorProps) {
  return (
...
export default TradeWindBeltMonitor
