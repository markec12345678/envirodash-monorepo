...
export interface BorderPatrolActivityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BorderPatrolActivityMonitor({ onClose, showClose = true }: BorderPatrolActivityMonitorProps) {
  return (
...
export default BorderPatrolActivityMonitor
