...
export interface CoastalErosionDetailMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CoastalErosionDetailMonitor({ onClose, showClose = true }: CoastalErosionDetailMonitorProps) {
  return (
...
export default CoastalErosionDetailMonitor
