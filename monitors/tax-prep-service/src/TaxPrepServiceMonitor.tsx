...
export interface TaxPrepServiceMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TaxPrepServiceMonitor({ onClose, showClose = true }: TaxPrepServiceMonitorProps) {
  return (
...
export default TaxPrepServiceMonitor
