...
export interface AcupunctureClinicCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AcupunctureClinicCafeMonitor({ onClose, showClose = true }: AcupunctureClinicCafeMonitorProps) {
  return (
...
export default AcupunctureClinicCafeMonitor
