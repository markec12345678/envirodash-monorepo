...
export interface RockGlacierMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RockGlacierMonitor({ onClose, showClose = true }: RockGlacierMonitorProps) {
  return (
...
export default RockGlacierMonitor
