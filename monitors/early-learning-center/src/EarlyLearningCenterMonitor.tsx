...
export interface EarlyLearningCenterMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function EarlyLearningCenterMonitor({ onClose, showClose = true }: EarlyLearningCenterMonitorProps) {
  return (
...
export default EarlyLearningCenterMonitor
