...
export interface MiniGolfSnackBarMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MiniGolfSnackBarMonitor({ onClose, showClose = true }: MiniGolfSnackBarMonitorProps) {
  return (
...
export default MiniGolfSnackBarMonitor
