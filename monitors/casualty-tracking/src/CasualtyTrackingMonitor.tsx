...
export interface CasualtyTrackingMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CasualtyTrackingMonitor({ onClose, showClose = true }: CasualtyTrackingMonitorProps) {
  return (
...
export default CasualtyTrackingMonitor
