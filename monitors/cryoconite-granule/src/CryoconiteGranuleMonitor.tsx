...
export interface CryoconiteGranuleMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CryoconiteGranuleMonitor({ onClose, showClose = true }: CryoconiteGranuleMonitorProps) {
  return (
...
export default CryoconiteGranuleMonitor
