...
export interface TidalEnergyMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TidalEnergyMonitor({ onClose, showClose = true }: TidalEnergyMonitorProps) {
  return (
...
export default TidalEnergyMonitor
