...
export interface BuddhistTempleMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BuddhistTempleMonitor({ onClose, showClose = true }: BuddhistTempleMonitorProps) {
  return (
...
export default BuddhistTempleMonitor
