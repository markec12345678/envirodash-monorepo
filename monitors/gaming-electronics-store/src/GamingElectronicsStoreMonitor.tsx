...
export interface GamingElectronicsStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GamingElectronicsStoreMonitor({ onClose, showClose = true }: GamingElectronicsStoreMonitorProps) {
  return (
...
export default GamingElectronicsStoreMonitor
