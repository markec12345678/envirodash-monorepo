...
export interface OptometryClinicMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function OptometryClinicMonitor({ onClose, showClose = true }: OptometryClinicMonitorProps) {
  return (
...
export default OptometryClinicMonitor
