...
export interface HotelRestaurantSupplyMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HotelRestaurantSupplyMonitor({ onClose, showClose = true }: HotelRestaurantSupplyMonitorProps) {
  return (
...
export default HotelRestaurantSupplyMonitor
