...
export interface PetStoreRetailMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PetStoreRetailMonitor({ onClose, showClose = true }: PetStoreRetailMonitorProps) {
  return (
...
export default PetStoreRetailMonitor
