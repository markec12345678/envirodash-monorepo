...
export interface PermafrostActiveLayerMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PermafrostActiveLayerMonitor({ onClose, showClose = true }: PermafrostActiveLayerMonitorProps) {
  return (
...
export default PermafrostActiveLayerMonitor
