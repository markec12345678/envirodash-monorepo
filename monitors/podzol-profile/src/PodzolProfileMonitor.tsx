...
export interface PodzolProfileMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PodzolProfileMonitor({ onClose, showClose = true }: PodzolProfileMonitorProps) {
  return (
...
export default PodzolProfileMonitor
