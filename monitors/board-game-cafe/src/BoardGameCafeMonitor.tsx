...
export interface BoardGameCafeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BoardGameCafeMonitor({ onClose, showClose = true }: BoardGameCafeMonitorProps) {
  return (
...
export default BoardGameCafeMonitor
