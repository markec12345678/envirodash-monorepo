...
export interface WaxingHairRemovalMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WaxingHairRemovalMonitor({ onClose, showClose = true }: WaxingHairRemovalMonitorProps) {
  return (
...
export default WaxingHairRemovalMonitor
