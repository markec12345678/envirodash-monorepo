...
export interface VolcanicLavaFlowMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VolcanicLavaFlowMonitor({ onClose, showClose = true }: VolcanicLavaFlowMonitorProps) {
  return (
...
export default VolcanicLavaFlowMonitor
