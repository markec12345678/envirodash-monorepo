...
export interface NotarySigningServiceMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function NotarySigningServiceMonitor({ onClose, showClose = true }: NotarySigningServiceMonitorProps) {
  return (
...
export default NotarySigningServiceMonitor
