...
export interface ElectronicsRetailChainMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ElectronicsRetailChainMonitor({ onClose, showClose = true }: ElectronicsRetailChainMonitorProps) {
  return (
...
export default ElectronicsRetailChainMonitor
