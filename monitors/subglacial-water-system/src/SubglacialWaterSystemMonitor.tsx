...
export interface SubglacialWaterSystemMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SubglacialWaterSystemMonitor({ onClose, showClose = true }: SubglacialWaterSystemMonitorProps) {
  return (
...
export default SubglacialWaterSystemMonitor
