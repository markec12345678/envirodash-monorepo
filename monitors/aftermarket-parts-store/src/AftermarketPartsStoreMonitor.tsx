...
export interface AftermarketPartsStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AftermarketPartsStoreMonitor({ onClose, showClose = true }: AftermarketPartsStoreMonitorProps) {
  return (
...
export default AftermarketPartsStoreMonitor
