...
export interface VolcanoSeismicMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VolcanoSeismicMonitor({ onClose, showClose = true }: VolcanoSeismicMonitorProps) {
  return (
...
export default VolcanoSeismicMonitor
