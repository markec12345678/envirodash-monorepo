...
export interface VeterinaryClinicMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VeterinaryClinicMonitor({ onClose, showClose = true }: VeterinaryClinicMonitorProps) {
  return (
...
export default VeterinaryClinicMonitor
