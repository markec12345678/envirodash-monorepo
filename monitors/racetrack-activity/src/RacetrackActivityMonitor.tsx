...
export interface RacetrackActivityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function RacetrackActivityMonitor({ onClose, showClose = true }: RacetrackActivityMonitorProps) {
  return (
...
export default RacetrackActivityMonitor
