...
export interface ChocolateConfectioneryMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ChocolateConfectioneryMonitor({ onClose, showClose = true }: ChocolateConfectioneryMonitorProps) {
  return (
...
export default ChocolateConfectioneryMonitor
