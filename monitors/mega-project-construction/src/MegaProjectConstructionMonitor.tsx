...
export interface MegaProjectConstructionMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MegaProjectConstructionMonitor({ onClose, showClose = true }: MegaProjectConstructionMonitorProps) {
  return (
...
export default MegaProjectConstructionMonitor
