...
export interface LighthouseNavigationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LighthouseNavigationMonitor({ onClose, showClose = true }: LighthouseNavigationMonitorProps) {
  return (
...
export default LighthouseNavigationMonitor
