...
export interface CruiseShipGalleyMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CruiseShipGalleyMonitor({ onClose, showClose = true }: CruiseShipGalleyMonitorProps) {
  return (
...
export default CruiseShipGalleyMonitor
