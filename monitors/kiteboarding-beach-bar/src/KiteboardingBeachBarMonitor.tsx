...
export interface KiteboardingBeachBarMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function KiteboardingBeachBarMonitor({ onClose, showClose = true }: KiteboardingBeachBarMonitorProps) {
  return (
...
export default KiteboardingBeachBarMonitor
