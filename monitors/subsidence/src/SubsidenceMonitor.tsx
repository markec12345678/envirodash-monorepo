...
export interface SubsidenceMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SubsidenceMonitor({ onClose, showClose = true }: SubsidenceMonitorProps) {
  return (
...
export default SubsidenceMonitor
