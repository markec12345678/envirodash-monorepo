...
export interface LightingShowroomMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function LightingShowroomMonitor({ onClose, showClose = true }: LightingShowroomMonitorProps) {
  return (
...
export default LightingShowroomMonitor
