...
export interface MuseumCafeGiftMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MuseumCafeGiftMonitor({ onClose, showClose = true }: MuseumCafeGiftMonitorProps) {
  return (
...
export default MuseumCafeGiftMonitor
