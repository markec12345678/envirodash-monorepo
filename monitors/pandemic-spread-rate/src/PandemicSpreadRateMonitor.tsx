...
export interface PandemicSpreadRateMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PandemicSpreadRateMonitor({ onClose, showClose = true }: PandemicSpreadRateMonitorProps) {
  return (
...
export default PandemicSpreadRateMonitor
