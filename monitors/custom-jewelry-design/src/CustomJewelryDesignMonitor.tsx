...
export interface CustomJewelryDesignMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CustomJewelryDesignMonitor({ onClose, showClose = true }: CustomJewelryDesignMonitorProps) {
  return (
...
export default CustomJewelryDesignMonitor
