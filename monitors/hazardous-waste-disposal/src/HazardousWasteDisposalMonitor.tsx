...
export interface HazardousWasteDisposalMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HazardousWasteDisposalMonitor({ onClose, showClose = true }: HazardousWasteDisposalMonitorProps) {
  return (
...
export default HazardousWasteDisposalMonitor
