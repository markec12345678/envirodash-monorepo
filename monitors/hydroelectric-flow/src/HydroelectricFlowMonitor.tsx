...
export interface HydroelectricFlowMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HydroelectricFlowMonitor({ onClose, showClose = true }: HydroelectricFlowMonitorProps) {
  return (
...
export default HydroelectricFlowMonitor
