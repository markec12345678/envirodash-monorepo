...
export interface PolarFrontJetMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PolarFrontJetMonitor({ onClose, showClose = true }: PolarFrontJetMonitorProps) {
  return (
...
export default PolarFrontJetMonitor
