...
export interface SubaqueousLavaFlowMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SubaqueousLavaFlowMonitor({ onClose, showClose = true }: SubaqueousLavaFlowMonitorProps) {
  return (
...
export default SubaqueousLavaFlowMonitor
