...
export interface MentalHealthCounselingMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MentalHealthCounselingMonitor({ onClose, showClose = true }: MentalHealthCounselingMonitorProps) {
  return (
...
export default MentalHealthCounselingMonitor
