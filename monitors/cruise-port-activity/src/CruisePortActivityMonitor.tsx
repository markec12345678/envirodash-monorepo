...
export interface CruisePortActivityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CruisePortActivityMonitor({ onClose, showClose = true }: CruisePortActivityMonitorProps) {
  return (
...
export default CruisePortActivityMonitor
