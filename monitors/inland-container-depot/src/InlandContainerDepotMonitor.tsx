...
export interface InlandContainerDepotMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function InlandContainerDepotMonitor({ onClose, showClose = true }: InlandContainerDepotMonitorProps) {
  return (
...
export default InlandContainerDepotMonitor
