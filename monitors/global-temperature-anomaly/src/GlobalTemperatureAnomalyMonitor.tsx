...
export interface GlobalTemperatureAnomalyMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GlobalTemperatureAnomalyMonitor({ onClose, showClose = true }: GlobalTemperatureAnomalyMonitorProps) {
  return (
...
export default GlobalTemperatureAnomalyMonitor
