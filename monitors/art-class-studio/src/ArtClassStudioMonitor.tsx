...
export interface ArtClassStudioMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ArtClassStudioMonitor({ onClose, showClose = true }: ArtClassStudioMonitorProps) {
  return (
...
export default ArtClassStudioMonitor
