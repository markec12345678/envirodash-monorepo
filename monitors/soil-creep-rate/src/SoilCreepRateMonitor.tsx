...
export interface SoilCreepRateMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SoilCreepRateMonitor({ onClose, showClose = true }: SoilCreepRateMonitorProps) {
  return (
...
export default SoilCreepRateMonitor
