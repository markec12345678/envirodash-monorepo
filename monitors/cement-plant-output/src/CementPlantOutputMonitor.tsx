...
export interface CementPlantOutputMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CementPlantOutputMonitor({ onClose, showClose = true }: CementPlantOutputMonitorProps) {
  return (
...
export default CementPlantOutputMonitor
