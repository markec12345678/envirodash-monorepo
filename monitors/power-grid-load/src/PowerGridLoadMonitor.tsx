...
export interface PowerGridLoadMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PowerGridLoadMonitor({ onClose, showClose = true }: PowerGridLoadMonitorProps) {
  return (
...
export default PowerGridLoadMonitor
