...
export interface OrganicGroceryStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function OrganicGroceryStoreMonitor({ onClose, showClose = true }: OrganicGroceryStoreMonitorProps) {
  return (
...
export default OrganicGroceryStoreMonitor
