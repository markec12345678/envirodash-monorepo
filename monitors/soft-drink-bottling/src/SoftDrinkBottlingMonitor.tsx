...
export interface SoftDrinkBottlingMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SoftDrinkBottlingMonitor({ onClose, showClose = true }: SoftDrinkBottlingMonitorProps) {
  return (
...
export default SoftDrinkBottlingMonitor
