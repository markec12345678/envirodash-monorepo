...
export interface CoastalDuneSystemMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CoastalDuneSystemMonitor({ onClose, showClose = true }: CoastalDuneSystemMonitorProps) {
  return (
...
export default CoastalDuneSystemMonitor
