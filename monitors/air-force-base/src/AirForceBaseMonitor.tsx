...
export interface AirForceBaseMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AirForceBaseMonitor({ onClose, showClose = true }: AirForceBaseMonitorProps) {
  return (
...
export default AirForceBaseMonitor
