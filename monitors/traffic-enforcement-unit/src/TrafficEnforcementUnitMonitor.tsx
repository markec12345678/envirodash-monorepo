...
export interface TrafficEnforcementUnitMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function TrafficEnforcementUnitMonitor({ onClose, showClose = true }: TrafficEnforcementUnitMonitorProps) {
  return (
...
export default TrafficEnforcementUnitMonitor
