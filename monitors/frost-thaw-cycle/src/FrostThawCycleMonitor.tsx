...
export interface FrostThawCycleMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FrostThawCycleMonitor({ onClose, showClose = true }: FrostThawCycleMonitorProps) {
  return (
...
export default FrostThawCycleMonitor
