...
export interface ChiropracticOfficeMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function ChiropracticOfficeMonitor({ onClose, showClose = true }: ChiropracticOfficeMonitorProps) {
  return (
...
export default ChiropracticOfficeMonitor
