...
export interface SatelliteGroundStationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SatelliteGroundStationMonitor({ onClose, showClose = true }: SatelliteGroundStationMonitorProps) {
  return (
...
export default SatelliteGroundStationMonitor
