...
export interface OlympicVenueMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function OlympicVenueMonitor({ onClose, showClose = true }: OlympicVenueMonitorProps) {
  return (
...
export default OlympicVenueMonitor
