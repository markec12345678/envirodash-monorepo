...
export interface FoodTruckFleetMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FoodTruckFleetMonitor({ onClose, showClose = true }: FoodTruckFleetMonitorProps) {
  return (
...
export default FoodTruckFleetMonitor
