...
export interface MarinaRestaurantMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MarinaRestaurantMonitor({ onClose, showClose = true }: MarinaRestaurantMonitorProps) {
  return (
...
export default MarinaRestaurantMonitor
