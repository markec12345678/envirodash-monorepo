...
export interface CommandBunkerFacilityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function CommandBunkerFacilityMonitor({ onClose, showClose = true }: CommandBunkerFacilityMonitorProps) {
  return (
...
export default CommandBunkerFacilityMonitor
