...
export interface MethaneEmissionHotspotMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MethaneEmissionHotspotMonitor({ onClose, showClose = true }: MethaneEmissionHotspotMonitorProps) {
  return (
...
export default MethaneEmissionHotspotMonitor
