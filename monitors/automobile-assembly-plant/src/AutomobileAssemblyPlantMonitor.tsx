...
export interface AutomobileAssemblyPlantMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function AutomobileAssemblyPlantMonitor({ onClose, showClose = true }: AutomobileAssemblyPlantMonitorProps) {
  return (
...
export default AutomobileAssemblyPlantMonitor
