...
export interface HealthFoodStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HealthFoodStoreMonitor({ onClose, showClose = true }: HealthFoodStoreMonitorProps) {
  return (
...
export default HealthFoodStoreMonitor
