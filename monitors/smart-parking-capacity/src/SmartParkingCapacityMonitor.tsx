...
export interface SmartParkingCapacityMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SmartParkingCapacityMonitor({ onClose, showClose = true }: SmartParkingCapacityMonitorProps) {
  return (
...
export default SmartParkingCapacityMonitor
