...
export interface HairSalonChainMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HairSalonChainMonitor({ onClose, showClose = true }: HairSalonChainMonitorProps) {
  return (
...
export default HairSalonChainMonitor
