...
export interface VolcanicSulfurDioxideMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VolcanicSulfurDioxideMonitor({ onClose, showClose = true }: VolcanicSulfurDioxideMonitorProps) {
  return (
...
export default VolcanicSulfurDioxideMonitor
