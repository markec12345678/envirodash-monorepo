...
export interface HydrothermalVentMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HydrothermalVentMonitor({ onClose, showClose = true }: HydrothermalVentMonitorProps) {
  return (
...
export default HydrothermalVentMonitor
