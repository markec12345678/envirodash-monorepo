...
export interface EvacuationRouteMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function EvacuationRouteMonitor({ onClose, showClose = true }: EvacuationRouteMonitorProps) {
  return (
...
export default EvacuationRouteMonitor
