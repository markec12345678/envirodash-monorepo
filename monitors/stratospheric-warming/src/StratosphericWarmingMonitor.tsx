...
export interface StratosphericWarmingMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function StratosphericWarmingMonitor({ onClose, showClose = true }: StratosphericWarmingMonitorProps) {
  return (
...
export default StratosphericWarmingMonitor
