...
export interface SnowCoverDurationMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SnowCoverDurationMonitor({ onClose, showClose = true }: SnowCoverDurationMonitorProps) {
  return (
...
export default SnowCoverDurationMonitor
