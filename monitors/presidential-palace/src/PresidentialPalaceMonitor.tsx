...
export interface PresidentialPalaceMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function PresidentialPalaceMonitor({ onClose, showClose = true }: PresidentialPalaceMonitorProps) {
  return (
...
export default PresidentialPalaceMonitor
