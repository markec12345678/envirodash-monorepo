...
export interface SpeciesMigrationRouteMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SpeciesMigrationRouteMonitor({ onClose, showClose = true }: SpeciesMigrationRouteMonitorProps) {
  return (
...
export default SpeciesMigrationRouteMonitor
