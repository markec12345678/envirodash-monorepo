...
export interface FootwearBoutiqueMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function FootwearBoutiqueMonitor({ onClose, showClose = true }: FootwearBoutiqueMonitorProps) {
  return (
...
export default FootwearBoutiqueMonitor
