...
export interface GiftSpecialtyShopMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function GiftSpecialtyShopMonitor({ onClose, showClose = true }: GiftSpecialtyShopMonitorProps) {
  return (
...
export default GiftSpecialtyShopMonitor
