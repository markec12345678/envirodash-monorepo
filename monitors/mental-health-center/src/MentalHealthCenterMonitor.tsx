...
export interface MentalHealthCenterMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function MentalHealthCenterMonitor({ onClose, showClose = true }: MentalHealthCenterMonitorProps) {
  return (
...
export default MentalHealthCenterMonitor
