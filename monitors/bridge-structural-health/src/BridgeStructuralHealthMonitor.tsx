...
export interface BridgeStructuralHealthMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function BridgeStructuralHealthMonitor({ onClose, showClose = true }: BridgeStructuralHealthMonitorProps) {
  return (
...
export default BridgeStructuralHealthMonitor
