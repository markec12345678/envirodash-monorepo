...
export interface HinduTempleMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function HinduTempleMonitor({ onClose, showClose = true }: HinduTempleMonitorProps) {
  return (
...
export default HinduTempleMonitor
