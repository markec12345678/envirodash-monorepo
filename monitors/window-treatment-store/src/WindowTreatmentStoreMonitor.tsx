...
export interface WindowTreatmentStoreMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function WindowTreatmentStoreMonitor({ onClose, showClose = true }: WindowTreatmentStoreMonitorProps) {
  return (
...
export default WindowTreatmentStoreMonitor
