...
export interface SynagogueHeritageMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function SynagogueHeritageMonitor({ onClose, showClose = true }: SynagogueHeritageMonitorProps) {
  return (
...
export default SynagogueHeritageMonitor
