...
export interface VolcanicTremorMonitorProps {
  onClose?: () => void
  showClose?: boolean
}

export function VolcanicTremorMonitor({ onClose, showClose = true }: VolcanicTremorMonitorProps) {
  return (
...
export default VolcanicTremorMonitor
